require.config({
        ...
        paths: {
            ...
            nodeuuid: "bower_components/node-uuid/uuid",
            q: "bower_components/q/q",
            "state-machine": "bower_components/state-machine/lib/state-machine",
            "socket.io-client": "bower_components/socket.io-client/socket.io",
            clientSDK: "bower_components/client-sdk",
            sockjs: "bower_components/sockjs/sockjs.min",
            bluebird: "bower_components/bluebird/js/browser/bluebird",
            underscore: "thirdparty/underscore",
            jquery: "thirdparty/jquery-1.8.2",
            "my.Class": "thirdparty/my.class.min",
            getscreenmedia: "thirdparty/getscreenmedia.bundle",
            getusermedia: "thirdparty/getusermedia.bundle",
            hark: "thirdparty/hark.bundle",
            attachmediastream: "thirdparty/attachmediastream.bundle",
            mockconsole: "thirdparty/mockconsole.umd",
            util: "thirdparty/index",
            adapter: "thirdparty/adapter",
            "mediastream-gain": "thirdparty/mediastream-gain.bundle",
            state_machine: "thirdparty/state-machine",
            Logger: "thirdparty/logger",
            browserDetector: "thirdparty/browserDetector",
            localmedia: "thirdparty/amd-wrappers/localmedia",
            webrtcsupport: "thirdparty/amd-wrappers/index-browser",
            wildemitter: "thirdparty/amd-wrappers/wildemitter",
            sdpUtils: "thirdparty/amd-wrappers/sdpUtils"
        },
        map: {
            "*": {
                my: "my.Class",
    ...
    function(a, b) {
        function c(a) {
            return a && "object" == typeof a && a.__wrapped__ ? a : this instanceof c ? void(this.__wrapped__ = a) : new c(a)
        }
        ...
        function d(a, b, c) {
            ...
            if (e)
                for (var f = {}, g = b - 1; ++g < d;) {
                    var h = a[g] + "";
                    (wb.call(f, h) ? f[h] : f[h] = []).push(a[g])
                }
            return function(c) {
                if (e) {
                    var d = c + "";
                    return wb.call(f, d) && la(f[d], c) > -1
                }
                return la(a, c, b) > -1
            }
        }
        ...
        function g(a, b, c, d) {
            function e() {
                var i = arguments,
                    j = g ? this : b;
                if (f || (a = b[h]), c.length && (i = i.length ? (i = m(i), d ? i.concat(c) : c.concat(i)) : c), this instanceof e) {
                    l.prototype = a.prototype, j = new l, l.prototype = null;
                    var k = a.apply(j, i);
                    return D(k) ? k : j
                }
                return a.apply(j, i)
        ...
        function h(a, b, c) {
            ...
            if ("function" != d) {
                ...
                var e = ec(a);
                return function(b) {
                    for (var c = e.length, d = !1; c-- && (d = A(b[e[c]], a[e[c]], db)););
                    return d
                }
            }
            return "undefined" != typeof b ? 1 === c ? function(c) {
                return a.call(b, c)
            } : 2 === c ? function(c, d) {
                return a.call(b, c, d)
        ...
        function i() {
            ...
            var e = b.args;
            b.firstArg = /^[^,]+/.exec(e)[0];
            var f = Function("createCallback, hasOwnProperty, isArguments, isArray, isString, objectTypes, nativeKeys", "return function(" + e + ") {\n" + Yb(b) + "\n}");
            return f(h, wb, o, dc, I, Wb, Db)
        }
        ...
        function p(a) {
            var b = !1;
            if (!a || "object" != typeof a || o(a)) return b;
            var c = a.constructor;
            return !C(c) || c instanceof c ? (bc(a, function(a, c) {
                b = c
            }), b === !1 || wb.call(a, b)) : b
        }
        ...
        function r(a, c, d, e, f, g) {
            var i = a;
            if ("function" == typeof c && (e = d, d = c, c = !1), "function" == typeof d) {
                d = "undefined" == typeof e ? d : h(d, e, 1), i = d(i);
            ...
            if (!k || !c) return k && !j ? n ? m(i) : hc({}, i) : i;
            var o = Vb[l];
            switch (l) {
                case Jb:
                case Kb:
                ...
                case Pb:
                    return j ? i : new o(i);
                case Ob:
                    return j ? i : o(i.source, kb.exec(i))
            }
            f || (f = []), g || (g = []);
            for (var p = f.length; p--;)
                if (f[p] == a) return g[p];
            return j || (i = n ? o(i.length) : {}, n && (wb.call(a, "index") && (i.index = a.index), wb.call(a, "input") && (i.input = a.input))), f.push(a), g.push(i), (n ? V : cc)(j ? i : a, function(a, e) {
                i[e] = r(a, c, d, b, f, g)
            }), i
        }
        ...
        function v(a) {
            for (var b = -1, c = ec(a), d = c.length, e = {}; ++b < d;) {
                var f = c[b];
                e[a[f]] = f
            }
            return e
        ...
        function w(a) {
            return a === !0 || a === !1 || yb.call(a) == Jb
        }

        function x(a) {
            return a instanceof Date || yb.call(a) == Kb
        }
        ...
        function z(a) {
            ...
            var c = yb.call(a),
                d = a.length;
            return c == Ib || c == Pb || c == Hb || c == Nb && "number" == typeof d && C(a.splice) ? !d : (cc(a, function() {
                return b = !1
            }), b)
        }
        ...
        function A(a, b, c, d, e, f) {
            var g = c === db;
            if (c && !g) {
                c = "undefined" == typeof d ? c : h(c, d, 2);
                var i = c(a, b);
            ...
            var l = yb.call(a),
                m = yb.call(b);
            if (l == Hb && (l = Nb), m == Hb && (m = Nb), l != m) return !1;
            switch (l) {
                case Jb:
                case Kb:
                    return +a == +b;
            ...
            var n = l == Ib;
            if (!n) {
                if (a.__wrapped__ || b.__wrapped__) return A(a.__wrapped__ || a, b.__wrapped__ || b, c, d, e, f);
                if (l != Nb) return !1;
                var o = a.constructor,
                    p = b.constructor;
                if (o != p && !(C(o) && o instanceof o && C(p) && p instanceof p)) return !1
            }
            e || (e = []), f || (f = []);
            for (var q = e.length; q--;)
                if (e[q] == a) return f[q] == b;
            var r = 0;
            if (i = !0, e.push(a), f.push(b), n) {
                if (q = a.length, r = b.length, i = r == a.length, !i && !g) return i;
                for (; r--;) {
                    var s = q,
                        t = b[r];
                    if (g)
                        for (; s-- && !(i = A(a[s], t, c, d, e, f)););
                    else if (!(i = A(a[r], t, c, d, e, f))) break
                }
                return i
            }
            return bc(b, function(b, g, h) {
                return wb.call(h, g) ? (r++, i = wb.call(a, g) && A(a[g], b, c, d, e, f)) : void 0
            }), i && !g && bc(a, function(a, b, c) {
                return wb.call(c, b) ? i = --r > -1 : void 0
            }), i
        }
        ...
        function G(a) {
            return "number" == typeof a || yb.call(a) == Mb
        }

        function H(a) {
            return a instanceof RegExp || yb.call(a) == Ob
        }

        function I(a) {
            return "string" == typeof a || yb.call(a) == Pb
        }
        ...
        function K(a, b, c) {
            ...
            if (c === db) var g = d[3],
                i = d[4],
                j = d[5];
            else i = [], j = [], "number" != typeof c && (f = d.length), f > 3 && "function" == typeof d[f - 2] ? g = h(d[--f - 1], d[f--], 2) : f > 2 && "function" == typeof d[f - 1] && (g = d[--f]);
            for (; ++e < f;)(dc(d[e]) ? V : cc)(d[e], function(b, c) {
                var d, e, f = b,
                    h = a[c];
                if (b && ((e = dc(b)) || jc(b))) {
                    ...
                    d || (h = e ? dc(h) ? h : [] : jc(h) ? h : {}, g && (f = g(h, b), "undefined" != typeof f && (h = f)), i.push(b), j.push(h), g || (h = K(h, b, db, g, i, j)))
                } else g && (f = g(h, b), "undefined" == typeof f && (f = b)), "undefined" != typeof f && (h = f);
                a[c] = h
            });
            return a
        }
        ...
        function L(a, b, c) {
            var d = "function" == typeof b,
                e = {};
            if (d) b = h(b, c);
            else var f = tb.apply(ab, arguments);
            return bc(a, function(a, c, g) {
                (d ? !b(a, c, g) : la(f, c, 1) < 0) && (e[c] = a)
            }), e
        }

        function M(a) {
            for (var b = -1, c = ec(a), d = c.length, e = Array(d); ++b < d;) {
                var f = c[b];
                e[b] = [f, a[f]]
            }
            return e
        ...
        function N(a, b, c) {
            ...
            if ("function" != typeof b)
                for (var e = 0, f = tb.apply(ab, arguments), g = D(a) ? f.length : 0; ++e < g;) {
                    var i = f[e];
                    i in a && (d[i] = a[i])
                } else b = h(b, c), bc(a, function(a, c, e) {
                    b(a, c, e) && (d[c] = a)
                });
            return d
        }
        ...
        function O(a) {
            for (var b = -1, c = ec(a), d = c.length, e = Array(d); ++b < d;) e[b] = a[c[b]];
            return e
        }

        function P(a) {
            for (var b = -1, c = tb.apply(ab, m(arguments, 1)), d = c.length, e = Array(d); ++b < d;) e[b] = a[c[b]];
            return e
        }
        ...
        function Q(a, b, c) {
            var d = -1,
                e = a ? a.length : 0,
                f = !1;
            return c = (0 > c ? Eb(0, e + c) : c) || 0, "number" == typeof e ? f = (I(a) ? a.indexOf(b, c) : la(a, b, c)) > -1 : ac(a, function(a) {
        ...
        function R(a, b, c) {
            var d = {};
            return b = h(b, c), V(a, function(a, c, e) {
                c = b(a, c, e) + "", wb.call(d, c) ? d[c]++ : d[c] = 1
            }), d
        }
        ...
        function W(a, b, c) {
            var d = {};
            return b = h(b, c), V(a, function(a, c, e) {
                c = b(a, c, e) + "", (wb.call(d, c) ? d[c] : d[c] = []).push(a)
            }), d
        }
        ...
        function Z(a, b, c) {
            var d = -(1 / 0),
                f = d;
            if (!b && dc(a))
                for (var g = -1, i = a.length; ++g < i;) {
                    var j = a[g];
                    j > f && (f = j)
                } else b = !b && I(a) ? e : h(b, c), ac(a, function(a, c, e) {
                    var g = b(a, c, e);
                    g > d && (d = g, f = a)
                });
            return f
        ...
        function aa(a, b, c, d) {
            ...
            return b = h(b, d, 4), V(a, function(a, d, h) {
                d = i ? i[--f] : --f, c = g ? (g = !1, e[d]) : b(c, e[d], d, h)
            }), c
        }

        function ba(a, b, c) {
            return b = h(b, c), T(a, function(a, c, d) {
                return !b(a, c, d)
            })
        }
        ...
        function da(a) {
            var b = a ? a.length : 0;
            return "number" == typeof b ? b : ec(a).length
        }
        ...
        function fa(a, b, c) {
            var d = -1,
                e = a ? a.length : 0,
                g = Array("number" == typeof e ? e : 0);
            for (b = h(b, c), V(a, function(a, c, e) {
                    g[++d] = {
                        criteria: b(a, c, e),
                        index: d,
                        value: a
                    }
                }), e = g.length, g.sort(f); e--;) g[e] = g[e].value;
            return g
        }

        function ga(a) {
            return a && "number" == typeof a.length ? m(a) : O(a)
        }
        ...
        function ia(a) {
            for (var b = -1, c = a ? a.length : 0, e = tb.apply(ab, arguments), f = d(e, c), g = []; ++b < c;) {
                var h = a[b];
                f(h) || g.push(h)
            }
            return g
        ...
        function ja(a, b, c) {
            if (a) {
                ...
                if ("number" != typeof b && null != b) {
                    var f = -1;
                    for (b = h(b, c); ++f < e && b(a[f], f, a);) d++
                } else if (d = b, null == d || c) return a[0];
                return m(a, 0, Fb(Eb(0, d), e))
            }
        }
        ...
        function ka(a, b) {
            for (var c = -1, d = a ? a.length : 0, e = []; ++c < d;) {
                var f = a[c];
                dc(f) ? xb.apply(e, b ? f : ka(f)) : e.push(f)
            }
            return e
        }
        ...
        function la(a, b, c) {
            var d = -1,
                e = a ? a.length : 0;
            if ("number" == typeof c) d = (0 > c ? Eb(0, e + c) : c || 0) - 1;
            else if (c) return d = ta(a, b), a[d] === b ? d : -1;
            for (; ++d < e;)
                if (a[d] === b) return d;
            return -1
        }
        ...
        function ma(a, b, c) {
            ...
            if ("number" != typeof b && null != b) {
                var f = e;
                for (b = h(b, c); f-- && b(a[f], f, a);) d++
            } else d = null == b || c ? 1 : b || d;
            return m(a, 0, Fb(Eb(0, e - d), e))
        }
        ...
        function na(a) {
            ...
            a: for (; ++f < g;) {
                var k = a[f];
                if (h) var l = k + "",
                    m = wb.call(e[0], l) ? !(j = e[0][l]) : j = e[0][l] = [];
                if (m || la(j, k) < 0) {
                    h && j.push(k);
                    for (var n = c; --n;)
                        if (!(e[n] || (e[n] = d(b[n], 0, 100)))(k)) continue a;
                    i.push(k)
                }
            }
            return i
        ...
        function pa(a, b, c) {
            var d = a ? a.length : 0;
            for ("number" == typeof c && (d = (0 > c ? Eb(0, d + c) : Fb(c, d - 1)) + 1); d--;)
                if (a[d] === b) return d;
            return -1
        }
        ...
        function ra(a, b, c) {
            ...
            for (var d = -1, e = Eb(0, sb((b - a) / c)), f = Array(e); ++d < e;) f[d] = a, a += c;
            return f
        }
        ...
        function sa(a, b, c) {
            if ("number" != typeof b && null != b) {
                var d = 0,
                    e = -1,
                    f = a ? a.length : 0;
                for (b = h(b, c); ++e < f && b(a[e], e, a);) d++
            } else d = null == b || c ? 1 : Eb(0, b);
            return m(a, d)
        }
        ...
        function ua() {
            return va(tb.apply(ab, arguments))
        }
        ...
        function va(a, b, c, d) {
            ...
            for (c && (i = [], c = h(c, d)); ++e < f;) {
                var l = a[e],
                    m = c ? c(l, e, a) : l;
                if (j) var n = m + "",
                    o = wb.call(k, n) ? !(i = k[n]) : i = k[n] = [];
                (b ? !e || i[i.length - 1] !== m : o || la(i, m) < 0) && ((c || j) && i.push(m), g.push(l))
            }
            return g
        }

        function wa(a) {
            for (var b = -1, c = a ? a.length : 0, e = d(arguments, 1), f = []; ++b < c;) {
                var g = a[b];
                e(g) || f.push(g)
            }
            return f
        ...
        function xa(a) {
            for (var b = -1, c = a ? Z(kc(arguments, "length")) : 0, d = Array(c); ++b < c;) d[b] = kc(arguments, b);
            return d
        }
        ...
        function za(a, b) {
            return Sb || zb && arguments.length > 2 ? zb.call.apply(zb, arguments) : g(a, b, m(arguments, 2))
        }

        function Aa(a) {
            for (var b = tb.apply(ab, arguments), c = b.length > 1 ? 0 : (b = t(a), -1), d = b.length; ++c < d;) {
                var e = b[c];
                a[e] = za(a[e], a)
            }
            return a
        ...
        function Ia(a) {
            return g(a, m(arguments, 1))
        }

        function Ja(a) {
            return g(a, m(arguments, 1), null, db)
        }
        ...
        function La(a, b) {
            return function() {
                var c = [a];
                return xb.apply(c, arguments), b.apply(this, c)
            }
        }

        function Ma(a) {
            return null == a ? "" : (a + "").replace(pb, k)
        }
        ...
        function Oa(a) {
            V(t(a), function(b) {
                ...
                c.prototype[b] = function() {
                    ...
                    return xb.apply(a, arguments), new c(d.apply(c, a))
                }
            })
        }
        ...
        function Qa(a, b) {
            return null == a && null == b && (b = 1), a = +a || 0, null == b && (b = a, a = 0), a + ub(Gb() * ((+b || 0) - a + 1))
        }
        ...
        function Sa(a, d, e) {
            var f = c.templateSettings;
            a || (a = ""), e = ic({}, e, f);
            var g, h = ic({}, e.imports, f.imports),
                i = ec(h),
                k = O(h),
                l = 0,
                m = e.interpolate || ob,
                n = "__p += '",
                o = RegExp((e.escape || ob).source + "|" + m.source + "|" + (m === nb ? mb : ob).source + "|" + (e.evaluate || ob).source + "|$", "g");
            a.replace(o, function(b, c, d, e, f, h) {
                return d || (d = e), n += a.slice(l, h).replace(qb, j), c && (n += "' +\n__e(" + c + ") +\n'"), f && (g = !0, n += "';\n" + f + ";\n__p += '"), d && (n += "' +\n((__t = (" + d + ")) == null ? '' : __t) +\n'"), l = h + b.length, b
            }), n += "';\n";
            var p = e.variable,
                q = p;
            ...
            try {
                var s = Function(i, "return " + n + r).apply(b, k)
            } catch (t) {
                throw t.source = n, t
            }
            return d ? s(d) : (s.source = n, s)
        }

        function Ta(a, b, c) {
            a = +a || 0;
            for (var d = -1, e = Array(a); ++d < a;) e[d] = b.call(c, d);
            return e
        }

        function Ua(a) {
            return null == a ? "" : (a + "").replace(gb, n)
        }
        ...
        var Za = "object" == typeof exports && exports,
            $a = "object" == typeof module && module && module.exports == Za && module,
            _a = "object" == typeof global && global;
        _a.global === _a;
        var ab = [],
            bb = {},
            cb = 0,
            ...
            eb = 30,
            fb = a._,
            gb = /&(?:amp|lt|gt|quot|#39);/g,
            hb = /\b__p \+= '';/g,
            ib = /\b(__p \+=) '' \+/g,
            jb = /(__e\(.*?\)|\b__t\)) \+\n'';/g,
            kb = /\w*$/,
            lb = RegExp("^" + (bb.valueOf + "").replace(/[.*+?^${}()|[\]\\]/g, "\\$&").replace(/valueOf|for [^\]]+/g, ".+?") + "$"),
            mb = /\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g,
            nb = /<%=([\s\S]+?)%>/g,
            ob = /($^)/,
            pb = /[&<>"']/g,
            ...
            tb = ab.concat,
            ub = Math.floor,
            vb = lb.test(vb = Object.getPrototypeOf) && vb,
            wb = bb.hasOwnProperty,
            xb = ab.push,
            yb = bb.toString,
            zb = lb.test(zb = m.bind) && zb,
            Ab = lb.test(Ab = Array.isArray) && Ab,
            Bb = a.isFinite,
            Cb = a.isNaN,
            Db = lb.test(Db = Object.keys) && Db,
            Eb = Math.max,
            Fb = Math.min,
            Gb = Math.random,
            Hb = "[object Arguments]",
            ...
            Tb = Db && (Qb || Rb),
            Ub = {};
        Ub[Lb] = !1, Ub[Hb] = Ub[Ib] = Ub[Jb] = Ub[Kb] = Ub[Mb] = Ub[Nb] = Ub[Ob] = Ub[Pb] = !0;
        var Vb = {};
        Vb[Ib] = Array, Vb[Jb] = Boolean, Vb[Kb] = Date, Vb[Nb] = Object, Vb[Mb] = Number, Vb[Ob] = RegExp, Vb[Pb] = String;
        var Wb = {
                "boolean": !1,
                "function": !0,
                object: !0,
        ...
        var Yb = function(a) {
                var b = "var index, iterable = " + a.firstArg + ", result = iterable;\nif (!iterable) return result;\n" + a.top + ";\n";
            ...
            cc = i($b, _b),
            dc = Ab || function(a) {
                return a instanceof Array || yb.call(a) == Ib
            },
            ec = Db ? function(a) {
                return D(a) ? Db(a) : []
            } : q,
    ...
    function(a) {
        ...
        function x(a, b) {
            ga && (fa.push(a), b && "undefined" != typeof b.stack ? ea.push(b.stack) : ea.push("(no stack) " + b))
        }
        ...
        var ha = i();
        return k
    }), define("browserDetector", ["require"], function(a) {
        var b = function(a) {
            a = a || window.navigator.userAgent, this.browser = null, this.os = null, this.osVersion = null, this.version = null, this.majorVersion = null, this.instructionSet = "x86", this.device = "workstation", this.cookies = !1;
            var b = {
                    mac: {
                        is: function(a) {
                            return /macintosh/i.test(a)
                        },
                        getVersion: function(a) {
                            var b = /Mac OS X ([\d_\.]+)[;\)]/i.exec(a)[1];
                    ...
                    windows: {
                        ...
                        getVersion: function(a) {
                            return /windows.*?([\d\.]+?)[;\)]/i.exec(a)[1]
                        }
                    },
                    solaris: {
                        is: function(a) {
                            return /sunos/i.test(a)
                        },
                        getVersion: function(a) {
                            return "0"
                        }
                ...
                c = {
                    firefox: {
                        ...
                        getVersion: function(a) {
                            return /firefox\/(.+?)(?:\s|$)/i.exec(a)[1]
                        },
                        getMajorVersion: function(a) {
                            return /\d+/i.exec(a)[0]
                        }
                    },
                    chrome: {
                        is: function(a) {
                            return /chrome\//i.test(a) && !c.edge.is(a) && !c.opera.is(a)
                        },
                        getVersion: function(a) {
                            return /chrome\/(.+?)(?:\s|$)/i.exec(a)[1]
                        },
                        getMajorVersion: function(a) {
                            return /\d+/i.exec(a)[0]
                        }
                    ...
                    safari: {
                        is: function(a) {
                            return /safari/i.test(a) && !c.chrome.is(a) && !c.edge.is(a) && !c.opera.is(a)
                        },
                        getVersion: function(a) {
                            return /version\/(.+?)(?:\s|$)/i.exec(a) ? /version\/(.+?)(?:\s|$)/i.exec(a)[1] : "6.0"
                        },
                        getMajorVersion: function(a) {
                            return /\d+/i.exec(a)[0]
                        }
                    ...
                    ie: {
                        ...
                        getVersion: function(a) {
                            return -1 != a.indexOf("Trident") ? "" + (parseFloat(/Trident\/(.+?)[\);]/i.exec(a)[1]) + 4) + ".0" : /msie (.+?);/i.exec(a)[1]
                        },
                        getMajorVersion: function(a) {
                            return /\d+/i.exec(a)[0]
                        },
                        getInstructionSet: function(a) {
                            return /x64;/i.test(a) ? "x86-64" : "x86"
                        }
                    },
                    opera: {
                        is: function(a) {
                            return /(Opera|OPR)\/(\d+(\.\d+)?)/i.test(a)
                        },
                        getVersion: function(a) {
                            return /OPR\/(.+?)(?:\s|$)/i.exec(a)[1]
                        },
                        getMajorVersion: function(a) {
                            return /\d+/i.exec(a)[0]
                        }
            ...
            for (var e in d) {
                var f = d[e];
                if (f.is(a)) return void(this.device = e)
            }
            for (var g in b) {
                var h = b[g];
                if (h.is(a)) {
                    this.os = g, this.osVersion = h.getVersion(a);
                    break
                }
            }
            for (var i in c) {
                var j = c[i];
                if (j.is(a)) {
                    this.browser = i, this.version = j.getVersion(a), this.majorVersion = j.getMajorVersion(this.version), j.getInstructionSet && (this.instructionSet = j.getInstructionSet(a));
                    break
                }
            }
        ...
        return new b
    }), define("Logger", ["underscore", "my", "browserDetector"], function(a, b, c) {
        var d, e = {
                windows: {
                    chrome: [{
                        screenWidth: 1920,
            ...
            i = b.Class({
                ...
                getCurrentLogLevel: function() {
                    var b = this.controlLevel(),
                        c = a(h).indexOf(b),
                        d = c >= 0 ? a(h).first(c) : h;
                    return ["all"].concat(d.join("-")).join("-")
                },
                log: function() {
                    this._log(arguments, g.LOG)
                },
                debug: function() {
                    this._log(arguments, g.DEBUG)
                },
                info: function() {
                    this._log(arguments, g.INFO)
                },
                warn: function() {
                    this._log(arguments, g.WARN)
                },
                error: function() {
                    this._log(arguments, g.ERROR)
                },
                isLevel: function(a) {
                    return new RegExp("level=" + a, "i").test(window.location.search)
                },
                ...
                _log: function(b, c) {
                    try {
                        var d = new Date,
                            e = ("0" + d.getHours()).substr(-2) + ":" + ("0" + d.getMinutes()).substr(-2) + ":" + ("0" + d.getSeconds()).substr(-2) + "." + ("000" + d.getMilliseconds()).substr(-4);
                        if (b[0] = "[" + e + "](" + c.func.toUpperCase() + "): " + b[0], window.console && window.console.log) {
                            window.location.search.match(/log=debug/);
                            var f = this.getCurrentLogLevel();
                            (g.ALL.include(f) && !c.exclude(f) || c.include(f)) && ("function" == typeof window.console[c.func] ? window.console[c.func].apply(window.console, b) : window.console[c.func](a(b).toArray().join(", ")))
                        }
                    } catch (h) {}
                },
                pluginLog: function(a, b, c, e) {
                    d || require(["mediaController"], function(a) {
                        d = a
                    });
                    try {
                        var f = [];
                        f[0] = a.toUpperCase() + "  ♦ [" + b + ":" + c + "]" + e[0].replace(/\s+\(/g, " ("), d && d.pluginLog(f)
                    } catch (g) {}
                },
                check: function(a) {
                    var b = g[a.toUpperCase()],
                        c = this.controlLevel();
                    return b ? g.ALL.include(c) && !b.exclude(c) || b.include(c) : !1
                },
                prepare: function(b, d, e, g) {
                    var h = a(g).toArray();
                    b = b.toUpperCase();
                    var j = (new moment).format(i.TIME_FORMAT);
                    h[0] = j + " @ " + (b + "  ").substr(0, 5) + " ♦ " + h[0];
                    var k = "(" + d + ":" + ("0000" + e).substr(-Math.max(String(e).length, 3)) + ")";
                    if (h.length > 1) h.push(k);
                    else {
                        var l = h[0].length,
                            m = Math.max(1, this.getConsoleColumns() - f[c.browser] - l - k.length - 1);
                        m = isNaN(m) ? 1 : m;
                        var n = new Array(m + 1).join(" ");
                        h[0] += n + k
                    }
                    return h
                },
                ...
                getConsoleColumns: function() {
                    var a, b, d = c.browser,
                        ...
                        g = e[f] && e[f][d] ? e[f][d] : 0,
                        h = window.innerWidth;
                    return g ? (a = (g[0].columns - g[1].columns) / (g[0].screenWidth - g[1].screenWidth), b = g[0].columns - a * g[0].screenWidth) : (a = 0, b = 0), Math.floor(a * h + b)
                }
            });
        return new i
    }), define("WebRTC_SDK/utilities/RTCBlueJay", ["require", "my.Class", "underscore", "Logger"], function(a) {
        var b = a("my.Class"),
            c = a("underscore"),
            d = (a("Logger"), b.Class({
                STATIC: {
                ...
                getRequestMessage: function(a) {
                    var b = c.extend({}, d.MESSAGE_BASE, {
                        call: this.callId,
                        id: this.generateMsgId()
                    }, a);
                    return b
                },
                getConnectMessage: function(a) {
                    return this.getRequestMessage({
                        method: "connect",
                        params: a
                    })
                },
                getUpdateMessage: function(a) {
                    return this.getRequestMessage({
                        method: "update",
                        params: a
                    })
                },
                getMuteMessage: function(a) {
                    return this.getRequestMessage({
                        method: "mute",
                        params: a
                    })
                ...
                getIceCandidateMessage: function(a) {
                    return this.getRequestMessage({
                        method: "ice",
                        params: {
                            iceCandidate: a
                ...
                getDisconnectMessage: function(a) {
                    return this.getRequestMessage({
                        method: "disconnect",
                        params: a
                    })
                },
                getSuccessResponse: function(a) {
                    return c.extend({}, d.MESSAGE_BASE, {
                        id: a,
                        call: this.callId,
                        result: "null"
                    })
                },
                getErrorResponse: function(a, b) {
                    return c.extend({}, d.MESSAGE_BASE, {
                        id: a,
                        call: this.callId,
                        error: b
        ...
        return new d
    }), define("WebRTC_SDK/utilities/RTCUtils", ["require", "jquery", "q", "my.Class", "underscore"], function(a) {
        var b = (a("jquery"), a("q")),
            c = a("my.Class"),
            d = a("underscore"),
            e = c.Class({
                constructor: function() {},
                promiseDecorator: function(a) {
                    return function() {
                        var c = b.defer();
                        return a.apply(this, arguments), c.resolve(), c.promise
                    }
                },
                deepMergeObjects: function(a, b) {
                    var c = d.keys(a),
                        e = d.keys(b),
                        f = d.extend({}, a),
                        g = Object.prototype.toString;
                    return d.each(e, function(e, h, i) {
                        if (-1 === d.indexOf(c, e)) f[e] = b[e];
                        else {
                            var j = a[e],
                                k = b[e];
                            g.call(j) !== g.call(k) ? f[e] = b[e] : "[object Object]" === g.call(j) ? f[e] = this.deepMergeObjects(j, k) : "[object Array]" === g.call(j) ? f[e] = this.deepMergeArrays(j, k) : f[e] = b[e]
                        }
                    }, this), f
                },
                deepMergeArrays: function(a, b) {
                    var c = a,
                        e = Object.prototype.toString;
                    return d.each(b, function(b, f, g) {
                        if ("[object Object]" !== e.call(b)) c.push(b);
                        else {
                            var h, i, j, k = !1;
                            i = d.keys(b), d.each(a, function(a, f, g) {
                                "[object Object]" === e.call(a) && (h = d.keys(a),
                                    j = d.difference(h, i), j.length || (c[f] = this.deepMergeObjects(a, b), k = !0))
                            }, this), k || c.push(b)
                        }
                    }, this), c
                },
                getLocalStreamType: function(a) {
                    var b;
                    switch (a.bjn_label) {
                        ...
                        case "preview_stream":
                            ...
                            break;
                        case "content_stream":
                            b = "localContentStream";
                            break;
                        default:
                            Logger.error("RTCUtils: Unknown stream type. Stream label: " + a.bjn_label)
                    }
                    return b
                },
                getRemoteStreamType: function(a) {
                    return "stream_label" === a.id ? "remoteStream" : "remoteContentStream"
                }
            });
        return new e
    }), ! function(a) {
        if ("object" == typeof exports && "undefined" != typeof module) module.exports = a();
        else if ("function" == typeof define && define.amd) define("socket.io-client", [], a);
        else {
            var b;
    ...
    }), define("WebRTC_SDK/utilities/RTCErrors", ["require", "my.Class", "Logger", "q"], function(a) {
        var b = a("my.Class"),
            c = a("Logger"),
            d = (a("q"), b.Class({
                constructor: function(a) {
                ...
                translateGetUserMediaError: function(a) {
                    var b = {},
                        d = this.GET_LOCAL_MEDIA_STATES;
                    switch (a.name) {
                        case "DevicesNotFoundError":
                            b = d.DEVICES_NOT_FOUND;
                            break;
                        case "PermissionDeniedError":
                            b = d.PERMISSION_DENIED;
                            break;
                        case "SourceUnavailableError":
                            b = d.SOURCE_UNAVAILABLE;
                            break;
                        default:
                            c.warn("Unhandled error in getUserMedia: ", a), b = d.EXCEPTION
                    }
                    return b.details = a, b
                },
                detectCameraStatus: function(a) {
                    var b, d = !1,
                        e = this;
                    return a && "function" == typeof a.getVideoTracks ? (b = a.getVideoTracks()[0], b ? "ended" === b.readyState ? (d = !1, c.warn("RTCErrors: Camera feed is unavailable, faulty camera or its in use by another program"), e.GET_LOCAL_MEDIA_STATES.SOURCE_UNAVAILABLE) : (d = !0, e.GET_LOCAL_MEDIA_STATES.AVAILABLE) : (c.warn("RTCErrors: No video tracks available in the stream, triggering camera unavailable state"), this.GET_LOCAL_MEDIA_STATES.SOURCE_UNAVAILABLE)) : this.GET_LOCAL_MEDIA_STATES.DEVICES_NOT_FOUND
                }
            }));
        return new d
    }), define("WebRTC_SDK/utilities/RTCMessageParser", ["require", "my.Class", "underscore", "Logger", "WebRTC_SDK/utilities/RTCBlueJay", "WebRTC_SDK/utilities/RTCErrors"], function(a) {
        var b = a("my.Class"),
            c = a("underscore"),
            d = a("Logger"),
            e = a("WebRTC_SDK/utilities/RTCBlueJay"),
            f = a("WebRTC_SDK/utilities/RTCErrors"),
            g = b.Class({
                STATIC: {
                    SUPPORTED_METHODS: c.values(e.METHODS),
                    ERROR: f.SIGNALING_ERRORS
                },
                constructor: function(a) {
                    c.bindAll(this), this.callbacks = a.callbacks
                },
                getMessgeType: function(a) {
                    return c.isUndefined(a.id) ? "notification" : c.isEmpty(a.error) ? c.isEmpty(a.result) ? c.isEmpty(a.params) ? (d.error("Message passed is in invalid format. Supported message types are: request, response, error, notification"), "invalid") : "request" : "response" : "error"
                },
                parseIncomingMessage: function(a) {
                    var b = this,
                        c = JSON.parse(a),
                        d = function(a) {
                            b.callbacks.invalidMessage.apply(b, [c, a])
                        },
                        e = function() {
                            var a = b.getMessgeType(c);
                            "function" == typeof b.callbacks[a] && b.callbacks[a].apply(b, [c])
                        };
                    this.validateMessage(c, e, d)
                },
                validateMessage: function(a, b, f) {
                    var h = e.getCallId();
                    c.isNull(a.call) || c.isUndefined(a.call) ? (d.error("Invalid message received from Remote Server, 'call' field not defined in message"), f(g.ERROR.BAD_REQUEST)) : a.call !== h ? (d.error("Invalid call id, Transaction does not exists"), f(g.ERROR.DOESNOT_EXIST)) : c.isUndefined(a.method) || -1 !== c.indexOf(g.SUPPORTED_METHODS, a.method) ? b() : (d.error("Invalid message received from Remote Server, 'method' passed is not supported: " + a.method), f(g.ERROR.METHOD_NOT_IMPLEMENTED))
                }
            });
        return g
    }), define("WebRTC_SDK/RTCStates", ["require", "my.Class", "Logger"], function(a) {
        var b = a("my.Class"),
            c = (a("Logger"), b.Class({
                constructor: function(a) {
                    this.BJ_CALLSTATES = {
                ...
                addWebrtcStatePrefix: function(a, b) {
                    var c = {};
                    return _.forEach(b, function(b, d) {
                        c[d] = a + b
                    }), c
                }
            }));
        return new c
    }), define("WebRTC_SDK/manager/RTCSignallingManager", ["require", "my.Class", "underscore", "Logger", "socket.io-client", "WebRTC_SDK/utilities/RTCBlueJay", "WebRTC_SDK/utilities/RTCMessageParser", "WebRTC_SDK/RTCStates", "backbone"], function(a) {
        var b = a("my.Class"),
            c = a("underscore"),
            d = a("Logger"),
            e = a("socket.io-client"),
            f = (a("WebRTC_SDK/utilities/RTCBlueJay"), a("WebRTC_SDK/utilities/RTCMessageParser")),
            g = a("WebRTC_SDK/RTCStates"),
            h = a("backbone"),
            i = b.Class({
                STATIC: {
                    MESSAGE_BASE: {
                ...
                constructor: function(a) {
                    c.bindAll(this), c.extend(this.config, a), c.extend(this, h.Events), this.isConnected = !1, this.WS_STATES = g.WS_STATES
                },
                createSocket: function(a) {
                    this.socket = e.connect(a.sockUrl, this.config.socketioOpts), this.setupListeners()
                },
                setupListeners: function() {
                    this.socket.on("message", this.handleMessage), this.socket.on("connect", this.socketConnected), this.socket.on("error", this.socketError), this.socket.on("disconnect", this.socketDisconnect), this.socket.on("reconnecting", this.socketReconnecting), this.socket.on("reconnect_failed", this.socketReconnectFailed), this.socket.on("reconnect", this.socketReconnect), this.socket.on("connect_error", this.onConnectError)
                },
                setupMessageParser: function(a) {
                    this.messageParser = new f({
                        callbacks: a
                    })
                },
                handleMessage: function(a) {
                    d.debug("RTCSignallingManager: Received message on socket: " + a), this.messageParser.parseIncomingMessage(a)
                },
                socketConnected: function() {
                    this.isConnected = !0, this.config.socketId = this.socket.id, this.trigger("wsConnectionStateChange", this.WS_STATES.CONNECTED, this.socket.id), d.debug("RTCSignallingManager: Socket connected successfully")
                },
                socketError: function(a) {
                    this.isConnected = !1, this.trigger("wsConnectionStateChange", this.WS_STATES.DISCONNECTED, this.config.socketId), d.error("RTCSignallingManager: Received 'error' message on socket")
                },
                socketDisconnect: function(a) {
                    this.isConnected = !1, this.trigger("wsConnectionStateChange", this.WS_STATES.DISCONNECTED, this.config.socketId), "io client disconnect" === a ? d.debug("RTCSignallingManager: Socket disconnected, initiated by client: ", a) : d.error("RTCSignallingManager: Socket disconnected, not initiated by client: ", a)
                },
                socketReconnecting: function(a) {
                    this.isConnected = !1, d.debug("RTCSignallingManager: Reconnecting socket, reconnect attempt ", a)
                },
                socketReconnectFailed: function() {
                    this.isConnected = !1, this.trigger("wsConnectionStateChange", this.WS_STATES.FAILED, this.config.socketId), d.debug("RTCSignallingManager: Socket reconnection failed")
                },
                socketReconnect: function() {
                    d.debug("RTCSignallingManager: Socket reconnected"), this.isConnected = !0, this.config.socketId = this.socket.id, this.trigger("wsConnectionStateChange", this.WS_STATES.RECONNECTED, this.socket.id)
                },
                onConnectError: function(a) {
                    d.debug("RTCSignallingManager :: connect error : " + a)
                },
                sendMsg: function(a) {
                    return c.isNull(a.call) || c.isUndefined(a.call) ? (d.warn("RTCSignallingManager: Invalid BlueJay message, 'call' field is missing"), !1) : a.id ? this.isConnected ? (this.socket.emit("message", JSON.stringify(a)), d.debug("RTCSignallingManager: Sending socket message: " + JSON.stringify(a)), !0) : (d.warn("RTCSignallingManager: Socket is not connected, Message :: " + JSON.stringify(a)), !1) : (d.warn("RTCSignallingManager: Invalid BlueJay message, 'id' field is missing"), !1)
                },
                close: function() {
                    this.socket ? (this.isConnected = !1, this.socket.disconnect(), this.socket = null) : d.warn("RTCSignallingManager: Socket has already been closed.")
                }
            });
        return new i
    }), define("WebRTC_SDK/models/RTCTransactionModel", ["require", "underscore", "backbone"], function(a) {
        var b = a("underscore"),
            c = a("backbone"),
            d = c.Model.extend({
                defaults: {
                    ...
                    bluejayMuteMsg: {},
                    bluejayTokenMsg: {},
                    connectResponseReceived: !1,
                    callState: "idle"
                },
                addRequest: function(a, b) {
                    this.get("bluejayReqMap")[a] = b
                },
                updateRequest: function(a, b) {
                    this.get("bluejayReqMap")[a] = b
                },
                removeRequest: function(a) {
                    this.get("bluejayReqMap")[a] && this.unset("bluejayReqMap" [a], {
                        silent: !0
                    })
                },
                addResponse: function(a, b) {
                    this.get("bluejayRespMap")[a] = b
                },
                getRequest: function(a) {
                    return this.get("bluejayReqMap")[a]
                },
                getResponse: function(a) {
                    return this.get("bluejayRespMap")[a]
                },
                addKeepAlive: function(a) {
                    this.set("bluejayKeepAlive", a)
                },
                addMuteMessage: function(a) {
                    this.set("bluejayMuteMsg", a)
                },
                addTokenMessage: function(a) {
                    this.set("bluejayTokenMsg", a)
                },
                ...
                getAllRequestMsgIds: function() {
                    return b.keys(this.get("bluejayReqMap"))
                },
    ...
    function(a) {
        a("state_machine", ["require", "exports", "module", "lodash"], function(a, b, c) {
            function d(a, b) {
            ...
            var e = a("lodash"),
                f = function(a, b) {
                    return {
                        call: function(c, d) {
                            void 0 !== a.from && a.from !== c || void 0 !== a.to && a.to !== d || b({
                                from: c,
                                to: d
                            })
                        }
                ...
                g = {
                    transition: function(a) {
                        return function(b, c) {
                            var d = Array.isArray(a) ? e.find(a, function(a) {
                                return a.from == b.getState()
                            }) : a;
                            return d && void 0 !== d.from && (b.getState() == d.from || e.include(d.from, b.getState())) ? (c(b.getState(), d.to, d.resetTriggers), !0) : void 0
                        }
                    },
                    afterTransition: function(a, b) {
                        return e.extend(f(a, b), {
                            beforeTransition: !1
                        })
                    },
                ...
                h = {
                    anyOf: function(a) {
                        return {
                            isFulfilled: function(a) {
                                return !e.isEmpty(this.matchingTriggers(a))
                            },
                            matchingTriggers: function(b) {
                    ...
                    allOf: function(a) {
                        return {
                            isFulfilled: function(a) {
                                return e.isEmpty(e.difference(this.matchingTriggers(a), a))
                            },
                ...
                i = function(a) {
                    function b(a, b, c) {
                        a && e.each(a, function(a) {
                            a.call(b, c)
                        })
                    }

                    function c() {
                        e.each(f.triggers, function(a) {
                            var b = a.activatedBy.isFulfilled(g.activatedTriggers);
                            if (b && f[a.event]()) {
                                var c = a.activatedBy.matchingTriggers(g.activatedTriggers);
                                g.activatedTriggers = e.difference(g.activatedTriggers, c)
                            }
                        })
                    }
                    d(void 0 !== a.initial, "initial state is mandatory");
                    var f = {};
                    f.events = a.events, f.triggers = a.triggers, f.callbacks = a.callbacks;
                    var g = {
                            state: a.initial,
                            activatedTriggers: []
                        },
                        h = function(a, c, d) {
                            var h = e.groupBy(f.callbacks, function(a) {
                                    return a.beforeTransition === !0
                                }),
                                i = h[!0];
                            i && b(i, a, c), g.state = c;
                            var j = h[!1];
                            j && b(j, a, c), d === !0 && (g.activatedTriggers = [])
                        };
                    return f.getState = function() {
                        return g.state
                    }, e.each(e.keys(f.events), function(b) {
                        var c = a.events[b];
                        d(void 0 !== c), f[b] = function() {
                            return c(f, h)
                        }
                    }), f.trigger = function(a) {
                        g.activatedTriggers.push(a), c()
                    }, f
                };
            return {
                create: i,
    ...
    }("object" == typeof module && "function" != typeof define ? function(a) {
        module.exports = a(require, exports, module)
    } : define), define("WebRTC_SDK/manager/RTCStateManager", ["require", "my.Class", "underscore", "backbone", "Logger", "state_machine", "WebRTC_SDK/RTCStates"], function(a) {
        var b = a("my.Class"),
            c = a("underscore"),
            d = a("backbone"),
            e = a("Logger"),
            ...
            h = d.Model.extend({
                ...
                setCurrentState: function(a) {
                    var b = this.get("currentState"),
                        c = this.get("prevState");
                    a !== b && (c.push(b), this.set("currentState", a)), this.logStateTransition()
                },
                logStateTransition: function() {
                    e.debug("RTCStateManager: Call State: " + this.get("currentState") + ", Ice-Gathering: " + this.get("iceGatheringState") + ", Ice-Connection: " + this.get("iceConnectionState") + ", Signaling: " + this.get("signalingState"))
                },
            ...
            i = b.Class({
                STATIC: {
                    BJ_CALLSTATES: g.BJ_CALLSTATES,
                    ICE_G_STATES: g.addWebrtcStatePrefix("iceG_", g.WEBRTC_STATES.iceGatheringState),
                    ICE_C_STATES: g.addWebrtcStatePrefix("ice_", g.WEBRTC_STATES.iceConnectionState),
                    SIG_STATES: g.addWebrtcStatePrefix("sig_", g.WEBRTC_STATES.signalingState),
                    STATE_EVTS: g.STATE_EVENTS
                },
                constructor: function(a) {
                    c.bindAll(this), c.extend(this, d.Events), this.model = new h, this.stateMachine = this.initStateMachine()
                },
                initStateMachine: function() {
                    var a = f.transitions.transition,
                        b = f.triggers.anyOf,
                        d = f.triggers.allOf,
                        e = i.BJ_CALLSTATES,
                        g = i.ICE_C_STATES,
                    ...
                    return f.create({
                        ...
                        events: {
                            ...
                            disconnect: a({
                                from: c.without(c.values(e), e.DISCONNECTED),
                                to: e.DISCONNECTED,
                                resetTriggers: !0
                            }),
                            reset: a({
                                from: c.without(c.values(e), e.IDLE),
                                to: e.IDLE,
                                resetTriggers: !0
                            })
                        },
                        triggers: [{
                            event: k.INITIALISE,
                            activatedBy: d([j.HAVE_LOCAL_OFFER])
                        }, {
                            event: k.CONNECT,
                            activatedBy: b([h.GATHERING, h.COMPLETE])
                        }, {
                            event: k.START_MEDIA,
                            activatedBy: d([j.STABLE])
                        }, {
                            event: k.ESTABLISH_CONNECTION,
                            activatedBy: b([g.COMPLETED, g.CONNECTED])
                        }, {
                            event: k.MEDIA_DISRUPTION,
                            activatedBy: d([g.DISCONNECTED])
                        }, {
                            event: k.DISCONNECT,
                            activatedBy: d([g.FAILED, g.CLOSED])
                        }],
                        callbacks: [f.transitions.afterTransition({}, l)]
                    })
                },
                iceGatheringStateChange: function(a) {
                    this.model.set("iceGatheringState", a), this.stateMachine.trigger("iceG_" + a)
                },
                signalingStateChange: function(a) {
                    this.model.set("signalingState", a), this.stateMachine.trigger("sig_" + a)
                },
                iceConnectionStateChange: function(a) {
                    this.model.set("iceConnectionState", a), this.stateMachine.trigger("ice_" + a)
                },
                callDisconnected: function(a) {
                    this.stateMachine.disconnect(), this._updateDisconnectState(a), this.model.setCurrentState(this.stateMachine.getState())
                },
                _updateDisconnectState: function(a) {
                    var b = a && a.code || "",
                        c = a && a.message || "";
                    b && (b = "string" == typeof b ? parseInt(b, 10) : b, this.model.set({
                        disconnectCode: b,
                        disconnectReason: {
                            code: b,
                            message: c
                ...
                callStateChange: function(a) {
                    "disconnected" !== a.to && this.model.setCurrentState(a.to)
                },
                reset: function() {
                    this.stateMachine.reset(), this.model.setCurrentState(this.stateMachine.getState())
                }
            });
        return new i
    }), define("WebRTC_SDK/manager/RTCTransactionManager", ["require", "my.Class", "underscore", "q", "backbone", "WebRTC_SDK/models/RTCTransactionModel", "WebRTC_SDK/utilities/RTCBlueJay", "WebRTC_SDK/RTCStates", "Logger", "WebRTC_SDK/manager/RTCStateManager"], function(a) {
        var b = a("my.Class"),
            c = a("underscore"),
            d = (a("q"), a("backbone")),
            e = a("WebRTC_SDK/models/RTCTransactionModel"),
            f = a("WebRTC_SDK/utilities/RTCBlueJay"),
            g = (a("WebRTC_SDK/RTCStates"), a("Logger")),
            h = (a("WebRTC_SDK/manager/RTCStateManager"), b.Class({
                config: {
                    requestTimeout: 5e3,
                ...
                constructor: function() {
                    c.bindAll(this), c.extend(this, d.Events), this.model = new e, this.requestTimers = {}
                },
                onRequest: function(a) {
                    var b = this,
                        c = function() {
                            b.onRequestTimeout(a)
                        };
                    this.requestTimers[a] = setInterval(c, this.config.requestTimeout)
                },
                onBlueJayRequest: function(a) {
                    switch (this.model.addRequest(a.id, {
                        method: a.method,
                        message: a,
                        state: "init",
                        ...
                        case f.METHODS.MUTE:
                            var b = this.model.getMuteMessage();
                            c.isUndefined(b) || this.removeRequestTransaction(b), this.model.addMuteMessage(a.id);
                            break;
                        case f.METHODS.TOKEN:
                            var d = this.model.getTokenMessage();
                            c.isUndefined(d) || this.removeRequestTransaction(d), this.model.addTokenMessage(a.id)
                    }
                    this.onRequest(a.id)
                },
                removeRequestTransaction: function(a) {
                    c.isUndefined(this.requestTimers[a]) || (clearInterval(this.requestTimers[a]), delete this.requestTimers[a]), this.model.removeRequest(a)
                },
                onOutgoingBlueJayResponse: function(a, b) {
                    this.model.addResponse(a, {
                        response: b
                    })
                },
                onIncomingBlueJayResponse: function(a) {
                    var b = this.model.getRequest(a);
                    if (c.isUndefined(b)) this.model.get("bluejayKeepAlive").messageId == a && this.model.addKeepAlive({
                        messageId: a,
                        state: "finished"
                    });
                    else switch (this.removeRequestTransaction(a), b.method) {
                        case f.METHODS.CONNECT:
                            this.model.set("connectResponseReceived", !0), this.trigger("receivedConnectResponse");
                            break;
                        case f.METHODS.DISCONNECT:
                            this.trigger("closeSocketConnection")
                    }
                },
                lookupOutgoingResponse: function(a) {
                    return this.model.getResponse(a)
                },
                onKeepaliveRequest: function(a) {
                ...
                onRequestTimeout: function(a) {
                    var b = this.model.getRequest(a);
                    if (b.method === f.METHODS.DISCONNECT) return this.removeRequestTransaction(a), void this.trigger("closeSocketConnection");
                    if (!c.isUndefined(b)) switch (b.state) {
                        case "init":
                        case "resend":
                            this.retransmitRequest(b, a)
                    }
                },
                retransmitRequest: function(a, b) {
                    a.retransmitAttempts >= this.config.maxRetransmitAttempts ? (g.warn("RTCTransactionManager: Request timeout occured for - Method :" + a.method + " :: Id - " + b), this.removeRequestTransaction(b), this.trigger("requestTimeout", {
                        messageId: b,
                        method: a.method
                    })) : (a.state = "resend", a.retransmitAttempts++, this.trigger("retransmitRequest", a.message), this.model.addRequest(b, a))
                },
                getRequestMessage: function(a) {
                    return this.model.getRequest(a).message
                },
                updateCallState: function(a) {
                    this.model.set("callState", a)
                },
                reset: function() {
                    c.each(this.requestTimers, function(a) {
                        clearInterval(a)
                    }), this.model.resetTransaction(), this.model.set("connectResponseReceived", !1)
                }
            }));
        return new h
    }), ! function(a) {
        if ("object" == typeof exports && "undefined" != typeof module) module.exports = a();
        else if ("function" == typeof define && define.amd) define("util", [], a);
        else {
            var b;
            "undefined" != typeof window ? b = window : "undefined" != typeof global ? b = global : "undefined" != typeof self && (b = self), b.util = a()
        }
    }(function() {
                ...
                (function(b, d) {
                    ...
                    function m(a, b, c, d, e, f) {
                        ...
                        if (j = Object.getOwnPropertyDescriptor(b, e) || {
                                value: b[e]
                            }, j.get ? h = j.set ? a.stylize("[Getter/Setter]", "special") : a.stylize("[Getter]", "special") : j.set && (h = a.stylize("[Setter]", "special")), D(d, e) || (g = "[" + e + "]"), h || (a.seen.indexOf(j.value) < 0 ? (h = q(c) ? i(a, j.value, null) : i(a, j.value, c - 1), h.indexOf("\n") > -1 && (h = f ? h.split("\n").map(function(a) {
                                return "  " + a
                            }).join("\n").substr(2) : "\n" + h.split("\n").map(function(a) {
                                return "   " + a
                    ...
                    c.debuglog = function(a) {
                        if (v(F) && (F = b.env.NODE_DEBUG || ""), a = a.toUpperCase(), !G[a])
                            if (new RegExp("\\b" + a + "\\b", "i").test(F)) {
                                b.pid;
                                G[a] = function() {
    ...
    function(a) {
        if ("function" == typeof bootstrap) bootstrap("hark", a);
        else if ("object" == typeof exports) module.exports = a();
        else if ("function" == typeof define && define.amd) define("hark", a);
        else if ("undefined" != typeof ses) {
            if (!ses.ok()) return;
            ses.makeHark = a
        } else "undefined" != typeof window ? window.hark = a() : global.hark = a()
    }(function() {
        return function(a, b, c) {
            ...
            1: [function(a, b, c) {
                ...
                b.exports = function(a, b) {
                    ...
                    g || (g = new f);
                    var n, o, p;
                    p = g.createAnalyser(), p.fftSize = 512, p.smoothingTimeConstant = h, o = new Float32Array(p.fftSize), a.jquery && (a = a[0]), a instanceof HTMLAudioElement || a instanceof HTMLVideoElement ? (n = g.createMediaElementSource(a), "undefined" == typeof k && (k = !0), j = j || -50) : (n = g.createMediaStreamSource(a), j = j || -50), n.connect(p), k && p.connect(g.destination), c.speaking = !1, c.setThreshold = function(a) {
                        j = a
                    }, c.setInterval = function(a) {
                        i = a
                    }, c.stop = function() {
                        m = !1, c.emit("volume_change", -100, j), c.speaking && (c.speaking = !1, c.emit("stopped_speaking"))
                    }, c.speakingHistory = [];
                    for (var q = 0; l > q; q++) c.speakingHistory.push(0);
                    var r = function() {
                        setTimeout(function() {
                            if (m) {
                                var a = d(p, o);
                                c.emit("volume_change", a, j);
                                var b = 0;
                                if (a > j && !c.speaking) {
                                    for (var e = c.speakingHistory.length - 3; e < c.speakingHistory.length; e++) b += c.speakingHistory[e];
                                    b >= 2 && (c.speaking = !0, c.emit("speaking"))
                                } else if (j > a && c.speaking) {
                                    for (var e = 0; e < c.speakingHistory.length; e++) b += c.speakingHistory[e];
                                    0 == b && (c.speaking = !1, c.emit("stopped_speaking"))
                                }
                                c.speakingHistory.shift(), c.speakingHistory.push(0 + (a > j)),
                                    r()
                            }
                        }, i)
                    };
            ...
            2: [function(a, b, c) {
                ...
                b.exports = d, d.prototype.on = function(a, b, c) {
                    var d = 3 === arguments.length,
                        e = d ? arguments[1] : void 0,
                        f = d ? arguments[2] : arguments[1];
                    return f._groupName = e, (this.callbacks[a] = this.callbacks[a] || []).push(f), this
                }, d.prototype.once = function(a, b, c) {
                    function d() {
                        e.off(a, d), h.apply(this, arguments)
                    }
                    var e = this,
                        f = 3 === arguments.length,
                        g = f ? arguments[1] : void 0,
                        h = f ? arguments[2] : arguments[1];
                    return this.on(a, g, d), this
                }, d.prototype.releaseGroup = function(a) {
                    var b, c, d, e;
                    ...
                    return d ? 1 === arguments.length ? (delete this.callbacks[a], this) : (c = d.indexOf(b), d.splice(c, 1), this) : this
                }, d.prototype.emit = function(a) {
                    ...
                    return this
                }, d.prototype.getWildcardCallbacks = function(a) {
                    var b, c, d = [];
    ...
    }), define("webrtcsupport", ["require", "exports", "module"], function(a, b, c) {
        var d, e;
        window.mozRTCPeerConnection || navigator.mozGetUserMedia ? (d = "moz", e = parseInt(navigator.userAgent.match(/Firefox\/([0-9]+)\./)[1], 10)) : (window.webkitRTCPeerConnection || navigator.webkitGetUserMedia) && (d = "webkit", e = navigator.userAgent.match(/Chrom(e|ium)/) && parseInt(navigator.userAgent.match(/Chrom(e|ium)\/([0-9]+)\./)[2], 10));
        var f = window.mozRTCPeerConnection || window.webkitRTCPeerConnection,
            g = window.mozRTCIceCandidate || window.RTCIceCandidate,
            h = window.mozRTCSessionDescription || window.RTCSessionDescription,
            i = window.webkitMediaStream || window.MediaStream,
            j = "https:" === window.location.protocol && ("webkit" === d && e >= 26 || "moz" === d && e >= 33),
            k = window.AudioContext || window.webkitAudioContext,
            l = document.createElement("video"),
            m = l && l.canPlayType && "probably" === l.canPlayType('video/webm; codecs="vp8", vorbis'),
            n = navigator.getUserMedia || navigator.webkitGetUserMedia || navigator.msGetUserMedia || navigator.mozGetUserMedia;
        c.exports = {
            prefix: d,
            browserVersion: e,
            support: !!f && m && !!n,
            supportRTCPeerConnection: !!f,
            supportVp8: m,
            supportGetUserMedia: !!n,
            supportDataChannel: !!(f && f.prototype && f.prototype.createDataChannel),
            supportWebAudio: !(!k || !k.prototype.createMediaStreamSource),
            supportMediaStream: !(!i || !i.prototype.removeTrack),
            supportScreenSharing: !!j,
            dataChannel: !!(f && f.prototype && f.prototype.createDataChannel),
            webAudio: !(!k || !k.prototype.createMediaStreamSource),
            mediaStream: !(!i || !i.prototype.removeTrack),
            screenSharing: !!j,
            AudioContext: k,
            PeerConnection: f,
    ...
    function(a) {
        if ("object" == typeof exports && "undefined" != typeof module) module.exports = a();
        else if ("function" == typeof define && define.amd) define("getusermedia", [], a);
        else {
            var b;
            b = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this, b.getUserMedia = a()
        }
    }(function() {
        return function a(b, c, d) {
            function e(g, h) {
            ...
            1: [function(a, b, c) {
                b.exports = function(a, b) {
                    var c, d = 2 === arguments.length,
                        ...
                        g = "PERMISSION_DENIED",
                        h = "ConstraintNotSatisfiedError";
                    return d || (b = a, a = e), "undefined" != typeof navigator && navigator.getUserMedia ? a.audio || a.video ? void navigator.mediaDevices.getUserMedia(a).then(function(a) {
                        b(null, a)
                    })["catch"](function(a) {
                        var c;
                        "string" == typeof a ? (c = new Error("MediaStreamError"), a === f || a === g ? c.name = f : c.name = h) : (c = a, c.name || (c[f] ? a.name = f : a.name = h)), b(c)
                    }) : (c = new Error("MediaStreamError"), c.name = "NoMediaRequestedError", setTimeout(function() {
                        b(c)
                    }, 0)) : (c = new Error("MediaStreamError"), c.name = "NotSupportedError", setTimeout(function() {
                        b(c)
                    }, 0))
                }
            }, {}]
        ...
        "object" == typeof exports ? module.exports = a() : "function" == typeof define && define.amd ? define("getscreenmedia", a) : "undefined" != typeof window ? window.getScreenMedia = a() : "undefined" != typeof global ? global.getScreenMedia = a() : "undefined" != typeof self && (self.getScreenMedia = a())
    }(function() {
        return function a(b, c, d) {
            function e(g, h) {
                if (!c[g]) {
            ...
            1: [function(a, b, c) {
                var d = a("getusermedia"),
                    e = {};
                b.exports = function(a, b) {
                    var c, f = 2 === arguments.length,
                        g = f ? b : a;
                    if ("undefined" == typeof window || "http:" === window.location.protocol) return c = new Error("NavigatorUserMediaError"), c.name = "HTTPS_REQUIRED", g(c);
                    if (window.navigator.userAgent.match("Chrome")) {
                        var h = parseInt(window.navigator.userAgent.match(/Chrome\/(.*) /)[1], 10),
                            i = 33,
                            j = !window.chrome.webstore;
                        if (window.navigator.userAgent.match("Linux") && (i = 35), j || h >= 26 && i >= h) a = f && a || {
                            video: {
                                mandatory: {
                                    googLeakyBucket: !0,
                            ...
                            var k = window.setTimeout(function() {
                                return c = new Error("NavigatorUserMediaError"), c.name = "EXTENSION_UNAVAILABLE", g(c)
                            }, 1e3);
                            e[k] = [g, f ? constraint : null], window.postMessage({
                                type: "getScreen",
                                id: k
                            }, "*")
                        }
                        ...
                        l >= 33 ? (a = f && a || {
                            ...
                            if (g(a, b), !a) var c = b.currentTime,
                                d = window.setInterval(function() {
                                    b || window.clearInterval(d), b.currentTime == c && (window.clearInterval(d), b.onended && b.onended()), c = b.currentTime
                                }, 500)
                        })) : (c = new Error("NavigatorUserMediaError"), c.name = "EXTENSION_UNAVAILABLE")
                    }
                }, window.addEventListener("message", function(a) {
                    if (a.origin == window.location.origin)
                        if ("gotScreen" == a.data.type && e[a.data.id]) {
                            var b = e[a.data.id],
                                c = b[1],
                                f = b[0];
                            if (delete e[a.data.id], "" === a.data.sourceId) {
                            ...
                            }, c.video.mandatory.chromeMediaSourceId = a.data.sourceId, d(c, f)
            ...
            2: [function(a, b, c) {
                var d = window.navigator.getUserMedia || window.navigator.webkitGetUserMedia || window.navigator.mozGetUserMedia || window.navigator.msGetUserMedia;
                b.exports = function(a, b) {
                    var c, e = 2 === arguments.length,
                        f = {
                            video: !0,
                            audio: !0
                        },
                        ...
                        h = "ConstraintNotSatisfiedError";
                    if (e || (b = a, a = f), !d) return c = new Error("MediaStreamError"), c.name = "NotSupportedError", window.setTimeout(function() {
                        b(c)
                    }, 0);
                    var i = window.location.protocol;
                    return "http:" !== i && "https:" !== i ? (c = new Error("MediaStreamError"), c.name = "NotSupportedError", window.setTimeout(function() {
                        b(c)
                    }, 0)) : a.audio || a.video ? (localStorage && "true" === localStorage.useFirefoxFakeDevice && (a.fake = !0), void d.call(window.navigator, a, function(a) {
                        b(null, a)
                    }, function(a) {
                        var c;
                        "string" == typeof a ? (c = new Error("MediaStreamError"), a === g ? c.name = g : c.name = h) : (c = a, c.name || (c[g] ? a.name = g : a.name = h)), b(c)
                    })) : (c = new Error("MediaStreamError"), c.name = "NoMediaRequestedError", window.setTimeout(function() {
                        b(c)
                    }, 0))
                }
            }, {}]
        }, {}, [1])(1)
    }), define("wildemitter", ["require", "exports", "module"], function(a, b, c) {
        function d() {
            this.callbacks = {}
        }
        c.exports = d, d.prototype.on = function(a, b, c) {
            var d = 3 === arguments.length,
                e = d ? arguments[1] : void 0,
                f = d ? arguments[2] : arguments[1];
            return f._groupName = e, (this.callbacks[a] = this.callbacks[a] || []).push(f), this
        ...
        "object" == typeof exports ? module.exports = a() : "function" == typeof define && define.amd ? define("mediastream-gain", a) : "undefined" != typeof window ? window.MediaStreamGainController = a() : "undefined" != typeof global ? global.MediaStreamGainController = a() : "undefined" != typeof self && (self.MediaStreamGainController = a())
    }(function() {
        return function a(b, c, d) {
            function e(g, h) {
                if (!c[g]) {
            ...
            1: [function(a, b, c) {
                function d(a) {
                    if (this.support = e.webAudio && e.mediaStream, this.gain = 1, this.support) {
                        var b = this.context = new e.AudioContext;
                        this.microphone = b.createMediaStreamSource(a), this.gainFilter = b.createGain(), this.destination = b.createMediaStreamDestination(), this.outputStream = this.destination.stream, this.microphone.connect(this.gainFilter), this.gainFilter.connect(this.destination), a.addTrack(this.outputStream.getAudioTracks()[0]), a.removeTrack(a.getAudioTracks()[0])
                    }
                    this.stream = a
                }
                var e = a("webrtcsupport");
                d.prototype.setGain = function(a) {
                    this.support && (this.gainFilter.gain.value = a, this.gain = a)
                }, d.prototype.getGain = function() {
                    return this.gain
            ...
            2: [function(a, b, c) {
                var d, e = !1,
                    f = !1,
                    g = window.navigator.userAgent.toLowerCase(); - 1 !== g.indexOf("firefox") ? (d = "moz", f = !0) : -1 !== g.indexOf("chrome") && (d = "webkit", e = !0);
                var h = window.mozRTCPeerConnection || window.webkitRTCPeerConnection,
                    i = window.mozRTCIceCandidate || window.RTCIceCandidate,
                    j = window.mozRTCSessionDescription || window.RTCSessionDescription,
                    k = window.webkitMediaStream || window.MediaStream,
                    l = window.navigator.userAgent.match("Chrome") && parseInt(window.navigator.userAgent.match(/Chrome\/(.*) /)[1], 10) >= 26,
                    m = window.AudioContext;
                b.exports = {
                    support: !!h,
                    dataChannel: e || f || h && h.prototype && h.prototype.createDataChannel,
                    prefix: d,
                    webAudio: !(!m || !m.prototype.createMediaStreamSource),
                    mediaStream: !(!k || !k.prototype.removeTrack),
                    screenSharing: !!l,
                    AudioContext: m,
                    PeerConnection: h,
    ...
    function(a) {
        if ("function" == typeof bootstrap) bootstrap("mockconsole", a);
        else if ("object" == typeof exports) module.exports = a();
        else if ("function" == typeof define && define.amd) define("mockconsole", a);
        else if ("undefined" != typeof ses) {
            if (!ses.ok()) return;
            ses.makeMockconsole = a
        } else "undefined" != typeof window ? window.mockconsole = a() : global.mockconsole = a()
    }(function() {
        return function(a, b, c) {
            function d(c, f) {
                if (!b[c]) {
            ...
            1: [function(a, b, c) {
                for (var d = "assert,count,debug,dir,dirxml,error,exception,group,groupCollapsed,groupEnd,info,log,markTimeline,profile,profileEnd,time,timeEnd,trace,warn".split(","), e = d.length, f = function() {}, g = {}; e--;) g[d[e]] = f;
                b.exports = g
            }, {}]
        }, {}, [1])(1)
    }), define("localmedia", ["require", "util", "hark", "webrtcsupport", "getusermedia", "getscreenmedia", "wildemitter", "mediastream-gain", "mockconsole"], function(a) {
        function b(a) {
            h.call(this);
            var b, c = this.config = {
                autoAdjustMic: !1,
            ...
            this.logger = c.logger, this._log = this.logger.log.bind(this.logger, "LocalMedia:"), this._logerror = this.logger.error.bind(this.logger, "LocalMedia:"), this.screenSharingSupport = e.screenSharing, this.localStreams = [], this.localScreens = [], e.support || this._logerror("Your browser does not support local media capture.")
        }
        var c = a("util"),
            d = a("hark"),
            e = a("webrtcsupport"),
            ...
            g = a("getscreenmedia"),
            h = a("wildemitter"),
            i = a("mediastream-gain"),
            j = a("mockconsole");
        return c.inherits(b, h), b.prototype.start = function(a, b) {
            var c = this,
                d = a || this.config.media;
            f(d, function(a, e) {
                if (a) {
                    if (c.config.audioFallback && "DevicesNotFoundError" === a.name && d.video !== !1) return d.video = !1, void c.start(d, b)
                } else d.audio && c.config.detectSpeakingEvents && c.setupAudioMonitor(e, c.config.harkOptions), c.localStreams.push(e), c.config.autoAdjustMic && (c.gainController = new i(e), c.setMicIfEnabled(.5)), e.onended = function() {}, c.emit("localStream", e);
                return b ? b(a, e) : void 0
            })
            ...
            if (a) {
                ...
                c > -1 ? (b.emit("localStreamStopped", a), b.localStreams = b.localStreams.splice(c, 1)) : (c = b.localScreens.indexOf(a), c > -1 && (b.emit("localScreenStopped", a), b.localScreens = b.localScreens.splice(c, 1)))
            } else this.stopStreams(), this.stopScreenShare()
        }, b.prototype.stopStreams = function() {
            var a = this;
            this.audioMonitor && (this.audioMonitor.stop(), delete this.audioMonitor), this.localStreams.forEach(function(b) {
                b.getTracks().forEach(function(a) {
                    a.stop()
                }), a.emit("localStreamStopped", b)
            }), this.localStreams = []
        }, b.prototype.startScreenShare = function(a) {
            var b = this;
            g(function(c, d) {
        ...
        }, b.prototype.stopScreenShare = function(a) {
            var b = this;
            a ? (a.getTracks().forEach(function(a) {
                a.stop()
            }), this.emit("localScreenStopped", a)) : (this.localScreens.forEach(function(a) {
                a.getTracks().forEach(function(a) {
                    a.stop()
                }), b.emit("localScreenStopped", a)
            }), this.localScreens = [])
        ...
        }, b.prototype.isVideoEnabled = function() {
            var a = !0;
            return this.localStreams.forEach(function(b) {
                b.getVideoTracks().forEach(function(b) {
                    a = a && b.enabled
        ...
        }, b.prototype.startLocalMedia = b.prototype.start, b.prototype.stopLocalMedia = b.prototype.stop, Object.defineProperty(b.prototype, "localStream", {
            get: function() {
                return this.localStreams.length > 0 ? this.localStreams[0] : null
            }
        }), Object.defineProperty(b.prototype, "localScreen", {
            get: function() {
                return this.localScreens.length > 0 ? this.localScreens[0] : null
            }
        }), b
    }), ! function(a) {
        "object" == typeof exports ? module.exports = a() : "function" == typeof define && define.amd ? define("attachmediastream", a) : "undefined" != typeof window ? window.attachMediaStream = a() : "undefined" != typeof global ? global.attachMediaStream = a() : "undefined" != typeof self && (self.attachMediaStream = a())
    }(function() {
        return function a(b, c, d) {
            function e(g, h) {
                if (!c[g]) {
            ...
            1: [function(a, b, c) {
                b.exports = function(a, b, c) {
                    ...
                    if (c)
                        for (d in c) f[d] = c[d];
                    return e ? "audio" === e.tagName.toLowerCase() && (f.audio = !0) : e = document.createElement(f.audio ? "audio" : "video"), f.disableContextMenu && (e.oncontextmenu = function(a) {
                        a.preventDefault()
                    }), f.autoplay && (e.autoplay = "autoplay"), f.muted && (e.muted = !0), !f.audio && f.mirror && ["", "moz", "webkit", "o", "ms"].forEach(function(a) {
    ...
    }), define("WebRTC_SDK/manager/RTCLocalMediaManager", ["require", "my.Class", "underscore", "Logger", "backbone", "q", "WebRTC_SDK/utilities/RTCUtils", "WebRTC_SDK/utilities/RTCErrors", "WebRTC_SDK/utilities/RTCBlueJay", "WebRTC_SDK/manager/RTCSignallingManager", "WebRTC_SDK/manager/RTCTransactionManager", "localmedia", "attachmediastream", "hark"], function(a) {
        var b = a("my.Class"),
            c = a("underscore"),
            d = a("Logger"),
            e = a("backbone"),
            f = a("q"),
            g = a("WebRTC_SDK/utilities/RTCUtils"),
            h = a("WebRTC_SDK/utilities/RTCErrors"),
            i = a("WebRTC_SDK/utilities/RTCBlueJay"),
            j = a("WebRTC_SDK/manager/RTCSignallingManager"),
            k = a("WebRTC_SDK/manager/RTCTransactionManager"),
            l = a("localmedia"),
            m = a("attachmediastream"),
            n = a("hark"),
            o = e.Model.extend({
                defaults: {
                    previewStream: null,
            ...
            p = b.Class({
                ...
                volumeMonitor: null,
                isSignallingChannelReady: !1,
                vadCount: 0,
                constructor: function(a) {
                    c.bindAll(this), c.extend(this, e.Events), this.config = g.deepMergeObjects(this.config, a), this.model = new o, this.localMedia = new l(this.config), this.cachedMediaConstraints = this.config.mediaConstraints, k.on("receivedConnectResponse", this.onReceiveConnectResponse)
                },
                startMedia: function(a, b) {
                    var c = this,
                        d = f.defer(),
                        e = g.deepMergeObjects(this.cachedMediaConstraints, a),
                        h = this.cachedMediaConstraints;
                    return this._startMedia(e, b).then(function(a) {
                        d.resolve(a), c.detectDeviceChange(h, e)
                    }, function(a) {
                        d.reject(a)
                    }), this.cachedMediaConstraints = e, d.promise
                },
                _startMedia: function(a, b) {
                    var c = f.defer(),
                        e = this,
                        g = this.hasMicPreferenceChanged(this.cachedMediaConstraints, a),
                        i = this.hasCameraPreferenceChanged(this.cachedMediaConstraints, a),
                        j = null;
                    return this.localMedia.start(a, function(a, f) {
                        if (a) {
                            var k = h.translateGetUserMediaError(a);
                            d.error("RTCLocalMediaManager: Error in get user media: ", JSON.stringify(k)), c.reject(k)
                        } else j = e.startMediaSuccess({
                            stream: f,
                            type: b,
                            micChanged: g,
                            cameraChanged: i
                ...
                startMediaSuccess: function(a) {
                    var b = null,
                        c = a.stream,
                        e = null,
                        f = this.model.get("localVideoMuted"),
                        g = [],
                        h = [];
                    return "local_stream" === a.type ? h = this.createLocalStreams(c) : (this.stopPreviewStream(), b = c, b.bjn_label = "preview_stream", b.onended = function() {
                        d.warn("RTCLocalMediaManager: Preview stream has ended. Id: ", this.id)
                    }, g.push(b), (a.micChanged || !f && a.cameraChanged) && (this.stopLocalStreams(), e = c.clone(), h = this.createLocalStreams(e), g = g.concat(h), this.trigger("localStreamsChanged")), this.model.set("previewStream", b)), g
                },
                createLocalStreams: function(a) {
                    var b = null,
                        c = null,
                        d = null,
                        e = [];
                    return this.hasAudioTracks(a) && this.hasVideoTracks(a) ? (d = a.clone(), b = this.extractAudioOnlyStream(a), c = this.extractVideoOnlyStream(d)) : this.hasAudioTracks(a) ? b = this.extractAudioOnlyStream(a) : this.hasVideoTracks(a) && (c = this.extractVideoOnlyStream(a)), b && (e.push(b), this.model.set("localAudioStream", b)), c && (e.push(c), this.model.set("localVideoStream", c)), e
                },
                hasMicPreferenceChanged: function(a, b) {
                    var d = this.getSourceId(a.audio),
                        e = this.getSourceId(b.audio);
                    return c.isNull(e) || d === e ? !1 : !0
                },
                hasCameraPreferenceChanged: function(a, b) {
                    var d = this.getSourceId(a.video),
                        e = this.getSourceId(b.video);
                    return c.isNull(e) || d === e ? !1 : !0
                },
                getSourceId: function(a) {
                    var b = null;
                    return c.each(a.optional, function(a, c, d) {
                        a.sourceId && (b = a.sourceId)
                    }), b
                },
                hasAudioTracks: function(a) {
                    return a && a.getAudioTracks().length > 0
                },
                hasVideoTracks: function(a) {
                    return a && a.getVideoTracks().length > 0
                },
                extractAudioOnlyStream: function(a) {
                    var b = a,
                        c = this.model.get("localAudioMuted");
                    return b.getVideoTracks().length > 0 && (b.getVideoTracks()[0].stop(), b.removeTrack(b.getVideoTracks()[0])), c && b.getAudioTracks().forEach(function(a) {
                        a.enabled = !c
                    }), b.bjn_label = "local_audio_stream", b.getAudioTracks()[0].onended = function() {
                        d.warn("RTCLocalMediaManager: Local Audio Stream has ended. Id: ", this.id)
                    }, b
                },
                extractVideoOnlyStream: function(a) {
                    var b = a;
                    return b.getAudioTracks().length > 0 && (b.getAudioTracks()[0].stop(), b.removeTrack(b.getAudioTracks()[0])), b.bjn_label = "local_video_stream", b.getVideoTracks()[0].onended = function() {
                        d.warn("RTCLocalMediaManager: Local Video Stream has ended. Id: ", this.id)
                    }, b
                },
                stopLocalStreams: function() {
                    this.stopLocalAudioStream(), this.stopLocalVideoStream()
                },
                stopLocalAudioStream: function() {
                    this.stopMedia(this.model.get("localAudioStream"))
                },
                stopLocalVideoStream: function() {
                    this.stopMedia(this.model.get("localVideoStream"))
                },
                stopPreviewStream: function() {
                    this.stopMedia(this.model.get("previewStream"))
                },
                stopMedia: function(a) {
                    if (!c.isNull(a) && !c.isUndefined(a)) {
                        var b = g.getLocalStreamType(a);
                        this.localMedia.stop(a), d.debug("RTCLocalMediaManager: " + b + " has been stopped."), this.model.set(b, null)
                    }
                },
                renderStream: function(a) {
                    return a.config = c.defaults({
                        autoplay: !0,
                        mirror: !1,
                        muted: !1
                    }, a.config), this.attachMediaStream(a)
                },
                renderSelfView: function(a) {
                    return a.config = c.defaults(this.config.selfViewConfig, a.config), this.attachMediaStream(a)
                },
                attachMediaStream: function(a) {
                    return a.stream && a.el ? (a.el && (a.el.oncontextmenu = function() {
                        return !1
                    }), m(a.stream, a.el, a.config)) : (d.error("RTCLocalMediaManager: Incorrect params passed to attachmediastream API. stream: " + a.stream + ", el: " + a.el), null)
                },
                getDevices: function() {
                    var a = this,
                        b = f.defer(),
                    ...
                    this.model.get("localAudioStream") && (d = this.model.get("localAudioStream").getAudioTracks()[0].label), this.model.get("localVideoStream") && (e = this.model.get("localVideoStream").getVideoTracks()[0].label);
                    var h = function(f) {
                            var h = {
                                audioIn: [],
                                videoIn: [],
                            ...
                            c.each(f, function(b, c, f) {
                                "audio" === b.kind || "audioinput" === b.kind ? (h.audioIn.push(a.translateDeviceInfo(b)), b.label === d && (g.audioIn = b)) : "video" === b.kind || "videoinput" === b.kind ? (h.videoIn.push(a.translateDeviceInfo(b)), b.label === e && (g.videoIn = b)) : "audiooutput" === b.kind && h.audioOut.push(a.translateDeviceInfo(b))
                            }), a.model.set("availableDevices", h), b.resolve({
                                available: h,
                                selected: g
                            })
                        },
                        i = function(a) {
                            b.reject("Error in navigator.mediaDevices.enumerateDevices API")
                        };
                    return navigator.mediaDevices.enumerateDevices ? navigator.mediaDevices.enumerateDevices().then(h)["catch"](i) : MediaStreamTrack.getSources ? MediaStreamTrack.getSources(h) : b.reject("Browser doesn't support MediaStreamTrack.getSources API"), b.promise
                },
                translateDeviceInfo: function(a) {
                    var b = a.id || a.deviceId;
                    return "audiooutput" === a.kind && (b = this.transformSpeakerId(b, !0)), {
                        id: b,
                        label: a.label,
                        kind: a.kind,
                        facing: a.facing,
                ...
                transformSpeakerId: function(a, b) {
                    var c = "_speaker";
                    return b ? a + c : (a && -1 !== a.indexOf(c) && (a = a.split(c)[0]), a)
                },
                updateStream: function(a) {
                    c.isUndefined(a.remoteStream) || this.model.set("remoteStream", a.remoteStream)
                },
                muteStreams: function(a) {
                    var b = f.defer(),
                        e = [];
                    return c.isUndefined(a.localAudio) || e.push(this.muteLocalAudio(a.localAudio)), c.isUndefined(a.localVideo) || e.push(this.muteLocalVideo(a.localVideo)), c.isUndefined(a.remoteAudio) || e.push(this.muteRemoteAudio(a.remoteAudio)), c.isUndefined(a.remoteVideo) || e.push(this.muteRemoteVideo(a.remoteVideo)), f.all(e).then(function() {
                        b.resolve()
                    }, function() {
                        d.error("RTCLocalMediaManager: Failed to mute local/remote stream")
                    }), b.promise
                },
                muteLocalAudio: function(a) {
                    var b = f.defer(),
                        e = this.model.get("localAudioStream"),
                        g = this.isAudioMuted(e),
                        h = c.isBoolean(a) && g !== a;
                    return h ? (c.isNull(e) || c.isUndefined(e) ? d.warn("Local Audio stream is null, cannot mute/unmute local audio") : (d.debug("RTCLocalMediaManager: " + (a ? "Muting " : "Unmuting ") + "local audio stream now"), e.getAudioTracks().forEach(function(b) {
                        b.enabled = !a
                    }), this.model.set("localAudioMuted", a), d.debug("RTCLocalMediaManager: Local Audio ", a ? "muted" : "unmuted")), b.resolve(), b.promise) : (d.debug("Local Audio is already " + (g ? "muted." : "unmuted.") + " Ignoring the mute request."), b.resolve(), b.promise)
                },
                muteLocalVideo: function(a) {
                    var b = f.defer(),
                        e = this.model.get("localVideoMuted"),
                        g = c.isBoolean(a) && e !== a;
                    return g ? (a ? this._stopLocalVideo(b) : this._resumeLocalVideo(b), b.promise) : (d.debug("Local Video is already " + (e ? "muted." : "unmuted.") + " Ignoring the mute request."), b.resolve(), b.promise)
                },
                _stopLocalVideo: function(a) {
                    var b = null;
                    b = this.model.get("localVideoStream"), c.isNull(b) || c.isUndefined(b) ? d.warn("Local Video stream is null, cannot mute/unmute local video") : (d.debug("RTCLocalMediaManager: Stopping/Muting local video stream now"), b.getVideoTracks().forEach(function(a) {
                        a.stop()
                    }), d.debug("RTCLocalMediaManager: Local Video muted")), this.model.set("localVideoMuted", !0), a.resolve()
                },
                _resumeLocalVideo: function(a) {
                    var b = this,
                        c = g.deepMergeObjects(this.cachedMediaConstraints, {
                            audio: !1
                        });
                    this._startMedia(c, "local_stream").then(function(c) {
                        d.debug("RTCLocalMediaManager: Local Video unmuted"), b.model.set("localVideoMuted", !1), a.resolve()
                    }, function(b) {
                        d.warn("RTCLocalMediaManager: Failed to get local video stream: " + b), a.resolve()
                    })
                },
                muteRemoteAudio: function(a) {
                    var b = f.defer(),
                        e = this.model.get("remoteStream");
                    return c.isNull(e) || c.isUndefined(e) ? d.warn("Remote stream is null, cannot mute/unmute remote audio") : (e.getAudioTracks().forEach(function(b) {
                        b.enabled = !a
                    }), this.model.set("remoteAudioMuted", a)), b.resolve(), b.promise
                },
                muteRemoteVideo: function(a) {
                    var b = f.defer(),
                        e = this.model.get("remoteStream");
                    return c.isNull(e) || c.isUndefined(e) ? d.warn("Remote stream is null, cannot mute/unmute remote video") : (e.getVideoTracks().forEach(function(b) {
                        b.enabled = !a
                    }), this.model.set("remoteVideoMuted", a)), b.resolve(), b.promise
                },
                isAudioMuted: function(a) {
                    var b = !0;
                    return c.isNull(a) || c.isUndefined(a) || a.getAudioTracks().forEach(function(a) {
                        b = b && !a.enabled
                    }), b
                },
                startVolumeMonitor: function(a, b) {
                    c.extend(this.config.volumeMonitoring, b), c.isUndefined(a) || (this.volumeMonitor = n(a, b), this.volumeMonitor.on("volume_change", this.volumeLevelChanged), d.debug("RTCLocalMediaManager: Started volume monitor"))
                },
                volumeLevelChanged: function(a, b) {
                    var c = Math.abs(1 - Math.abs(a / 100));
                    "number" == typeof c && (c = parseFloat(c.toFixed(3)));
                    var d = 1 > c ? c : 0;
                    this.model.set("volumeLevel", d), this.checkIfSpeaking(a)
                },
                checkIfSpeaking: function(a) {
                    var b = 20,
                        c = 140 / b,
                        d = 260 / b;
                    a >= this.config.volumeMonitoring.threshold ? (this.vadCount++, this.vadCount >= c && (this.vadCount = d + c)) : (this.vadCount--, this.vadCount < c && (this.vadCount = 0)), this.model.set("isSpeaking", this.vadCount >= c ? !0 : !1)
                },
                stopVolumeMonitor: function() {
                    c.isNull(this.volumeMonitor) || (d.debug("RTCLocalMediaManager: Stopping volume monitor"), this.volumeMonitor.stop())
                },
                setSpeaker: function(a) {
                    var b = this,
                        d = a.mediaElements,
                        e = a.speakerId;
                    c.each(d, function(a) {
                        a && "function" == typeof a.setSinkId && e && a.setSinkId(b.transformSpeakerId(e, !1))
                    }), e && e !== this.model.get("selectedSpeaker") && (this.model.set("selectedSpeaker", e), this.sendDeviceInfo())
                },
                detectCameraStatus: function(a) {
                    var b, c = this,
                        e = f.defer(),
                        g = "local_stream" === a ? this.model.get("localVideoStream") : this.model.get("previewStream");
                    return g && "function" == typeof g.getVideoTracks ? (b = g.getVideoTracks()[0], b ? window.setTimeout(function() {
                        var f = "local_stream" === a ? c.model.get("localVideoMuted") : !1;
                        "ended" !== b.readyState || f ? e.resolve(h.GET_LOCAL_MEDIA_STATES.AVAILABLE) : (d.warn("RTCLocalMediaManager: Camera feed is unavailable, faulty camera or its in use by another program"), e.resolve(h.GET_LOCAL_MEDIA_STATES.SOURCE_UNAVAILABLE))
                    }, 500) : (d.warn("RTCLocalMediaManager: Stream doesn't have any video tracks"), e.resolve(h.GET_LOCAL_MEDIA_STATES.SOURCE_UNAVAILABLE))) : e.resolve(h.GET_LOCAL_MEDIA_STATES.DEVICES_NOT_FOUND), e.promise
                },
                detectDeviceChange: function(a, b) {
                    var c = this.hasMicPreferenceChanged(a, b),
                        d = this.hasCameraPreferenceChanged(a, b);
                    this.model.set("selectedCamera", this.getSourceId(b.video)), this.model.set("selectedMic", this.getSourceId(b.audio)), (c || d) && this.sendDeviceInfo()
                },
                sendDeviceInfo: function() {
                    if (this.isSignallingChannelReady) {
                        var a = this.model.get("selectedMic"),
                            b = this.model.get("selectedCamera"),
                            c = this.model.get("selectedSpeaker"),
                            e = this.getDeviceLabel(a, "audioIn"),
                            f = this.getDeviceLabel(b, "videoIn"),
                            g = this.getDeviceLabel(c, "audioOut");
                        d.debug("RTCLocalMediaManager: Devices in use, Mic - " + e + ", Camera - " + f + ", Speaker - " + g);
                        var h = i.getInfoMsg({
                            type: "deviceinfo",
                            device: {
                                input: {
                        ...
                        j.sendMsg(h), k.onBlueJayRequest(h)
                    }
                },
                getDeviceLabel: function(a, b) {
                    var d = null,
                        e = this.model.get("availableDevices");
                    return c.each(e[b], function(b, c, e) {
                        b.id === a && (d = b.label)
                    }), d
                },
                onReceiveConnectResponse: function() {
                    this.isSignallingChannelReady = !0
                },
                close: function() {
                    this.stopMedia(this.model.get("localVideoStream")), this.stopMedia(this.model.get("localAudioStream")), this.stopMedia(this.model.get("previewStream")), this.isSignallingChannelReady = !1, this.model.clear().set((new o).defaults)
                }
            });
        return p
    }),
    function(a) {
        if ("object" == typeof exports && "undefined" != typeof module) module.exports = a();
        else if ("function" == typeof define && define.amd) define("adapter", [], a);
        else {
            var b;
        ...
        return function a(b, c, d) {
                    ...
                    f = {
                        ...
                        shimPeerConnection: function() {
                            ...
                            RTCPeerConnection.prototype.addIceCandidate = function() {
                                return null === arguments[0] ? Promise.resolve() : a.apply(this, arguments)
                            }
                        }
                    };
                b.exports = {
            ...
            5: [function(a, b, c) {
                var d = a("sdp"),
                    ...
                    f = {
                        shimPeerConnection: function() {
                            window.RTCIceGatherer && (window.RTCIceCandidate || (window.RTCIceCandidate = function(a) {
                                return a
                                ...
                                return a.codecs.forEach(function(a) {
                                    for (var d = 0; d < b.codecs.length; d++) {
                                        ...
                                        if (a.name.toLowerCase() === e.name.toLowerCase() && a.clockRate === e.clockRate && a.numChannels === e.numChannels) {
                                            c.codecs.push(e), e.rtcpFeedback = e.rtcpFeedback.filter(function(b) {
                                ...
                                b && a.rtpSender && (e.encodings = a.sendEncodingParameters, e.rtcp = {
                                    cname: d.localCName
                                }, a.recvEncodingParameters.length && (e.rtcp.ssrc = a.recvEncodingParameters[0].ssrc), a.rtpSender.send(e)), c && a.rtpReceiver && (e.encodings = a.recvEncodingParameters, e.rtcp = {
                                    cname: a.cname
                                ...
                                switch (this.usingBundle = d.matchPrefix(g, "a=group:BUNDLE ").length > 0, f.forEach(function(f, i) {
                                    ...
                                    if ("offer" !== a.type || m) "answer" !== a.type || m || (p = b.transceivers[i], q = p.iceGatherer, r = p.iceTransport, s = p.dtlsTransport, t = p.rtpSender, u = p.rtpReceiver, v = p.sendEncodingParameters, x = p.localCapabilities, b.transceivers[i].recvEncodingParameters = w, b.transceivers[i].remoteCapabilities = B, b.transceivers[i].cname = C, (h || E) && F.length && r.setRemoteCandidates(F), b.usingBundle && 0 !== i || (r.start(q, z, "controlling"), s.start(A)), b._transceive(p, "sendrecv" === n || "recvonly" === n, "sendrecv" === n || "sendonly" === n), !u || "sendrecv" !== n && "sendonly" !== n ? delete p.rtpReceiver : (y = u.track, e.push([y, u]), c.addTrack(y)));
                                        ...
                                        if (E && G.iceTransport.setRemoteCandidates(F), x = RTCRtpReceiver.getCapabilities(l), v = [{
                                                ssrc: 1001 * (2 * i + 2)
                                ...
                                c.forEach(function(b, c) {
                                    var e, f, g = b.track,
                                        i = b.kind,
                                        j = d.generateIdentifier(),
                                        k = a.usingBundle && c > 0 ? {
                                            iceGatherer: h[0].iceGatherer,
                                            iceTransport: h[0].iceTransport,
                                            dtlsTransport: h[0].dtlsTransport
                                        } : a._createIceAndDtlsTransports(j, c),
                                        l = RTCRtpSender.getCapabilities(i),
                                        m = [{
                                            ssrc: 1001 * (2 * c + 1)
                                        }];
                                    g && (e = new RTCRtpSender(g, k.dtlsTransport)), b.wantReceive && (f = new RTCRtpReceiver(k.dtlsTransport, i)), h[c] = {
                                ...
                                if (null === a) this.transceivers.forEach(function(a) {
                ...
                b.exports = function() {
                    ...
                    if (e.version < 49) {
                        ...
                        navigator.mediaDevices.getUserMedia = function(b) {
                            return g(b)["catch"](function(b) {
                                return Promise.reject(a(b))
                            })
                        }
                    }
                    navigator.getUserMedia = function(a, c, d) {
                        return e.version < 44 ? b(a, c, d) : void navigator.mediaDevices.getUserMedia(a).then(c, d)
                    }
                }
            }, {
                "../utils": 10
    ...
    }), define("WebRTC_SDK/models/RTCCallStatsModel", ["require", "backbone", "underscore", "Logger"], function(a) {
        var b = a("backbone"),
            c = a("underscore"),
            d = (a("Logger"), b.Model.extend({
                STATIC: {
                    LABELS: {
                ...
                parseStats: function(a) {
                    var b = {},
                        d = this;
                    c.each(a, function(a, e, f) {
                        if ("ssrc" === a.type)
                            if (a.id && -1 !== a.id.indexOf("_send") && (c.isUndefined(a.audioInputLevel) || (b.audioInputLevel = a.audioInputLevel, b.audioPacketsSent = a.packetsSent)), a.id && -1 !== a.id.indexOf("_recv")) c.isUndefined(a.audioOutputLevel) || (b.audioPacketsRecvd = a.packetsReceived);
                            else switch (a.googTrackId) {
                                case d.STATIC.LABELS.VIDEO_TRACK:
                                    b.videoRecvHeight = a.googFrameHeightReceived ? parseInt(a.googFrameHeightReceived, 10) : null, b.videoRecvWidth = a.googFrameWidthReceived ? parseInt(a.googFrameWidthReceived, 10) : null;
                                    break;
                                case d.STATIC.LABELS.CONTENT_TRACK:
                                    b.contentRecvHeight = a.googFrameHeightReceived ? parseInt(a.googFrameHeightReceived, 10) : null, b.contentRecvWidth = a.googFrameWidthReceived ? parseInt(a.googFrameWidthReceived, 10) : null
                            }
                    }), this.set(b)
                }
            }));
        return d
    }), define("WebRTC_SDK/RTCCallStats", ["require", "my.Class", "underscore", "backbone", "Logger", "WebRTC_SDK/models/RTCCallStatsModel"], function(a) {
        var b = a("my.Class"),
            c = a("underscore"),
            d = (a("backbone"), a("Logger")),
            e = a("WebRTC_SDK/models/RTCCallStatsModel"),
            f = b.Class({
                STATIC: {},
                constructor: function(a) {
                    c.bindAll(this), this.model = new e, this.peerConnection = a.peerConnection, this.pollInterval = a.statsPollInterval, this.pollInterval && this.startPollingStats()
                },
                startPollingStats: function() {
                    var a = this;
                    d.debug("RTCCallStats: Starting call stats poll with interval: ", this.pollInterval), this.pollStatsHandle = window.setInterval(function() {
                        a.getStats({
                            peerConnection: a.peerConnection,
                            success: a.getStatsSuccess,
                            error: a.getStatsError
                        })
                    }, this.pollInterval)
                },
                stopPollingStats: function() {
                    return this.pollStatsHandle ? (d.debug("RTCCallStats: Stopping call stats poll"), window.clearInterval(this.pollStatsHandle), void(this.pollStatsHandle = null)) : void d.warn("RTCCallStats: Call stats poll already stopped")
                },
                getStats: function(a) {
                    var b = a.peerConnection;
                    b && b.getStats && b.getStats(a.success, a.error)
                },
                getStatsSuccess: function(a) {
                    this.model.updateStats(a)
                },
                getStatsError: function() {
                    d.error("RTCCallStats: Failed to get webrtc call stats")
                },
                close: function() {
        ...
        return f
    }), define("WebRTC_SDK/models/RTCPeerModel", ["require", "backbone", "WebRTC_SDK/utilities/RTCUtils"], function(a) {
        var b = a("backbone"),
            c = a("WebRTC_SDK/utilities/RTCUtils"),
            d = b.Model.extend({
                initialize: function() {},
                setStreamByType: function(a, b, d) {
                    var e = "local" === b ? c.getLocalStreamType(a) : c.getRemoteStreamType(a);
                    this.set(e, d)
                }
            }, {
    ...
    function(a) {
        "function" == typeof define && define.amd ? define("sdpUtils", a) : a(window.require)
    }(function(a, b, c) {
        "use strict";
        ...
        function e(a, b) {
            return "true" === b.opusStereo ? a = u(a, "opus/48000", "stereo", "1") : "false" === b.opusStereo && (a = v(a, "opus/48000", "stereo")), "true" === b.opusFec ? a = u(a, "opus/48000", "useinbandfec", "1") : "false" === b.opusFec && (a = v(a, "opus/48000", "useinbandfec")), "true" === b.opusDtx ? a = u(a, "opus/48000", "usedtx", "1") : "false" === b.opusDtx && (a = v(a, "opus/48000", "usedtx")), b.opusMaxPbr && (a = u(a, "opus/48000", "maxplaybackrate", b.opusMaxPbr)), a
        }

        function f(a, b) {
            return b.audioSendBitrate ? (d("Prefer audio send bitrate: " + b.audioSendBitrate), j(a, b.audioSendBitrate, "audio")) : a
        }

        function g(a, b) {
            return b.audioRecvBitrate ? (d("Prefer audio receive bitrate: " + b.audioRecvBitrate), j(a, b.audioRecvBitrate, "audio")) : a
        }

        function h(a, b) {
            return b.videoSendBitrate ? (d("Prefer video send bitrate: " + b.videoSendBitrate), j(a, b.videoSendBitrate, "video")) : a
        }

        function i(a, b) {
            return b.videoRecvBitrate ? (d("Prefer video receive bitrate: " + b.videoRecvBitrate), j(a, b.videoRecvBitrate, "video")) : a
        }

        function j(a, b, c) {
            var e = a.split("\r\n"),
                f = z(e, "m=", c);
            if (null === f) return d("Failed to add bandwidth line to sdp, as no m-line found"), a;
            var g = A(e, f + 1, -1, "m=");
            null === g && (g = e.length);
            var h = A(e, f + 1, g, "c=");
            if (null === h) return d("Failed to add bandwidth line to sdp, as no c-line found"), a;
            var i = A(e, h + 1, g, "b=AS");
            i && e.splice(i, 1);
            var j = "b=AS:" + b;
            return e.splice(h + 1, 0, j), a = e.join("\r\n")
        }

        function k(a, b) {
            var c = b.videoSendInitialBitrate;
            if (!c) return a;
            var e = c,
                f = b.videoSendBitrate;
            f && (c > f && (d("Clamping initial bitrate to max bitrate of " + f + " kbps."), c = f, b.videoSendInitialBitrate = c), e = f);
            var g = a.split("\r\n"),
                h = z(g, "m=", "video");
            if (null === h) return d("Failed to find video m-line"), a;
            var i = b.videoRecvCodec;
            return a = u(a, i, "x-google-min-bitrate", b.videoSendInitialBitrate.toString()), a = u(a, i, "x-google-max-bitrate", e.toString())
        }

        function l(a, b) {
            a = a.split(" ");
            for (var c = 0; c < a.length; ++c) a[c] === b.toString() && a.splice(c, 1);
            return a.join(" ")
        }

        function m(a, b) {
            var c = z(a, "a=rtpmap", b);
            if (null === c) return a;
            var d = C(a[c]);
            a.splice(c, 1);
            var e = z(a, "m=", "video");
            return null === e ? a : (a[e] = l(a[e], d), a)
        }

        function n(a, b) {
            var c = z(a, "a=rtpmap", b.toString());
            if (null === c) return a;
            a.splice(c, 1);
            var d = z(a, "m=", "video");
            return null === d ? a : (a[d] = l(a[d], b), a)
        }

        function o(a, b) {
            if ("false" !== b.videoFec) return a;
            var c = a.split("\r\n"),
                d = z(c, "a=rtpmap", "red");
            if (null === d) return a;
            var e = C(c[d]);
            if (c = n(c, e), c = m(c, "ulpfec"), d = z(c, "a=fmtp", e.toString()), null === d) return a;
            var f = w(c[d]),
                g = f.pt;
            return null === g ? a : (c.splice(d, 1), c = n(c, g), c.join("\r\n"))
        }

        function p(a, b) {
            return t(a, "audio", "send", b.audioSendCodec)
        }

        function q(a, b) {
            return t(a, "audio", "receive", b.audioRecvCodec)
        }

        function r(a, b) {
            return t(a, "video", "send", b.videoSendCodec)
        }

        function s(a, b) {
            return t(a, "video", "receive", b.videoRecvCodec)
        }

        function t(a, b, c, e) {
            var f = b + " " + c + " codec";
            if (!e) return d("No preference on " + f + "."), a;
            d("Prefer " + f + ": " + e);
            var g = a.split("\r\n"),
                h = z(g, "m=", b);
            if (null === h) return a;
            var i = B(g, e);
            return i && (g[h] = D(g[h], i)), a = g.join("\r\n")
        }
        ...
        function u(a, b, c, d) {
            var e = a.split("\r\n"),
                ...
                g = {};
            if (null === f) {
                var h = z(e, "a=rtpmap", b);
                if (null === h) return a;
                var i = C(e[h]);
                g.pt = i.toString(), g.params = {}, g.params[c] = d, e.splice(h + 1, 0, x(g))
            } else g = w(e[f]), g.params[c] = d, e[f] = x(g);
            return a = e.join("\r\n")
        }
        ...
        function v(a, b, c) {
            ...
            delete f.params[c];
            var g = x(f);
            return null === g ? d.splice(e, 1) : d[e] = g, a = d.join("\r\n")
        }

        function w(a) {
            var b = {},
                c = a.indexOf(" "),
                d = a.substring(c + 1).split("; "),
                e = new RegExp("a=fmtp:(\\d+)"),
                f = a.match(e);
            if (!f || 2 !== f.length) return null;
            b.pt = f[1];
        ...
        function x(a) {
            if (!a.hasOwnProperty("pt") || !a.hasOwnProperty("params")) return null;
            var b = a.pt,
                c = a.params,
                d = [],
                e = 0;
            for (var f in c) d[e] = f + "=" + c[f], ++e;
            return 0 === e ? null : "a=fmtp:" + b.toString() + " " + d.join("; ")
        }

        function y(a, b) {
            var c = B(a, b);
            return c ? z(a, "a=fmtp:" + c.toString()) : null
        }
        ...
        function C(a) {
            var b = new RegExp("a=rtpmap:(\\d+) [a-zA-Z0-9-]+\\/\\d+"),
                c = a.match(b);
        ...
        function E(a) {
            var b = a.split("\r\n"),
                ...
                c = z(b, "m=");
            if (null === c) return a;
            var d = A(b, 0, c, "a=ice-options", "trickle");
            if (d) return a;
            var e = "a=ice-options:trickle";
            return b.splice(c - 1, 0, e), a = b.join("\r\n")
        }
        var F = {
            setDefaultCodec: D,
            setCodecParam: u,
            maybeSetOpusOptions: e,
            maybePreferCodec: t,
            maybePreferVideoReceiveCodec: s,
            maybePreferVideoSendCodec: r,
            maybePreferAudioReceiveCodec: q,
            maybePreferAudioSendCodec: p,
            maybeSetVideoReceiveBitRate: i,
            maybeSetVideoSendBitRate: h,
            maybeSetAudioReceiveBitRate: g,
            maybeSetAudioSendBitRate: f,
            maybeSetVideoSendInitialBitRate: k,
            maybeSetTrickleIceAttr: E,
            maybeRemoveVideoFec: o
        };
        return F
    }), define("WebRTC_SDK/RTCPeer", ["require", "q", "my.Class", "underscore", "backbone", "Logger", "adapter", "WebRTC_SDK/utilities/RTCErrors", "WebRTC_SDK/utilities/RTCBlueJay", "WebRTC_SDK/RTCCallStats", "WebRTC_SDK/RTCStates", "WebRTC_SDK/utilities/RTCUtils", "WebRTC_SDK/models/RTCPeerModel", "WebRTC_SDK/manager/RTCStateManager", "sdpUtils"], function(a) {
        var b = a("q"),
            c = a("my.Class"),
            d = a("underscore"),
            e = a("backbone"),
            f = a("Logger"),
            g = (a("adapter"), a("WebRTC_SDK/utilities/RTCErrors")),
            h = a("WebRTC_SDK/utilities/RTCBlueJay"),
            i = a("WebRTC_SDK/RTCCallStats"),
            j = a("WebRTC_SDK/RTCStates"),
            k = a("WebRTC_SDK/utilities/RTCUtils"),
            l = a("WebRTC_SDK/models/RTCPeerModel"),
            m = a("WebRTC_SDK/manager/RTCStateManager"),
            n = a("sdpUtils"),
            o = c.Class({
                iceRestartTimer: null,
                iceRestartTimeout: 1e4,
                iceConnectivityTimeout: 2e4,
                iceConnectivityTimer: null,
                numIceCandidates: 0,
                constructor: function(a) {
                    d.bindAll(this), d.extend(this, e.Events), this.ICE_CONNECTION_STATES = j.WEBRTC_STATES.iceConnectionState;
                    var b = k.deepMergeObjects(l.getDefaults(), a.peerConfig);
                    this.model = new l(b);
                    var c = this.model.get("peerConnectionConfig"),
                        g = this.model.get("peerConnectionConstraints");
                    c.forceTurn && (f.debug("RTCPeer: Force turn is enabled, get only relay ICE candidates"), c.iceTransports = "relay"), this.pc = new RTCPeerConnection(c, g), this.pc.onicecandidate = this.onIceCandidate, this.pc.onaddstream = this.onRemoteStreamAdded, this.pc.onremovestream = this.onRemoteStreamRemoved, this.pc.onsignalingstatechange = this.onSignalingStateChanged, this.pc.oniceconnectionstatechange = this.onIceConnectionStateChanged, this.pc.onicegatheringstatechange = this.onIceGatheringStateChanged, this.pc.onnegotiationneeded = this.onNegotiationNeeded, d.isNull(a.localAudioStream) || d.isUndefined(a.localAudioStream) || this.addStream(a.localAudioStream), d.isNull(a.localVideoStream) || d.isUndefined(a.localVideoStream) || this.addStream(a.localVideoStream), this.callStats = new i({
                        peerConnection: this.pc,
                        statsPollInterval: this.model.get("statsPollInterval")
                    }), this.callStatsModel = this.callStats.model
                },
                addStream: function(a) {
                    return this.isPCClosed() ? (f.warn("RTCPeer: Peer connection is closed, ignoring addStream request"), g.PEER_CONNECTION_ERRORS.PC_CLOSED) : (this.pc.addStream(a), this.model.setStreamByType(a, "local", a), f.debug("RTCPeer: Added stream to peer connection: ", a.id), void 0)
                },
                removeStream: function(a) {
                    return this.isPCClosed() ? (f.warn("RTCPeer: Peer connection is closed, ignoring removeStream request"), g.PEER_CONNECTION_ERRORS.PC_CLOSED) : (this.pc.removeStream(a), this.model.setStreamByType(a, "local", null), f.debug("RTCPeer: Removed stream from peer connection: ", a.id), void 0)
                },
                removeAudioStream: function() {
                    var a = this.model.get("localAudioStream");
                    d.isNull(a) || d.isUndefined(a) ? f.debug("RTCPeer: Local Audio Stream in PC is null, cannot remove") : this.removeStream(a)
                },
                removeVideoStream: function() {
                    var a = this.model.get("localVideoStream");
                    d.isNull(a) || d.isUndefined(a) ? f.debug("RTCPeer: Local Video Stream in PC is null, cannot remove") : this.removeStream(a)
                },
                onIceCandidate: function(a) {
                    var b = a.candidate;
                    b ? (this.model.set("iceGatheringState", this.pc.iceGatheringState), this.trigger("iceCandidate", this, b), this.numIceCandidates++) : null === b && (0 === this.numIceCandidates ? (f.debug("RTCPeer :: Received NULL Ice Candidate before gathering candidates"), this.onIceGatheringFailure()) : (f.debug("RTCPeer: Ice Gathering complete, Ice Candidate count " + this.numIceCandidates), this.model.set("iceGatheringState", this.pc.iceGatheringState)))
                },
                onIceConnectionStateChanged: function(a) {
                    if (this.pc) switch (this.model.set("iceConnectionState", this.pc.iceConnectionState), f.debug("RTCPeer: iceConnectionState changed to: " + this.pc.iceConnectionState), this.pc.iceConnectionState) {
                        ...
                        case this.ICE_CONNECTION_STATES.DISCONNECTED:
                            this.initIceRestart(), this.initIceConnectivityTimer();
                            break;
                        case this.ICE_CONNECTION_STATES.FAILED:
                            this.initIceConnectivityTimer(), this.restartIce();
                            break;
                ...
                initIceRestart: function() {
                    var a = this,
                        b = this.model.get("iceConnectionState");
                    this.iceRestartTimer = window.setTimeout(function() {
                        b = a.model.get("iceConnectionState"), b === a.ICE_CONNECTION_STATES.CONNECTED || b === a.ICE_CONNECTION_STATES.COMPLETED ? a.clearIceRestartTimer() : a.restartIce()
                    }, this.iceRestartTimeout)
                },
                restartIce: function() {
                    this.trigger("restartICE"), this.clearIceRestartTimer()
                },
                initIceConnectivityTimer: function() {
                    var a = this;
                    null === a.iceConnectivityTimer && (a.iceConnectivityTimer = setTimeout(function() {
                        var b = a.model.get("iceConnectionState");
                        b !== a.ICE_CONNECTION_STATES.CONNECTED && b !== a.ICE_CONNECTION_STATES.COMPLETED && (f.warn("Can not establish ICE connectivity, restarting the call"), m.callDisconnected(g.DISCONNECT_REASONS.ICE_CONNECTION_FAILED))
                    }, a.iceConnectivityTimeout))
                },
                clearIceRestartTimer: function() {
                    this.iceRestartTimer && window.clearTimeout(this.iceRestartTimer), this.iceRestartTimer = null
                },
                clearIceConnectivityTimer: function() {
                    this.iceConnectivityTimer && window.clearTimeout(this.iceConnectivityTimer), this.iceConnectivityTimer = null
                },
                onIceGatheringStateChanged: function(a) {
                    f.debug("RTCPeer: Received 'iceGatheringStateChange' event")
                },
                onNegotiationNeeded: function(a) {},
                onSignalingStateChanged: function(a) {
                    this.pc && (f.debug("RTCPeer: signalingState changed to: " + this.pc.signalingState), this.model.set("signalingState", this.pc.signalingState))
                },
                onIceCandidatesEnded: function() {
                    f.debug("RTCPeer: Received 'endOfCandidates' event")
                },
                onRemoteStreamAdded: function(a) {
                    var b = a.stream;
                    d.isNull(b) || d.isUndefined(b) ? f.error("RTCPeer: onRemoteStreamAdded event has invalid stream in it: ", b) : (this.model.setStreamByType(b, "remote", b), f.debug("RTCPeer: Connector added a stream to peer connection: ", b))
                },
                onRemoteStreamRemoved: function(a) {
                    var b = a.stream;
                    d.isNull(b) || d.isUndefined(b) ? f.error("RTCPeer: onRemoteStreamRemoved event has invalid stream in it: ", b) : (this.model.setStreamByType(b, "remote", null), f.debug("RTCPeer: Connector removed a stream from peer connection: ", b))
                },
                handleResponseMessage: function(a) {},
                handleErrorMessage: function(a) {
                    f.debug("RTCPeer: Received 'error' message: " + a)
                },
                handleNotificationMessage: function(a) {
                    f.debug("RTCPeer: Received 'notification' message: " + a);
                    var b = h.METHODS;
                    switch (a.method) {
                        case b.CANDIDATE:
                            this.pc.processIce(a.iceCandidate);
                            break;
                        default:
                            f.error("RTCPeer: Method received in notification message: " + a.method + " is not supported.")
                    }
                },
                createOffer: function(a) {
                    var c = this,
                        e = b.defer(),
                        h = d.extend({}, this.model.get("receiveMedia"), a);
                    h && h.iceRestart === !0 && (this.numIceCandidates = 0);
                    var i = function(a) {
                            a.sdp = n.maybeRemoveVideoFec(a.sdp, {
                                videoFec: "false"
                            }), c.pc.setLocalDescription(a, function() {
                                a = c._appendInfoToSdp(a), c.model.set("localSdp", a), e.resolve(a)
                            }, function(a) {
                                f.error("RTCPeer: Error while setting localSdp: " + a), e.reject(a)
                            })
                        },
                        j = function(a) {
                            f.error("RTCPeer: Error while creating offer sdp: " + a), e.reject(a)
                        };
                    return this.isPCClosed() ? (f.warn("RTCPeer: Peer connection is closed, ignoring createOffer request"), e.reject(g.PEER_CONNECTION_ERRORS.PC_CLOSED)) : this.pc.createOffer(i, j, h), e.promise
                },
                handleOffer: function(a) {
                    var c = this,
                        d = a.params.sessionDescription,
                        e = b.defer(),
                        h = function(a) {
                            f.error("RTCPeer: Error while processing incoming offer request: " + a), e.reject(a)
                        };
                    return this.isPCClosed() ? (f.warn("RTCPeer: Peer connection is closed, ignoring handleOffer request"), e.reject(g.PEER_CONNECTION_ERRORS.PC_CLOSED)) : this.pc.setRemoteDescription(new RTCSessionDescription(d), function() {
                        c.model.set("remoteSdp", d), c.pc.createAnswer(function(a) {
                            c.pc.setLocalDescription(answer, function() {
                                a = c._appenInfotoSdp(a), c.model.set("localSdp", a), e.resolve()
                            }, h)
                        }, h)
                    }, h), e.promise
                },
                handleAnswer: function(a) {
                    var c = this,
                        d = a.params.sessionDescription,
                        e = b.defer();
                    return this.isPCClosed() ? (f.warn("RTCPeer: Peer connection is closed, ignoring handleAnswer request"), e.reject(g.PEER_CONNECTION_ERRORS.PC_CLOSED)) : this.pc.setRemoteDescription(new RTCSessionDescription(d), function() {
                        c.model.set("remoteSdp", d), e.resolve()
                    }, function(a) {
                        f.error("RTCPeer: Error while setting remote description: " + a), e.reject(a)
                    }), e.promise
                },
                handleUpdate: function(a) {
                    var c = b.defer();
                    return f.warn("RTCPeer: 'update' Method is not supported yet"), c.resolve(), c.promise
                },
                handleKeepAlive: function(a) {
                    f.debug("RTCPeer: Received a keepalive message");
                    var c = b.defer();
                    return c.resolve(), c.promise
                },
                handleDisconnect: function(a) {
                    var c = b.defer();
                    return this.pc ? ("closed" !== this.pc.signalingState && this.pc.close(), this.model.set("remoteStream", null), this.model.set("closed", !0), this.pc = null) : f.warn("RTCPeer: This Peer Connection has already been closed!!"), c.resolve(), c.promise
                },
                handleIceCandidate: function(a) {
                    var c = b.defer();
                    if (this.pc) {
                        var d = new RTCIceCandidate({
                            sdpMLineIndex: a.sdpMLineIndex,
                            candidate: a.candidate,
                            sdpMid: a.sdpMid
                        });
                        this.pc.addIceCandidate(d), c.resolve()
                    }
                    return c.promise
                },
                isPCClosed: function() {
                    return this.model.get("closed") === !0 || "closed" === this.pc.signalingState ? !0 : !1
                },
                close: function() {
                    f.debug("RTCPeer: closing RTCPeerConnection now"), this.clearIceConnectivityTimer(), this.clearIceRestartTimer(), this.handleDisconnect(), this.callStats.close(), this.numIceCandidates = 0
                },
                _appendInfoToSdp: function(a) {
                    var b = new Object({
                        audioMsid: "",
                        videoMsid: "",
                        contnetMsid: ""
                    });
                    return this.pc.getLocalStreams().forEach(function(a) {
                        switch (a.bjn_label) {
                            case "local_av_stream":
                                b.audioMsid = a.id, b.videoMsid = a.id;
                                break;
                            case "local_audio_stream":
                                b.audioMsid = a.id;
                                break;
                            ...
                            case "content_stream":
                                ...
                                break;
                            default:
                                f.error("RTCPeer: Invalid Stream found in PC " + a.bjn_label)
                        }
                    }), a.streamInfo = b, a
                },
                onIceGatheringFailure: function() {
                    var a = this;
                    window.setTimeout(function() {
                        0 === a.numIceCandidates && (f.warn("RTCPeer :: Received only NULL Ice Candidate before gathering candidates, Restarting the call"), m.callDisconnected(g.DISCONNECT_REASONS.ICE_GATHERING_FAILED))
                    }, 5e3)
                }
            });
        return o
    }), define("WebRTC_SDK/models/RTCScreenSharingModel", ["require", "backbone", "jquery", "underscore", "Logger", "WebRTC_SDK/RTCStates"], function(a) {
        var b = a("backbone"),
            c = a("jquery"),
            d = a("underscore"),
            e = a("Logger"),
            f = a("WebRTC_SDK/RTCStates"),
            g = b.Model.extend({
                defaults: {
                    localContentStream: null,
                    chromeMediaSourceId: null,
                    isChromeExtensionInstalled: !1,
                    extensionStatus: f.EXTENSION_STATES.NOT_INSTALLED,
                    screenShareState: null,
                    tokenStatus: null,
                    presentationToken: {}
                },
                isExtensionInstalled: function() {
                    var a = c("body").find(".InMeetingExtensionIsInstalled"),
                        b = !1,
                        g = this;
                    d.each(a, function(a, d, e) {
                        c(a).attr("data-extension-id") === g.get("chromeExtensionId") && (b = !0)
                    });
                    var h = this.get("extensionStatus") === f.EXTENSION_STATES.INSTALLED;
                    return b || h ? (e.debug("RTCScreenSharingModel: The Screen Sharing Chrome extension has been installed."), !0) : (e.warn("RTCScreenSharingModel: The Screen Sharing Chrome extension is not installed."), !1)
                },
                isExtensionInstalling: function() {
                    return this.model.get("extensionStatus") === f.EXTENSION_STATES.INSTALLING
                }
            });
        return g
    }), define("WebRTC_SDK/manager/RTCScreenSharingManager", ["require", "underscore", "jquery", "my.Class", "q", "backbone", "Logger", "WebRTC_SDK/utilities/RTCBlueJay", "WebRTC_SDK/RTCStates", "WebRTC_SDK/utilities/RTCErrors", "WebRTC_SDK/utilities/RTCUtils", "WebRTC_SDK/models/RTCScreenSharingModel", "WebRTC_SDK/manager/RTCSignallingManager", "WebRTC_SDK/manager/RTCTransactionManager"], function(a) {
        var b = a("underscore"),
            c = a("jquery"),
            d = a("my.Class"),
            e = a("q"),
            f = (a("backbone"), a("Logger")),
            g = a("WebRTC_SDK/utilities/RTCBlueJay"),
            h = a("WebRTC_SDK/RTCStates"),
            i = a("WebRTC_SDK/utilities/RTCErrors"),
            j = a("WebRTC_SDK/utilities/RTCUtils"),
            k = a("WebRTC_SDK/models/RTCScreenSharingModel"),
            l = a("WebRTC_SDK/manager/RTCSignallingManager"),
            m = a("WebRTC_SDK/manager/RTCTransactionManager"),
            n = d.Class({
                config: {
                    mediaConstraints: {
                        audio: !1,
                ...
                constructor: function(a) {
                    b.bindAll(this), this.model = new k, this.model.on("change:extensionStatus", this.onExtensionStatusChanged), this.model.on("change:tokenStatus", this.onTokenStatusChange)
                },
                setParams: function(a) {
                    this.model.set("chromeExtensionId", a.chromeExtensionId), this.config.features = a.features, this.screenSharingExtensionUrl = "https://chrome.google.com/webstore/detail/" + a.chromeExtensionId
                },
                onExtensionStatusChanged: function() {
                    var a = this.model.get("extensionStatus"),
                        b = h.EXTENSION_STATES;
                    switch (f.debug("RTCScreenSharingManager: Extension status changed to: ", a), a) {
                        case b.NOT_INSTALLED:
                            break;
                        case b.INSTALLING:
                            break;
                        case b.INSTALLED:
                            this.doScreenSharing && (f.debug("RTCScreenSharingManager: Screen sharing is on, sending msg to extension to get desktop media source ID"), this.getDesktopMediaSourceId());
                            break;
                        case b.IFRAME_INSTALL_FAILED:
                            this.model.set("screenShareState", i.SCREEN_SHARING_STATES.INSTALL_EXTENSION_FAILED);
                            break;
                        case b.INSTALL_FAILED:
                            this.model.set("screenShareState", i.SCREEN_SHARING_STATES.INSTALL_EXTENSION_FAILED);
                            break;
                        case b.INSTALL_CANCELLED:
                            break;
                        case b.REQUEST_FAILED:
                    }
                },
                startScreenSharing: function(a) {
                    var b = this.model.isExtensionInstalled(),
                        c = a || {};
                    this.doScreenSharing = !0, this.installationCompletedRetries = 0, this.model.set("extensionStatus", h.EXTENSION_STATES.NOT_INSTALLED), b || c.skipInlineInstallation ? (f.debug('RTCScreenSharingManager: Content Scripts have been injected, "ping" extension to check if extension is not uninstalled'), this.pingAndStartSharing()) : (f.warn("RTCScreenSharingManager: Content Scripts have not been injected, extension has not been installed"), this.triggerInlineInstallation())
                },
                stopScreenSharing: function() {
                    this.doScreenSharing = !1;
                    var a = this.model.get("localContentStream");
                    a ? (f.debug("RTCScreenSharingManager: Stopping screen sharing now"), a.getTracks().forEach(function(a) {
                        a.stop()
                    })) : (f.debug("RTCScreenSharingManager: Screen sharing has already been stopped"), this.reset())
                },
                triggerInlineInstallation: function() {
                    var a = this,
                        b = function(b) {
                            f.debug("RTCScreenSharingManager: Chrome inline installation was successful."), a.model.set("extensionStatus", h.EXTENSION_STATES.INSTALLING), a.pingAndStartSharing()
                        },
                        d = function(b) {
                            a.handleInstallationFailure(b)
                        };
                    try {
                        c("head").append('<link rel="chrome-webstore-item" href=' + this.screenSharingExtensionUrl + ">"), window.chrome.webstore.install(this.screenSharingExtensionUrl, b, d)
                    } catch (e) {
                        a.handleInstallationFailure(e)
                    }
                },
                handleInstallationFailure: function(a) {
                    var b, c = h.EXTENSION_STATES;
                    switch (f.error("RTCScreenSharingManager: Inline installation of Chrome extension failed: " + a), a) {
                        case "User cancelled install":
                            b = c.INSTALL_CANCELLED;
                            break;
                        case "Chrome Web Store installations can only be started by the top frame.":
                            b = c.IFRAME_INSTALL_FAILED;
                            break;
                        case "Installs can only be initiated by one of the Chrome Web Store item's verified sites.":
                            b = c.INSTALL_FAILED_DOMAIN_UNVERIFIED;
                            break;
                        default:
                            b = c.INSTALL_FAILED
                    }
                    this.model.set("extensionStatus", b)
                },
                pingAndStartSharing: function() {
                    var a = this;
                    this.installationCompletedRetries < this.maxInstallationCompletedRetries ? window.setTimeout(function() {
                        a.installationCompletedRetries++, f.debug('RTCScreenSharingManager: Sending "ping" to extension. Attempt no. ', a.installationCompletedRetries), a.pingExtension(function(b) {
                            a.installationCompletedRetries = 0, a.onPingSuccess(b)
                        }, function(b) {
                            "emptyResponse" === b ? a.pingAndStartSharing() : a.model.set("extensionStatus", h.EXTENSION_STATES.REQUEST_FAILED)
                        })
                    }, 500) : this.model.set("extensionStatus", h.EXTENSION_STATES.INSTALL_FAILED)
                },
                pingExtension: function(a, b) {
                    this.sendMessageToExtension({
                        type: "ping"
                    }).then(a, b)
                },
                onPingSuccess: function(a) {
                    "pong" === a.type && this.doScreenSharing && (this.model.set("extensionStatus", h.EXTENSION_STATES.INSTALLED, {
                        silent: !0
                ...
                getDesktopMediaSourceId: function() {
                    var a = e.defer(),
                        b = this;
                    return this.model.set("tokenStatus", g.TOKEN_STATUS.WAITING), this.sendMessageToExtension({
                        type: "getScreen",
                        options: this.config.features.applicationSharing ? ["screen", "window"] : ["screen"]
                    }).then(function(a) {
                        switch (a.type) {
                            case "gotScreenSharing":
                                b.model.set("chromeMediaSourceId", a.sourceId), b.requestToken();
                                break;
                            case "canceledGetScreen":
                                b.model.set("tokenStatus", g.TOKEN_STATUS.CANCELLED);
                                break;
                            default:
                                f.error('RTCScreenSharingManager: Unhandled message type for "getScreen" API'), b.model.set("tokenStatus", g.TOKEN_STATUS.CANCELLED)
                        }
                    }, function(a) {}), a.promise
                },
                sendMessageToExtension: function(a) {
                    var c = e.defer(),
                        d = b.extend({
                            targetModule: "RTCDesktopMedia"
                        }, a);
                    try {
                        window.chrome.runtime.sendMessage(this.model.get("chromeExtensionId"), d, b.bind(function(a) {
                            f.debug("RTCScreenSharingManager: Response from extension: " + JSON.stringify(a)), b.isUndefined(a) ? c.reject("emptyResponse") : c.resolve(a)
                        }, this))
                    } catch (g) {
                        f.error("RTCScreenSharingManager: Exception occured while sending message to Extension: ", g), c.reject("error")
                    }
                    return c.promise
                },
                getDesktopMediaStream: function() {
                    var a = j.deepMergeObjects(this.config.mediaConstraints, {
                        video: {
                            mandatory: {
                    ...
                    window.navigator.webkitGetUserMedia(a, this.getDesktopMediaSuccess, this.getDesktopMediaError)
                },
                getDesktopMediaSuccess: function(a) {
                    f.debug("RTCScreenSharingManager: Local Content has been acquired"), a.bjn_label = "content_stream", a.onended = b.bind(function() {
                        f.debug("RTCScreenSharingManager: Local Content Stream has ended."), this.doScreenSharing = !1, this.releaseToken(), this.reset(), this.sendMessageToExtension({
                            type: "focusTab"
                        })
                    }, this), this.model.set("localContentStream", a)
                },
                getDesktopMediaError: function(a) {
                    f.error("Failed to get desktop media stream, error: ", a)
                },
                requestToken: function() {
                    var a = g.requestTokenMsg();
                    l.sendMsg(a), RTCStateManager.getCurrentCallState() !== h.BJ_CALLSTATES.IDLE && m.onBlueJayRequest(a)
                },
                releaseToken: function() {
                    var a = g.releaseTokenMsg();
                    l.sendMsg(a), m.onBlueJayRequest(a), this.model.set("tokenStatus", g.TOKEN_STATUS.RELEASED)
                },
                handleTokenMessage: function(a) {
                    var b = a.params.type;
                    switch (b) {
                        case g.TOKEN_TYPES.STATUS:
                            this.model.set("tokenStatus", a.params.status);
                            break;
                        case g.TOKEN_TYPES.TOKENINDICATION:
                            this.model.set("presentationToken", a.params);
                            break;
                        case g.TOKEN_TYPES.CONTENTINDICATION:
                            this.model.set("presentationToken", a.params);
                            break;
                        default:
                            f.error("RTCScreenSharingManager: Invalid type passed in token msg: ", b)
                    }
                },
                onTokenStatusChange: function(a) {
                    var b = a.get("tokenStatus");
                    switch (b) {
                        case g.TOKEN_STATUS.GRANTED:
                            this.doScreenSharing ? this.getDesktopMediaStream() : (f.info("RTCScreenSharingManager: Screen sharing was cancelled while acquiring token"), this.releaseToken());
                            break;
                        case g.TOKEN_STATUS.REVOKED:
                            f.debug("RTCScreenSharingManager: Token has been 'revoked', must have been hijacked!"), this.stopScreenSharing()
                    }
                },
                sendPresentaionRatio: function(a) {
                    var b = {
                        ...
                        c = g.getInfoMsg(b);
                    l.sendMsg(c), m.onBlueJayRequest(c)
                },
                reset: function() {
                    var a = this.model.get("tokenStatus");
                    a === g.TOKEN_STATUS.GRANTED && this.releaseToken(), this.model.set("localContentStream", null), this.model.set("chromeMediaSourceId", null)
                },
                close: function() {
        ...
        return new n
    }), define("WebRTC_SDK/manager/RTCPeerConnectionManager", ["require", "q", "my.Class", "underscore", "backbone", "Logger", "WebRTC_SDK/RTCPeer", "WebRTC_SDK/utilities/RTCBlueJay", "WebRTC_SDK/RTCStates", "sdpUtils", "WebRTC_SDK/manager/RTCStateManager", "WebRTC_SDK/manager/RTCSignallingManager", "WebRTC_SDK/manager/RTCTransactionManager", "WebRTC_SDK/manager/RTCScreenSharingManager", "WebRTC_SDK/utilities/RTCErrors"], function(a) {
        var b = a("q"),
            c = a("my.Class"),
            d = a("underscore"),
            e = a("backbone"),
            f = a("Logger"),
            g = a("WebRTC_SDK/RTCPeer"),
            h = a("WebRTC_SDK/utilities/RTCBlueJay"),
            i = a("WebRTC_SDK/RTCStates"),
            j = a("sdpUtils"),
            k = a("WebRTC_SDK/manager/RTCStateManager"),
            l = a("WebRTC_SDK/manager/RTCSignallingManager"),
            m = a("WebRTC_SDK/manager/RTCTransactionManager"),
            n = a("WebRTC_SDK/manager/RTCScreenSharingManager"),
            o = a("WebRTC_SDK/utilities/RTCErrors"),
            p = c.Class({
                config: {
                ...
                isSignallingChannelReady: !1,
                constructor: function(a) {
                    d.bindAll(this), d.extend(this.config, a), d.extend(this, e.Events), this.BJ_CALLSTATES = i.BJ_CALLSTATES, this.WEBRTC_STATES = i.WEBRTC_STATES, l.setupMessageParser(this.getSignallingCallbacks()), this.iceCandidates = [], this.isSignalingChannelReady = !1, m.on("receivedConnectResponse", this.onReceiveConnectResponse), m.on("receivedKeepAliveResponse", this.onKeepAliveResponse)
                },
                createPeer: function(a) {
                    this.peer = new g(a), this.peer.on("iceCandidate", this.onNewIceCandiate), this.peer.model.on("change:iceGatheringState", this.onIceGatheringStateChanged), this.peer.model.on("change:iceConnectionState", this.onIceConnectionStateChange), this.peer.model.on("change:signalingState", this.onSignalingStateChange)
                },
                getPeer: function() {
                    return this.peer
                },
                updateMeetingParams: function(a) {
                    if (this.meetingParams = a, this.meetingParams.maxBandwidth) {
                        var b = window.parseInt(this.meetingParams.maxBandwidth, 10);
                        b >= 100 && 4096 >= b ? (this.config.sdpParams.videoRecvBitrate = this.meetingParams.maxBandwidth, f.debug("RTCPeerConnectionManager :: Updating max session bitrate to - " + this.config.sdpParams.videoRecvBitrate)) : f.debug("RTCPeerConnectionManager :: received invalid max bitrate " + b + ", using default value")
                    } else f.debug("RTCPeerConnectionManager :: using default max session bitrate - " + this.config.sdpParams.videoRecvBitrate)
                },
                signallingChannelCreated: function() {
                    this.initKeepAliveMessage(), this.sendKeepAliveMessage(!1), this.isSignalingChannelReady = !0, this.enqueueIceCandidates()
                },
                initiateCall: function(a, b) {
                    var c = this;
                    this.iceCandidates = [], this.createOffer(a).then(function(a) {
                        var b = k.getCurrentCallState();
                        b === c.BJ_CALLSTATES.CONNECTING || b === c.BJ_CALLSTATES.INITIALISING || b === c.BJ_CALLSTATES.IDLE ? c.sendConnectMessage(a) : (b === c.BJ_CALLSTATES.RECONNECTING || b === c.BJ_CALLSTATES.REINITIALISING) && c.sendUpdateMessage(a)
                    }, function(a) {
                        throw f.error("RTCPeerConnectionManager: Error while creating 2nd offerSdp after ICE gathering completed"), a
                    })
                },
                sendIceCandidate: function(a) {
                    if (a) {
                        var b = h.getIceCandidateMessage(a);
                        l.sendMsg(b), m.onBlueJayRequest(b)
                    }
                },
                enqueueIceCandidates: function() {
                    var a = this;
                    a.iceCandidates.forEach(function(b) {
                        a.sendIceCandidate(b)
                    })
                },
                onNewIceCandiate: function(a, b) {
                    this.isSignalingChannelReady === !1 ? this.iceCandidates.push(b) : this.sendIceCandidate(b)
                },
                onIceGatheringStateChanged: function(a) {
                    k.iceGatheringStateChange(a.get("iceGatheringState"))
                },
                onIceConnectionStateChange: function(a) {
                    k.iceConnectionStateChange(a.get("iceConnectionState"))
                },
                onSignalingStateChange: function(a) {
                    k.signalingStateChange(a.get("signalingState"))
                },
                handleResponseMessage: function(a) {
                    var b = this.getPeer();
                    return b.handleResponseMessage(a)
                },
                handleErrorMessage: function(a) {
                    var b = this.getPeer();
                    return b.handleErrorMessage(a)
                },
                handleNotificationMessage: function(a) {
                    var b = this.getPeer();
                    return b.handleNotificationMessage(a)
                },
                handleRequestMessage: function(a) {
                    var b = h.METHODS,
                        c = this.getPeer();
                    switch (a.method) {
                        case b.CONNECT:
                            return this.onConnect(c, a);
                        case b.ANSWER:
                            return this.onAnswer(c, a);
                        case b.UPDATE:
                            return this.onUpdate(c, a);
                        case b.DISCONNECT:
                            return this.onDisconnect(c, a);
                        case b.KEEPALIVE:
                            return this.onKeepAlive(c, a);
                        case b.ICE:
                            return this.onIceCandidate(c, a);
                        default:
                            f.error("RTCPeerConnectionManager: Method received in message: " + a.method + " is not supported.")
                    }
                },
                onConnect: function(a, b) {
                    return a.handleOffer(b)
                },
                onAnswer: function(a, b) {
                    var c = this;
                    return b.params.sessionDescription.sdp = j.maybeSetVideoReceiveBitRate(b.params.sessionDescription.sdp, c.config.sdpParams), a.handleAnswer(b).then(function() {
                        c.offerInProgress = !1, c.createOfferQueued && (f.debug("RTCPeerConnectionManager: Processing previously Queued 'update offer' request"), c.createUpdateOffer(), c.createOfferQueued = !1)
                    })
                },
                ...
                onDisconnect: function(a, b) {
                    return a.handleDisconnect(b)
                },
                onKeepAlive: function(a, b) {
                    return a.handleKeepAlive(b)
                },
                onIceCandidate: function(a, b) {
                    return a.handleIceCandidate(b.params.iceCandidate)
                },
                addPeerStream: function(a) {
                    var b = this.getPeer();
                    return b ? (b.addStream(a), this.createUpdateOffer(), !0) : (f.warn("RTCPeerConnectionManager: RTCPeer does not exist, ignoring addStream API on it"), !1)
                },
                updatePeerStream: function(a) {
                    var b = this.getPeer();
                    return b ? (d.isUndefined(a.newAudioStream) || d.isNull(a.newAudioStream) || (b.removeAudioStream(), b.addStream(a.newAudioStream)), d.isUndefined(a.newVideoStream) || d.isNull(a.newVideoStream) || (b.removeVideoStream(), b.addStream(a.newVideoStream)), void this.createUpdateOffer()) : (f.warn("RTCPeerConnectionManager: RTCPeer does not exist, ignoring updatePeerStream API on it"), !1)
                },
                removePeerStream: function(a) {
                    var b = this.getPeer();
                    return b ? (b.removeStream(a), this.createUpdateOffer(), !0) : (f.warn("RTCPeerConnectionManager: RTCPeer does not exist, ignoring removeStream API on it"), !1)
                },
                createUpdateOffer: function(a) {
                    var b = this;
                    return this.isSignallingChannelReady === !1 ? void(this.createOfferQueued = !0) : void this.createOffer(a).then(function(a) {
                        b.sendUpdateMessage(a)
                    }, function(a) {
                        f.error('RTCPeerConnectionManager: RTCPeer failed to create "updated" offer')
                    })
                },
                createOffer: function(a) {
                    var c = this.getPeer(),
                        d = this,
                        e = b.defer(),
                        g = k.getCurrentCallState();
                    return this.offerInProgress ? (this.createOfferQueued = !0, f.debug("RTCPeerConnectionManager: Queing 'update offer' request. Current call state: ", g)) : (d.offerInProgress = !0, c.createOffer(a).then(function(a) {
                        a.sdp = j.maybeSetVideoReceiveBitRate(a.sdp, d.config.sdpParams), a.sdp = j.maybeSetTrickleIceAttr(a.sdp), e.resolve(a)
                    }, function(a) {
                        d.offerInProgress = !1, e.reject(a)
                    })), e.promise
                },
                sendConnectMessage: function(a) {
                    var b = h.getConnectMessage({
                    ...
                    m.onBlueJayRequest(b), l.sendMsg(b)
                },
                sendUpdateMessage: function(a) {
                    var b = h.getUpdateMessage({
                        sessionDescription: a,
                        streamInfo: a.streamInfo
                    });
                    m.onBlueJayRequest(b), l.sendMsg(b)
                },
                sendKeepAliveMessage: function(a) {
                    if (!a || this.keepAliveFailedAttempts >= this.config.keepAliveMaxFailures - 1) {
                        var b = h.getKeepaliveMessage();
                        m.onKeepaliveRequest(b.id), l.sendMsg(b)
                    }
                },
                ...
                onRequestMessage: function(a) {
                    var b = h.getSuccessResponse(a.id);
                    d.isUndefined(m.lookupOutgoingResponse(a.id)) ? a.method === h.METHODS.TOKEN ? (n.handleTokenMessage(a), l.sendMsg(b)) : this.handleRequestMessage(a).then(function(c) {
                        l.sendMsg(b), m.onOutgoingBlueJayResponse(a.id, b), "disconnect" === a.method && k.callDisconnected(a.params)
                    }, function(b) {
                        f.debug("RTCPeerConnectionManager :: Error while handling request message " + b);
                        var c = h.getErrorResponse(a.id, o.SIGNALING_ERRORS.BAD_REQUEST);
                        l.sendMsg(c)
                    }) : l.sendMsg(b)
                },
                onResponseMessage: function(a) {
                    this.handleResponseMessage(a), m.onIncomingBlueJayResponse(a.id)
                },
                onErrorMessage: function(a) {
                    return this.handleErrorMessage(a), a.error.code === o.SIGNALING_ERRORS.METHOD_NOT_IMPLEMENTED.code ? void f.warn("RTCPeerConnectionManager :: Method not Implemented, Message :: " + JSON.stringify(m.getRequestMessage(a.id))) : void k.callDisconnected(o.DISCONNECT_REASONS.TRANSPORT_FAIL)
                },
                onNotificationMessage: function(a) {
                    this.handleNotificationMessage(a)
                },
                onInvalidMessage: function(a, b) {
                    var c = h.getErrorResponse(a.id, b);
                    l.sendMsg(c)
                },
                initKeepAliveMessage: function() {
                    var a = this;
                    a.keepAliveTimer = setInterval(function() {
                        "finished" === m.getKeepaliveMessageState() ? (a.sendKeepAliveMessage(!1), a.keepAliveFailedAttempts = 0) : (a.keepAliveFailedAttempts++, a.keepAliveFailedAttempts == a.config.keepAliveConnectorfailure && l.WS_STATES === i.WS_STATES.CONNECTED || a.keepAliveFailedAttempts >= a.config.keepAliveMaxFailures ? (f.warn("RTCPeerConnectionManager: KeepAlive timeout has occurred, call will need to be reconnected!!"), k.callDisconnected(o.DISCONNECT_REASONS.KEEPALIVE_TIMEOUT)) : a.sendKeepAliveMessage(!1))
                    }, m.config.keepaliveTimeout)
                },
                stopKeepAliveMessages: function() {
                    this.keepAliveFailedAttempts = 0, clearInterval(this.keepAliveTimer)
                },
                onReceiveConnectResponse: function() {
                    this.isSignallingChannelReady = !0
                },
                ...
                close: function() {
                    var a = this.getPeer();
                    this.stopKeepAliveMessages(), this.createOfferQueued = !1, this.offerInProgress = !1, this.isSignalingChannelReady = !1, a && a.close()
                }
            });
        return p
    }),
    function() {
        ...
        function d(a, c, d) {
            ...
            if (g[6] = 15 & g[6] | 64, g[8] = 63 & g[8] | 128, c)
                for (var h = 0; 16 > h; h++) c[f + h] = g[h];
            return c || b(g)
        }
        var e, f = this;
        ...
        var o = e(),
            ...
            s = 0,
            t = d;
        if (t.v1 = c, t.v4 = d, t.parse = a, t.unparse = b, t.BufferClass = k, "function" == typeof define && define.amd) define("nodeuuid", [], function() {
            return t
        });
    ...
    }.call(this), define("WebRTC_SDK/manager/RTCCapabilitiesManager", ["require", "my.Class", "underscore", "backbone", "Logger", "q"], function(a) {
        var b = a("my.Class"),
            c = a("underscore"),
            d = a("backbone"),
            e = (a("Logger"), a("q")),
            ...
            g = b.Class({
                STATIC: {},
                constructor: function(a) {
                    c.bindAll(this), this.model = new f
                },
                detectCapabilities: function() {
                    var a = e.defer();
                    return this.detectOutputSpeakerSelection(), a.resolve(), a.promise
                },
                detectOutputSpeakerSelection: function() {
                    $("body").append('<video id="testSpeakerSelection" style="display:none"></video>');
                    var a = $("#testSpeakerSelection")[0];
                    this.model.set("supportsOutputSpeakerSelection", a && void 0 !== a.setSinkId ? !0 : !1), $("#testSpeakerSelection").remove()
                }
            });
        return new g
    }), define("WebRTC_SDK/RTCController", ["require", "q", "my.Class", "underscore", "backbone", "Logger", "WebRTC_SDK/utilities/RTCBlueJay", "WebRTC_SDK/utilities/RTCUtils", "WebRTC_SDK/manager/RTCSignallingManager", "WebRTC_SDK/manager/RTCLocalMediaManager", "WebRTC_SDK/manager/RTCPeerConnectionManager", "WebRTC_SDK/manager/RTCTransactionManager", "WebRTC_SDK/manager/RTCStateManager", "WebRTC_SDK/RTCStates", "nodeuuid", "WebRTC_SDK/manager/RTCScreenSharingManager", "WebRTC_SDK/utilities/RTCErrors", "WebRTC_SDK/manager/RTCCapabilitiesManager"], function(a) {
        var b = a("q"),
            c = a("my.Class"),
            d = a("underscore"),
            e = a("backbone"),
            f = a("Logger"),
            g = a("WebRTC_SDK/utilities/RTCBlueJay"),
            h = (a("WebRTC_SDK/utilities/RTCUtils"), a("WebRTC_SDK/manager/RTCSignallingManager")),
            i = a("WebRTC_SDK/manager/RTCLocalMediaManager"),
            j = a("WebRTC_SDK/manager/RTCPeerConnectionManager"),
            k = a("WebRTC_SDK/manager/RTCTransactionManager"),
            l = a("WebRTC_SDK/manager/RTCStateManager"),
            m = a("WebRTC_SDK/RTCStates"),
            n = a("nodeuuid"),
            o = a("WebRTC_SDK/manager/RTCScreenSharingManager"),
            p = a("WebRTC_SDK/utilities/RTCErrors"),
            q = a("WebRTC_SDK/manager/RTCCapabilitiesManager"),
            r = e.Model.extend({
                defaults: {
                    localVideoStream: null,
                    localAudioStream: null,
            ...
            t = c.Class({
                ...
                resendMute: !1,
                constructor: function(a) {
                    d.bindAll(this), d.extend(this.config, a), d.extend(this, e.Events), this.model = new r, this.internalModel = new s, this.BJ_CALLSTATES = m.BJ_CALLSTATES, this.TOKEN_STATUS = g.TOKEN_STATUS, this.EXTENSION_STATES = m.EXTENSION_STATES, this.WS_STATES = m.WS_STATES, this.localMediaManager = new i(this.config.localMediaParams), this.peerConnectionManager = new j({
                        peerConfig: this.config.peerConfig,
                        meetingParams: a.meetingParams
                    }), this.localMediaManager.model.on("change:localAudioStream", this.onLocalAudioStreamChange), this.localMediaManager.model.on("change:localVideoStream", this.onLocalVideoStreamChange), this.localMediaManager.model.on("change:previewStream", this.onPreviewStreamChange), this.localMediaManager.model.on("change:remoteAudioMuted", this.onRemoteAudioMuteChange), this.localMediaManager.model.on("change:remoteVideoMuted", this.onRemoteVideoMuteChange), this.localMediaManager.model.on("change:isSpeaking", this.isSpeaking), this.localMediaManager.model.on("change:volumeLevel", this.updateVolumeLevel), this.localMediaManager.on("localStreamsChanged", this.onLocalStreamsChanged), k.on("retransmitRequest", this.onRetransmitRequest), k.on("receivedConnectResponse", this.onReceiveConnectResponse), k.on("requestTimeout", this.onRequestTimeout), k.on("closeSocketConnection", this.closeSocket), l.model.on("change:disconnectCode", this.onDisconnectCodeChange), l.model.on("change:currentState", this.onCallStateChange), h.on("wsConnectionStateChange", this.wsConnectionStateChange), o.setParams({
                        chromeExtensionId: this.config.chromeExtensionId
                    }), o.setParams({
                        chromeExtensionId: this.config.chromeExtensionId,
                        features: this.config.features
                    }), o.model.on("change:presentationToken", this.onReceivePresentationToken), o.model.on("change:localContentStream", this.onLocalContentStreamChanged), o.model.on("change:tokenStatus", this.onPresentationTokenStatusChanged), o.model.on("change:extensionStatus", this.onExtensionStatusChanged)
                },
                getLocalMedia: function(a, c) {
                    var d = b.defer();
                    return this.localMediaManager.startMedia(a, c).then(function(a) {
                        return d.resolve(a)
                    }, function(a) {
                        return f.warn("RTCController: Could not get access to user's media devices"), d.reject(a)
                    }), d.promise
                },
                getLocalDevices: function() {
                    var a = this,
                        c = b.defer();
                    return this.localMediaManager.getDevices().then(function(b) {
                        var d = a.model.get("devices");
                        d.available = b.available, d.selected = b.selected, a.model.set("devices", d), c.resolve(d)
                    }, function(a) {
                        c.reject(a)
                    }), c.promise
                },
                getCameraStatus: function(a) {
                    return this.localMediaManager.detectCameraStatus(a)
                },
                getCapabilities: function() {
                    return q.detectCapabilities().then(d.bind(function() {
                        this.model.set("capabilities", q.model.attributes)
                    }, this), function() {
                        f.error("RTCController: failed to get RTC capabilities")
                    })
                },
                setSpeaker: function(a) {
                    this.localMediaManager.setSpeaker(a)
                },
                renderSelfView: function(a) {
                    return this.localMediaManager.renderSelfView(a)
                },
                renderStream: function(a) {
                    return this.localMediaManager.renderStream(a)
                },
                stopLocalMedia: function(a) {
                    this.localMediaManager.stopMedia(a)
                },
                createPeerConnection: function(a) {
                    this.peerConnectionManager.createPeer(a), this.peerConnectionManager.peer.model.on("change:remoteStream", this.onRemoteStreamChanged), this.peerConnectionManager.peer.model.on("change:remoteContentStream", this.onRemoteContentStreamChanged), this.peerConnectionManager.peer.on("iceConnectionClosed", this.onIceConnectivityClosed), this.peerConnectionManager.peer.on("restartICE", this.restartMediaChannel), this.peerConnectionManager.peer.on("iceConnectivityTimeout", this.onIceConnectivityTimeout), this.peerConnectionManager.peer.callStatsModel.on("change", function(a) {
                        this.model.set(a.attributes)
                    }, this)
                },
                onCallStateChange: function(a) {
                    var b = a.get("currentState");
                    this.model.set("callState", b), k.updateCallState(b), this.reactToCallStateChange()
                },
                reactToCallStateChange: function() {
                    var a = this.model.get("callState");
                    switch (a) {
                        case this.BJ_CALLSTATES.CONNECTED:
                            this.model.set("isIceRestarted", !1);
                            break;
                        case this.BJ_CALLSTATES.DISCONNECTED:
                            this.reset(), this.sendDisconnectMessage(l.getDisconnectReason())
                    }
                },
                onDisconnectCodeChange: function() {
                    this.model.set("disconnectCode", l.model.get("disconnectCode"))
                },
                initializePeerConnection: function(a, b) {
                    (void 0 === b || b === !0) && l.reset(), this.peerConnectionManager.initiateCall(a, !0)
                },
                startConnection: function(a) {
                    var b = n.v1();
                    h.createSocket(a), this.peerConnectionManager.updateMeetingParams(a), g.setCallid(b)
                },
                generateDtlsRsaCertificate: function() {
                    var a, c = b.defer(),
                        d = this;
                    return webkitRTCPeerConnection.generateCertificate ? (a = d.internalModel.get("dtlsCertificate"), a ? c.resolve(a) : webkitRTCPeerConnection.generateCertificate({
                        name: "RSASSA-PKCS1-v1_5",
                        hash: "SHA-256",
                        modulusLength: 2048,
                        publicExponent: new Uint8Array([1, 0, 1])
                    }).then(function(a) {
                        f.debug("RTCController :: Successfully created DTLS RSA certificate"), d.internalModel.set("dtlsCertificate", a), c.resolve(a)
                    }, function(a) {
                        c.reject(a)
                    })) : c.resolve(), c.promise
                },
                makeCall: function(a, b) {
                    var c = this;
                    k.reset(), l.reset(), this.closeSocket(), this.generateDtlsRsaCertificate().then(function(d) {
                        d && (a.peerConfig.peerConnectionConfig.certificates = [d]), c.startConnection(b), c.createPeerConnection(a)
                    }, function(a) {
                        f.error("RTCController :: Failed to start call, Error :" + a)
                    })
                },
                joinMeeting: function() {
                    var a = this.model.get("callState");
                    if (a !== this.BJ_CALLSTATES.CONNECTING && a !== this.BJ_CALLSTATES.RECONNECTING) throw f.error("RTCController: callState is not in connecting/reconnecting state, cannot proceed with call yet"), "Connection state not ready to call";
                    var b = this.config.peerConfig.receiveMedia;
                    b.iceRestart = !1, this.peerConnectionManager.initiateCall(b, !1)
                },
                restartMediaChannel: function() {
                    var a = this.internalModel.get("wsConnectionState");
                    if (a !== this.WS_STATES.CONNECTED && a !== this.WS_STATES.RECONNECTED || this.model.get("isIceRestarted") !== !1) f.debug("RTCController : Failed to restart media channel, Signalling channel is disconnected or media restart is already in progress.");
                    else {
                        f.debug("Re-starting the media channel - ICE Restart, get new local SDP");
                        var b = this.config.peerConfig.receiveMedia;
                        b.iceRestart = !0, this.initializePeerConnection(b, !1), this.model.set("isIceRestarted", !0)
                    }
                },
                onRetransmitRequest: function(a) {
                    h.sendMsg(a)
                },
                onLocalAudioStreamChange: function(a) {
                    this.model.set("localAudioStream", a.get("localAudioStream"))
                },
                onLocalVideoStreamChange: function(a) {
                    this.model.set("localVideoStream", a.get("localVideoStream"))
                },
                onPreviewStreamChange: function(a) {
                    this.model.set("previewStream", a.get("previewStream"))
                },
                onRemoteStreamChanged: function(a) {
                    this.model.set("remoteStream", a.get("remoteStream")), this.localMediaManager.updateStream({
                        remoteStream: a.get("remoteStream")
                    })
                },
                onRemoteContentStreamChanged: function(a) {
                    this.model.set("remoteContentStream", a.get("remoteContentStream"))
                },
                onReceivePresentationToken: function(a) {
                    this.model.set("presentationToken", a.get("presentationToken"))
                },
                _applyCachedMuteStates: function() {
                    f.info("RTCController: Applying cached mute states"), this.muteStreams({
                        resendMuteMsg: !0,
                ...
                muteStreams: function(a) {
                    var b = this;
                    k.model.get("connectResponseReceived"), d.isBoolean(a.localAudio) && a.localAudio !== this.model.get("localAudioMuted"), d.isBoolean(a.localVideo) && a.localVideo !== this.model.get("localVideoMuted");
                    this.localMediaManager.muteStreams(a).then(function() {
                        b.onLocalStreamsChanged();
                        var a = b.localMediaManager.model.get("localAudioMuted"),
                            c = b.localMediaManager.model.get("localVideoMuted"),
                            d = b.localMediaManager.model.get("remoteAudioMuted"),
                            e = b.localMediaManager.model.get("remoteVideoMuted"),
                            f = g.getMuteMessage({
                                audio: a ? "muted" : "unmuted",
                                video: c ? "muted" : "unmuted",
                                remoteAudio: d ? "muted" : "unmuted",
                                remoteVideo: e ? "muted" : "unmuted"
                            });
                        h.sendMsg(f) ? (k.onBlueJayRequest(f), b.resendMute = !1) : b.resendMute = !0, b.model.set({
                            localAudioMuted: a,
                            localVideoMuted: c
                        })
                    }, function() {
                        f.error("RTCController: Failed to Mute streams")
                    })
                },
                onRemoteAudioMuteChange: function(a) {
                    this.model.set("remoteAudioMuted", a.get("remoteAudioMuted"))
                },
                onRemoteVideoMuteChange: function(a) {
                    this.model.set("remoteVideoMuted", a.get("remoteVideoMuted"))
                },
                updateLocalStream: function(a) {
                    return this.peerConnectionManager.updatePeerStream(a)
                },
                startVolumeMonitoring: function(a, b) {
                    null == this.localMediaManager.volumeMoniter ? this.localMediaManager.startVolumeMonitor(a, b) : f.debug("Already monitering volume")
                },
                stopVolumeMonitoring: function() {
                    this.localMediaManager.stopVolumeMonitor()
                },
                isSpeaking: function(a) {
                    this.model.set("isSpeaking", a.get("isSpeaking"))
                },
                updateVolumeLevel: function(a) {
                    this.model.set("volumeLevel", a.get("volumeLevel"))
                },
                onLocalStreamsChanged: function() {
                    var a = this.localMediaManager.model.get("localAudioStream"),
                        b = this.localMediaManager.model.get("localVideoStream");
                    this.model.get("callState");
                    this.peerConnectionManager.updatePeerStream({
                        newVideoStream: b,
                        newAudioStream: a
                    })
                },
                onLocalStreamSuccessCB: function(a) {
                    var b = this,
                        c = null,
                        e = null,
                        f = b.model.get("localVideoStream"),
                        g = b.model.get("localAudioStream"),
                        h = this.model.get("callState");
                    d.each(a, function(a, d, f) {
                        a.getVideoTracks().length > 0 ? (c = a, b.model.set("localVideoStream", c)) : (e = a, b.model.set("localAudioStream", e))
                    }), h === this.BJ_CALLSTATES.CONNECTED && b.peerConnectionManager.updatePeerStream({
                        currentVideoStream: f,
                        newVideoStream: c,
                        currentAudioStream: g,
                        newAudioStream: e
                    })
                },
                onReceiveConnectResponse: function() {
                    this._applyCachedMuteStates(), this.peerConnectionManager.signallingChannelCreated(), this.localMediaManager.sendDeviceInfo()
                },
                onCallDisconnected: function(a) {
                    l.callDisconnected(a)
                },
                onRequestTimeout: function() {
                    l.callDisconnected(p.DISCONNECT_REASONS.REQ_TIMED_OUT)
                },
                endCall: function() {
                    this.localMediaManager.close(), this.reset(), this.sendDisconnectMessage(p.DISCONNECT_REASONS.USER_INITIATED)
                },
                reset: function() {
                    var a = b.defer();
                    return this.peerConnectionManager.close(), o.close(), k.reset(), a.resolve(), a.promise
                },
                sendDisconnectMessage: function(a) {
                    var b = g.getDisconnectMessage(a);
                    k.onBlueJayRequest(b), h.sendMsg(b)
                },
                closeSocket: function() {
                    f.debug("RTCController closing socket"), h.close()
                },
                getVersion: function() {
                    return "1.0"
                },
                startScreenSharing: function(a) {
                    o.startScreenSharing(a)
                },
                stopScreenSharing: function() {
                    o.stopScreenSharing()
                },
                onLocalContentStreamChanged: function(a) {
                    var b = a.get("localContentStream");
                    b ? this.peerConnectionManager.addPeerStream(b) : (b = this.model.get("localContentStream"), b && this.peerConnectionManager.removePeerStream(b)), this.model.set("localContentStream", a.get("localContentStream"))
                },
                onPresentationTokenStatusChanged: function(a) {
                    this.model.set("presentationTokenStatus", a.get("tokenStatus"))
                },
                onExtensionStatusChanged: function(a) {
                    this.model.set("extensionStatus", a.get("extensionStatus"))
                },
                wsConnectionStateChange: function(a, b) {
                    var c = this.internalModel.get("wsConnectionState");
                    switch (this.internalModel.set("wsConnectionState", a), a) {
                        case this.WS_STATES.CONNECTED:
                            (l.getCurrentCallState() === this.BJ_CALLSTATES.IDLE || c !== this.WS_STATES.RECONNECTED) && this.initializePeerConnection();
                            break;
                        case this.WS_STATES.RECONNECTED:
                            var d = this.internalModel.get("wsSocketId");
                            d !== b && l.getCurrentCallState() === this.BJ_CALLSTATES.RESTART_MEDIA && this.restartMediaChannel(), this.peerConnectionManager.sendKeepAliveMessage(!0), this.resendMute && this._applyCachedMuteStates();
                            break;
                        case this.WS_STATES.FAILED:
                            l.callDisconnected(p.DISCONNECT_REASONS.TRANSPORT_FAIL);
                            break;
                        case this.WS_STATES.DISCONNECTED:
                        case this.WS_STATES.CLOSED:
                    }
                    this.internalModel.set("wsSocketId", b)
                },
                onIceConnectivityTimeout: function() {
                    l.callDisconnected(p.DISCONNECT_REASONS.TRANSPORT_FAIL)
                },
                setPresentationRatio: function(a) {
                    o.sendPresentaionRatio(a)
                },
                onIceConnectivityClosed: function() {
                    f.debug("RTCController :: Ice connection is closed, ending the call"), l.callDisconnected(p.DISCONNECT_REASONS.USER_INITIATED), this.localMediaManager.close()
                }
            });
        return t
    ...
    }), define("clientSDK/src/clients/RestClient", ["config"], function(a) {
        var b = a,
            c = 15e3,
            d = function(a, d) {
                ...
                f || d("sipDialout: XMLHttpRequest is not supported"), f.timeout = c, f.addEventListener("readystatechange", function() {
                    if (4 === this.readyState)
                        if (200 === this.status) d(null, this.responseText);
                        else {
                            var a = this.status || 408;
                            d(a)
                        }
                }), f.addEventListener("error", function(a) {
                    d(this.err)
                }), f.addEventListener("abort", function(a) {
                    d(this.err)
                }), f.ontimeout = function(a) {
                    d("XMLHttpRequest timeout")
                };
                var g = b.environment.hostname + "/seamapi/v1/user/" + a.oauthInfo.scope.meeting.leaderId + "/live_meetings/" + a.oauthInfo.scope.meeting.meetingNumericId + "/dialout/pstn?access_token=" + encodeURIComponent(a.oauthInfo.access_token);
                f.open("POST", g, !0), f.setRequestHeader("Content-Type", "application/json"), f.send(e)
            },
            e = function(a, d) {
                var e = b.environment.hostname + a.url,
                    f = JSON.stringify(a.body),
                    g = new XMLHttpRequest;
                g || d("POST: XMLHttpRequest is not supported"), g.timeout = c, g.addEventListener("readystatechange", function() {
                    if (4 === this.readyState)
                        if (200 === this.status || 201 === this.status) d(null, this.responseText);
                        else {
                            var a = this.status || 408;
                            d({
                                status: a
                    ...
                    d(a)
                }), g.addEventListener("abort", function(a) {
                    d(a)
                ...
                }, g.open("POST", e, !0), g.setRequestHeader("Content-Type", "application/json"), g.send(f)
            };
        return {
            sipDialout: d,
            post: e
        }
    }), define("clientSDK/src/clients/SecurePerimeterClient", ["clientSDK/src/clients/RestClient"], function(a) {
        var b = function(b, c) {
                var d = "/seamapi/v1/services/pairingCodeGenerator?stringifyOauthJson=false&includeProfilePictureUrl=false&includePhoneContactInfo=false&includePairing=false",
                    e = b,
                    f = {
                        url: d,
                        body: e
            ...
            c = function(b, c) {
                var d = "/seamapi/v1/user/" + b.oauthInfo.scope.meeting.leaderId + "/live_meetings/" + b.oauthInfo.scope.meeting.meetingNumericId + "/pairing_code/webrtc?access_token=" + encodeURIComponent(b.oauthInfo.access_token),
                    e = {
                        endpointType: 4,
                        userId: b.oauthInfo.scope.meeting.leaderId,
                        languageCode: "en",
            ...
            d = function(b, c, d) {
                var e = "/seamapi/v1/user/" + b.oauthInfo.scope.meeting.leaderId + "/live_meetings/" + b.oauthInfo.scope.meeting.meetingNumericId + "/dialout/pstn?access_token=" + encodeURIComponent(b.oauthInfo.access_token),
                    f = {
                        uri: c
                    },
                    g = {
    ...
    }), define("clientSDK/src/models/Connection", ["require", "backbone", "underscore"], function(a) {
        var b = a("backbone"),
            c = a("underscore"),
            d = b.Model.extend({
                idAttribute: "connectionGuid"
            }, {
                translationMatrix: function(a) {
                    var b = c.clone(a);
                    return b.capabilities && (b.capabilities = c.map(b.capabilities, function(a) {
                        return a.toLowerCase()
                    })), b
                }
            });
        return d.Collection = b.Collection.extend({
            model: d
        }), d
    }), define("clientSDK/src/models/Participant", ["require", "backbone", "underscore", "./Connection"], function(a) {
        var b = a("backbone"),
            c = a("underscore"),
            d = a("./Connection"),
            e = b.Model.extend({
                ...
                collectionProps: {
                    connections: d.Collection
                },
                sync: function(a, b, c) {},
                destroy: function(a) {
                    b.Model.prototype.destroy.call(this, a)
                },
                set: function(a, d, e) {
                    var f, g = this,
                        h = function(a) {
                            return c.object(c.map(a, function(a, c) {
                                if (!g.collectionProps[c]) return [c, a];
                                if (a instanceof b.Collection) return [c, a];
                                var d = g.get(c);
                                return d.set(a), [c, d]
                            }))
                        },
                        i = function() {
                            return c.object(c.map(g.collectionProps, function(a, b) {
                                return [b, new a]
                            }))
                        };
                    if ("object" == typeof a) {
                        this._collectionsInitialized || (b.Model.prototype.set.call(g, i(), e), this._collectionsInitialized = !0);
                        var j = a;
                        e = d, f = h(j), b.Model.prototype.set.call(g, f, e)
                    } else f = h(c.object([a], [d])), void 0 !== f[a] && b.Model.prototype.set.call(g, a, d, e)
                },
                isEntered: function() {
                    var a = c.any(this.get("connections").toJSON(), function(a) {
                        return "Skinny" == a.endpoint
                    });
                    return a ? c.any(this.get("connections").toJSON(), function(a) {
                        return a.capabilities.length > 0
                    }) : !0
                }
            }, {
                translationMatrixShort: function(a, b) {
                    return {
                        dataObject: a,
                        chatEndpointGuid: a.ch,
                        callguid: a.c,
                        id: a.E1,
                        name: a.n,
                        type: a.t || "endpoint",
                        callQuality: parseInt(a.C1, 10),
                        isLeader: 1 == a.L1,
                        isSelf: b && a.E1 == b.id,
                        endpointType: a.e,
                        isSpeaking: "1" == a.T,
                        isPresenting: "1" == a.C2,
                        isSecure: "Freeswitch" == a.e || "Phone" == a.e || "PartnerParticipant" == a.e || "1" == a.S1,
                        isPhone: "Phone" == a.e || "PartnerParticipant" == a.e,
                        meetingId: a.m,
                        isVisible: !a.v || "1" == a.v,
                        isChatOnly: "SkinnyChat" == a.e,
                        inWaitingRoom: !a.L2 || "1" == a.L2,
                        isPresentationLayout: "2" == a.L2,
                        isVideoLayout: "4" == a.L2,
                        currentLayout: a.S2,
                        isCurrentlyShowingVideo: "1" == a.V1,
                        isSendingVideo: "1" != a.V2,
                        isServerMutingVideo: "1" == a.V3,
                        isVideoSeen: "1" != a.V2 && "1" != a.V3,
                        isCurrentlyShowingAudio: "1" == a.A1,
                        isSendingAudio: "1" != a.A2,
                        isServerMutingAudio: "1" == a.A3,
                        isAudioHeard: "1" != a.A2 && "1" != a.A3,
                        alerts: a.a ? a.a.split(",") : void 0,
                        audioRecvCodec: void 0 !== a.A4 && "" !== a.A4 ? a.A4 : null,
                        audioSendCodec: void 0 !== a.A5 && "" !== a.A5 ? a.A5 : null,
                        videoRecvCodec: void 0 !== a.V4 && "" !== a.V4 ? a.V4 : null,
                        videoRecvHeight: a.V5 && "" !== a.V5 ? parseInt(a.V5, 10) : null,
                        videoRecvWidth: a.V6 && "" !== a.V6 ? parseInt(a.V6, 10) : null,
                        videoSendCodec: void 0 !== a.V7 && "" !== a.V7 ? a.V7 : null,
                        videoSendHeight: a.V8 && "" !== a.V8 ? parseInt(a.V8, 10) : null,
                        videoSendWidth: a.V9 && "" !== a.V9 ? parseInt(a.V9, 10) : null,
                        contentRecvHeight: a.C3 && "" !== a.C3 ? parseInt(a.C3, 10) : null,
                        contentRecvWidth: a.C4 && "" !== a.C4 ? parseInt(a.C4, 10) : null,
                        videoShareRecvHeight: a.VideoShareRecvHeight && "" !== a.VideoShareRecvHeight ? parseInt(a.VideoShareRecvHeight, 10) : null,
                        videoShareRecvWidth: a.VideoShareRecvWidth && "" !== a.VideoShareRecvWidth ? parseInt(a.VideoShareRecvWidth, 10) : null,
                        pinnedGuid: a.P1,
                        connections: a.C5 ? c.map(a.C5, function(a) {
                            return d.translationMatrix(a)
                        }) : null,
                        rdcControllee: void 0 !== a.r && "None" !== a.r ? a.r : null,
                        rdcVersion: a.R1,
                        isRdcControllerCapable: "1" == a.R2,
                        isRdcControlleeCapable: "1" == a.R3
                    }
                },
                translateAttributes: function(a, b) {
                    var d = b && b.get("dataObject") ? b.get("dataObject") : {},
                        e = c.extend(d, a);
                    b && b.get("id") && (e.id = b.get("id"));
                    var f = this.translationMatrixShort(e, b);
                    return f
                },
                getId: function(a) {
                    return a.E1
        ...
        return e
    }), define("clientSDK/src/models/ParticipantsCollection", ["require", "backbone", "underscore", "./Participant"], function(a) {
        var b = a("backbone"),
            c = a("underscore"),
            d = a("./Participant"),
            e = 0,
            ...
            i = b.Collection.extend({
                model: d,
                initialize: function() {
                    b.Collection.prototype.initialize.apply(this), c.bindAll(this, "getExistingForRaw"), this.callGuidMap = {}, this.chatGuidMap = {}
                },
                comparator: function(a) {
                    var b = g;
                    return b = a.get("isLeader") ? f : b, b = a.get("isSelf") ? e : b, b + (a.get("name") ? a.get("name").toLowerCase() : h)
                },
                sync: function(a, b, c) {
                    b.trigger("fetch", a, c)
                },
                getExistingForRaw: function(a) {
                    return this.get(this.model.getId(a))
                },
        ...
        return i
    }), define("clientSDK/src/Roster", ["require", "underscore", "my.Class", "./models/ParticipantsCollection", "./models/Participant"], function(a) {
        var b = a("underscore"),
            c = a("my.Class"),
            d = a("./models/ParticipantsCollection"),
            e = a("./models/Participant"),
            f = c.Class({
                constructor: function(a) {
                    this.collection = a, this.selfParticipant = new e
                },
                extractSelf: function(a) {
                    var c, d = this.selfParticipant ? this.selfParticipant.id : null;
                    a.f && (a.f = b(a.f).filter(function(a) {
                        return d && e.getId(a) === d ? (c = a, !1) : !0
                    }), c && this.processSelf(c, this.selfParticipant));
                    var f;
                    a.a && (a.a = b(a.a).filter(function(a) {
                        return d && e.getId(a) === d ? (f = a, !1) : !0
                    }), f && this.processSelf(f, this.selfParticipant));
                    var g;
                    a.m && (a.m = b(a.m).filter(function(a) {
                        return d && e.getId(a) === d ? (g = a, !1) : !0
                    }), g && this.processSelf(g, this.selfParticipant)), a.d && (a.d = b(a.d).filter(b.bind(function(a) {
                        return d && e.getId(a) === d ? (this.selfLeft(), !1) : !0
                    }, this)))
                },
                fullUpdate: function(a, c) {
                    var e = this.collection ? this.collection : new d,
                        f = [],
                        g = [],
                        h = [],
                        i = [];
                    this.extractSelf(a), b(a.f).each(function(a) {
                        var b = e.getExistingForRaw(a);
                        b ? (g.push(a), i.push(b.get("id"))) : f.push(a)
                    }), b(b.difference(b.pluck(e.models, "id"), i)).each(function(a) {
                        h.push(e.get(a))
                    }), this.processAdded(f, c), this.processModified(g, c), this.processDeleted(h, c, !0)
                },
                partialUpdate: function(a, b) {
                    this.extractSelf(a), a.a && this.processAdded(a.a, b), a.m && this.processModified(a.m, b), a.d && this.processDeleted(a.d, b)
                },
                processAdded: function(a, c) {
                    var d = this.collection,
                        e = b(a).map(b.bind(function(a) {
                            var b = d.model.translateAttributes(a, void 0);
                            return new d.model(b)
                        }, this)).filter(function(a) {
                            return a.get("isVisible")
                        });
                    b.each(e, function(a) {
                        d.add(a, c)
                    })
                },
                processModified: function(a, c) {
                    var d = this.collection,
                        e = b(a).map(function(a) {
                            return d.model.translateAttributes(a, d.getExistingForRaw(a))
                        });
                    b.each(e, function(a) {
                        var b = d.get(a.id);
                        b && b.set(a)
                ...
                processDeleted: function(a, c, d) {
                    var e = this.collection;
                    b(a).each(function(a) {
                        var b = d ? e.get(a) : e.getExistingForRaw(a);
                        b && b.destroy()
                    })
                },
                assignedSelf: function(a) {
                    var c, d = this.collection;
                    this.selfParticipant.id = a.E1, d && (d = b(d).filter(function(b) {
                        return b ? a && a.E1 && b.id === a.E1 ? (c = b, !1) : !0 : !1
                    }), c ? this.processSelf(c) : e.translateAttributes(a, this.selfParticipant))
                },
                processSelf: function(a, b) {
                    if (void 0 !== a) {
                        var c = b ? b : new e,
                            d = this.collection.model.translateAttributes(a, c);
                        c.set(d)
                    }
                },
                selfLeft: function() {},
                registerMeetingEventsProcessor: function(a) {
                    var c = this.collection ? this.collection : new d;
                    this.meetingEventsProcessor = a;
                    var e = this;
                    b.defer(function() {
                        e.meetingEventsProcessor.processFullRoster(c)
                    })
                }
            });
        return f
        ...
        if ("object" == typeof exports && "undefined" != typeof module) module.exports = a();
        else if ("function" == typeof define && define.amd) define("bluebird", [], a);
        else {
            var b;
            "undefined" != typeof window ? b = window : "undefined" != typeof global ? b = global : "undefined" != typeof self && (b = self), b.Promise = a()
        }
    }(function() {
        var a, b, c;
        return function d(a, b, c) {
            ...
            for (var f = "function" == typeof _dereq_ && _dereq_, g = 0; g < c.length; g++) e(c[g]);
            return e
        }({
            1: [function(a, b, c) {
                b.exports = function(a) {
            ...
            2: [function(a, b, c) {
                ...
                var j = a("./schedule"),
                    k = a("./queue"),
                    l = a("./util");
                d.prototype.setScheduler = function(a) {
                    var b = this._schedule;
                    return this._schedule = a, this._customScheduler = !0, b
                }, d.prototype.hasCustomScheduler = function() {
                    return this._customScheduler
                }, d.prototype.enableTrampoline = function() {
                    this._trampolineEnabled = !0
                }, d.prototype.disableTrampolineIfNecessary = function() {
                    l.hasDevTools && (this._trampolineEnabled = !1)
                }, d.prototype.haveItemsQueued = function() {
                    return this._isTickUsed || this._haveDrainedQueues
                }, d.prototype.fatalError = function(a, b) {
                    b ? (process.stderr.write("Fatal " + (a instanceof Error ? a.stack : a) + "\n"), process.exit(2)) : this.throwLater(a)
                }, d.prototype.throwLater = function(a, b) {
                ...
                }, l.hasDevTools ? (d.prototype.invokeLater = function(a, b, c) {
                    this._trampolineEnabled ? e.call(this, a, b, c) : this._schedule(function() {
                        setTimeout(function() {
                            a.call(b, c)
                        }, 100)
                    })
                ...
                }, d.prototype.settlePromises = function(a) {
                    this._trampolineEnabled ? g.call(this, a) : this._schedule(function() {
                        a._settlePromises()
                    })
                }) : (d.prototype.invokeLater = e, d.prototype.invoke = f, d.prototype.settlePromises = g), d.prototype._drainQueue = function(a) {
                    for (; a.length() > 0;) {
                        var b = a.shift();
                        if ("function" == typeof b) {
                            var c = a.shift(),
                ...
                }, d.prototype._drainQueues = function() {
                    this._drainQueue(this._normalQueue), this._reset(), this._haveDrainedQueues = !0, this._drainQueue(this._lateQueue)
                }, d.prototype._queueTick = function() {
                    this._isTickUsed || (this._isTickUsed = !0, this._schedule(this.drainQueues))
                }, d.prototype._reset = function() {
                    this._isTickUsed = !1
                }, b.exports = d, b.exports.firstLineError = h
            }, {
                "./queue": 26,
                "./schedule": 29,
                "./util": 36
            ...
            6: [function(a, b, c) {
                b.exports = function(b, c, d, e) {
                    ...
                    b.prototype["break"] = b.prototype.cancel = function() {
                        ...
                        return a === this ? (this._branchesRemainingToCancel = 0, this._invokeOnCancel(), !0) : (this._branchHasCancelled(), this._enoughBranchesHaveCancelled() ? (this._invokeOnCancel(), !0) : !1)
                        ...
                        if (f.isArray(a))
                            for (var c = 0; c < a.length; ++c) this._doInvokeOnCancel(a[c], b);
                        else if (void 0 !== a)
            ...
            8: [function(a, b, c) {
                b.exports = function(a) {
                    ...
                    function c() {
                        return e ? new b : void 0
                    }

                    function d() {
                        var a = f.length - 1;
                        return a >= 0 ? f[a] : void 0
                    }
                    var e = !1,
                        f = [];
            ...
            9: [function(a, b, c) {
                b.exports = function(b, c) {
                    ...
                    function f(a, b, c) {
                        ...
                        try {
                            a(b, c, function(a) {
                                if ("function" != typeof a) throw new TypeError("onCancel must be a function, got: " + M.toString(a));
                    ...
                    function g(a) {
                        ...
                        void 0 !== b ? M.isArray(b) ? b.push(a) : this._setOnCancel([b, a]) : this._setOnCancel(a)
                    }
                    ...
                    function m() {
                        var a = this._boundTo;
                        return void 0 !== a && a instanceof b ? a.isFulfilled() ? a.value() : void 0 : a
                    }
                    ...
                    function o(a, b) {
                        if (N(a)) {
                            ...
                            if (void 0 !== c && b && (c = c._parent), void 0 !== c) c.attachExtraTrace(a);
                                ...
                                var d = x(a);
                                M.notEnumerableProp(a, "stack", d.message + "\n" + d.stack.join("\n")), M.notEnumerableProp(a, "__stackCleaned__", !0)
                            }
                        }
                    }

                    function p(a, b, c, d, e) {
                        if (void 0 === a && null !== b && X) {
                    ...
                    function q(a, b) {
                        ...
                        return b && (c += " Use " + b + " instead."), r(c)
                    }

                    function r(a, c, d) {
                        if (fa.warnings) {
                            var e, f = new L(a);
                            if (c) d._attachExtraTrace(f);
                            else if (fa.longStackTraces && (e = b._peekContext())) e.attachExtraTrace(f);
                            else {
                                var g = x(f);
                                f.stack = g.message + "\n" + g.stack.join("\n")
                            }
                    ...
                    function u(a) {
                        for (var b = a[0], c = 1; c < a.length; ++c) {
                            for (var d = a[c], e = b.length - 1, f = b[e], g = -1, h = d.length - 1; h >= 0; --h)
                                if (d[h] === f) {
                                    g = h;
                                    break
                                }
                    ...
                    function v(a) {
                        for (var b = [], c = 0; c < a.length; ++c) {
                            var d = a[c],
                                e = "    (No stack trace)" === d || R.test(d),
                                f = e && ca(d);
                            e && !f && (T && " " !== d.charAt(0) && (d = "    " + d), b.push(d))
                        }
                        return b
                    }
                    ...
                    function w(a) {
                        for (var b = a.stack.replace(/\s+$/g, "").split("\n"), c = 0; c < b.length; ++c) {
                            var d = b[c];
                            if ("    (No stack trace)" === d || R.test(d)) break
                        }
                    ...
                    function x(a) {
                        var b = a.stack,
                            c = a.toString();
                        return b = "string" == typeof b && b.length > 0 ? w(a) : ["    (No stack trace)"], {
                            message: c,
                            stack: "SyntaxError" == a.name ? b : v(b)
                        }
                    }
                    ...
                    function y(a, b, c) {
                        if ("undefined" != typeof console) {
                            ...
                            "function" == typeof I ? I(d, c) : "function" == typeof console.log || "object" == typeof console.log
                        }
                    }
                    ...
                    function z(a, b, c, d) {
                        ...
                        "unhandledRejection" === a ? aa(a, c, d) || e || y(c, "Unhandled rejection ") : aa(a, d)
                    }
                    ...
                    function A(a) {
                        ...
                        if ("function" == typeof a) b = "[function " + (a.name || "anonymous") + "]";
                            ...
                            b = a && "function" == typeof a.toString ? a.toString() : M.toString(a);
                    ...
                    function E(a, b) {
                        if (C()) {
                            ...
                            0 > g || 0 > h || !c || !d || c !== d || g >= h || (ca = function(a) {
                                if (O.test(a)) return !0;
                                var b = D(a);
                                return b && b.fileName === c && g <= b.line && b.line <= h ? !0 : !1
                            })
                        }
                    }
                    ...
                    function F(a) {
                        ...
                        ea(this, F), b > 32 && this.uncycle()
                    }
                    var G, H, I, J = b._getDomain,
                        K = b._async,
                        L = a("./errors").Warning,
                        M = a("./util"),
                        N = M.canAttachTrace,
                        O = /[\\\/]bluebird[\\\/]js[\\\/](release|debug|instrumented)/,
                        P = /\((?:timers\.js):\d+:\d+\)/,
                        Q = /[\/<\(](.+?):(\d+):(\d+)\)?\s*$/,
                        R = null,
                        S = null,
                        T = !1,
                        U = !(0 == M.env("BLUEBIRD_DEBUG")),
                        V = !(0 == M.env("BLUEBIRD_WARNINGS") || !U && !M.env("BLUEBIRD_WARNINGS")),
                        W = !(0 == M.env("BLUEBIRD_LONG_STACK_TRACES") || !U && !M.env("BLUEBIRD_LONG_STACK_TRACES")),
                        X = 0 != M.env("BLUEBIRD_W_FORGOTTEN_RETURN") && (V || !!M.env("BLUEBIRD_W_FORGOTTEN_RETURN"));
                    b.prototype.suppressUnhandledRejections = function() {
                        ...
                        0 === (524288 & this._bitField) && (this._setRejectionIsUnhandled(), K.invokeLater(this._notifyUnhandledRejection, this, void 0))
                    }, b.prototype._notifyUnhandledRejectionIsHandled = function() {
                        z("rejectionHandled", G, void 0, this)
                        ...
                        if (this._isRejectionUnhandled()) {
                            ...
                            this._setUnhandledRejectionIsNotified(), z("unhandledRejection", H, a, this)
                        }
                    ...
                    }, b.prototype._warn = function(a, b, c) {
                        return r(a, b, c || this)
                    }, b.onPossiblyUnhandledRejection = function(a) {
                        var b = J();
                        H = "function" == typeof a ? null === b ? a : M.domainBind(b, a) : void 0
                    }, b.onUnhandledRejectionHandled = function(a) {
                        var b = J();
                        G = "function" == typeof a ? null === b ? a : M.domainBind(b, a) : void 0
                    };
                    var Y = function() {};
                    b.longStackTraces = function() {
                        if (K.haveItemsQueued() && !fa.longStackTraces) throw new Error("cannot enable long stack traces after promises have been created\n\n    See http://goo.gl/MqrFmX\n");
                        if (!fa.longStackTraces && C()) {
                            var a = b.prototype._captureStackTrace,
                                d = b.prototype._attachExtraTrace;
                            fa.longStackTraces = !0, Y = function() {
                                if (K.haveItemsQueued() && !fa.longStackTraces) throw new Error("cannot enable long stack traces after promises have been created\n\n    See http://goo.gl/MqrFmX\n");
                                b.prototype._captureStackTrace = a, b.prototype._attachExtraTrace = d, c.deactivateLongStackTraces(), K.enableTrampoline(), fa.longStackTraces = !1
                            }, b.prototype._captureStackTrace = n, b.prototype._attachExtraTrace = o, c.activateLongStackTraces(), K.disableTrampolineIfNecessary()
                        }
                    }, b.hasLongStackTraces = function() {
                        return fa.longStackTraces && C()
                    };
                    var Z = function() {
                            try {
                                if ("function" == typeof CustomEvent) {
                                    var a = new CustomEvent("CustomEvent");
                                    return M.global.dispatchEvent(a),
                                        function(a, b) {
                                            var c = new CustomEvent(a.toLowerCase(), {
                                                detail: b,
                                                cancelable: !0
                                            });
                                            return !M.global.dispatchEvent(c)
                                        }
                                }
                                if ("function" == typeof Event) {
                                    ...
                                    return M.global.dispatchEvent(a),
                                        function(a, b) {
                                            ...
                                            return c.detail = b, !M.global.dispatchEvent(c)
                                        }
                                }
                                var a = document.createEvent("CustomEvent");
                                return a.initCustomEvent("testingtheevent", !1, !0, {}), M.global.dispatchEvent(a),
                                    function(a, b) {
                                        var c = document.createEvent("CustomEvent");
                                        return c.initCustomEvent(a.toLowerCase(), !1, !0, b), !M.global.dispatchEvent(c)
                                    }
                            } catch (b) {}
                            return function() {
                                return !1
                        ...
                        $ = function() {
                            return M.isNode ? function() {
                                ...
                                var b = "on" + a.toLowerCase(),
                                    c = M.global[b];
                                return c ? (c.apply(M.global, [].slice.call(arguments, 1)), !0) : !1
                            } : function() {
                                return !1
                            }
                        }(),
                        ...
                        aa = function(a) {
                            ...
                            var d = !1;
                            try {
                                d = Z(a, _[a].apply(null, arguments))
                            } catch (c) {
                                K.throwLater(c), d = !0
                            }
                            return d || b
                    ...
                    b.config = function(a) {
                        if (a = Object(a), "longStackTraces" in a && (a.longStackTraces ? b.longStackTraces() : !a.longStackTraces && b.hasLongStackTraces() && Y()), "warnings" in a) {
                            var c = a.warnings;
                            fa.warnings = !!c, X = fa.warnings, M.isObject(c) && "wForgottenReturn" in c && (X = !!c.wForgottenReturn)
                        }
                        if ("cancellation" in a && a.cancellation && !fa.cancellation) {
                            if (K.haveItemsQueued()) throw new Error("cannot enable cancellation after promises are in use");
                            b.prototype._clearCancellationData = j, b.prototype._propagateFrom = k, b.prototype._onCancel = h, b.prototype._setOnCancel = i, b.prototype._attachCancellationCallback = g, b.prototype._execute = f, ba = k, fa.cancellation = !0
                        }
                        return "monitoring" in a && (a.monitoring && !fa.monitoring ? (fa.monitoring = !0, b.prototype._fireEvent = aa) : !a.monitoring && fa.monitoring && (fa.monitoring = !1, b.prototype._fireEvent = e)), b
                    }, b.prototype._fireEvent = e, b.prototype._execute = function(a, b, c) {
                        try {
                            a(b, c)
                        } catch (d) {
                            return d
                        }
                    }, b.prototype._onCancel = function() {}, b.prototype._setOnCancel = function(a) {}, b.prototype._attachCancellationCallback = function(a) {}, b.prototype._captureStackTrace = function() {}, b.prototype._attachExtraTrace = function() {}, b.prototype._clearCancellationData = function() {}, b.prototype._propagateFrom = function(a, b) {};
                    var ba = l,
                        ca = function() {
                            return !1
                        },
                        da = /[\/<\(]([^:\/]+):(\d+):(?:\d+)\)?\s*$/;
                    M.inherits(F, Error), c.CapturedTrace = F, F.prototype.uncycle = function() {
                        var a = this._length;
                        if (!(2 > a)) {
                            ...
                            for (var d = 0; a > d; ++d) {
                                ...
                                if (void 0 !== h && h !== d) {
                                    ...
                                    a - 1 > h ? (i._parent = b[h + 1], i._parent.uncycle(), i._length = i._parent._length + 1) : (i._parent = void 0, i._length = 1);
                                    for (var j = i._length + 1, k = d - 2; k >= 0; --k) b[k]._length = j, j++;
                                    return
                                }
                            }
                        }
                    }, F.prototype.attachExtraTrace = function(a) {
                        if (!a.__stackCleaned__) {
                            this.uncycle();
                            for (var b = x(a), c = b.message, d = [b.stack], e = this; void 0 !== e;) d.push(v(e.stack.split("\n"))), e = e._parent;
                            u(d), t(d), M.notEnumerableProp(a, "stack", s(c, d)), M.notEnumerableProp(a, "__stackCleaned__", !0)
                        }
                    };
                    var ea = function() {
                        var a = /^\s*at\s*/,
                            b = function(a, b) {
                                return "string" == typeof a ? a : void 0 !== b.name && void 0 !== b.message ? b.toString() : A(b)
                            };
                        if ("number" == typeof Error.stackTraceLimit && "function" == typeof Error.captureStackTrace) {
                            Error.stackTraceLimit += 6, R = a, S = b;
                        ...
                        var d = new Error;
                        if ("string" == typeof d.stack && d.stack.split("\n")[0].indexOf("stackDetection@") >= 0) return R = /@/, S = b, T = !0,
                            function(a) {
                        ...
                        return "stack" in d || !e || "number" != typeof Error.stackTraceLimit ? (S = function(a, b) {
                            return "string" == typeof a ? a : "object" != typeof b && "function" != typeof b || void 0 === b.name || void 0 === b.message ? A(b) : b.toString()
                        }, null) : (R = a, S = b, function(a) {
                    ...
                    "undefined" != typeof console && "undefined" != typeof console.warn && (I = function(a) {}, M.isNode && process.stderr.isTTY ? I = function(a, b) {} : M.isNode || "string" != typeof(new Error).stack || (I = function(a, b) {}));
                    var fa = {
                        warnings: V,
                        longStackTraces: !1,
                        cancellation: !1,
                    ...
                    return W && b.longStackTraces(), {
                        longStackTraces: function() {
                            return fa.longStackTraces
                        },
                        warnings: function() {
                            return fa.warnings
                        },
                        cancellation: function() {
                            return fa.cancellation
                        },
                        monitoring: function() {
                            return fa.monitoring
                        },
            ...
            12: [function(a, b, c) {
                ...
                for (var r = "join pop push shift unshift slice filter forEach some every map indexOf lastIndexOf reduce reduceRight sort reverse".split(" "), s = 0; s < r.length; ++s) "function" == typeof Array.prototype[r[s]] && (p.prototype[r[s]] = Array.prototype[r[s]]);
            ...
            15: [function(a, b, c) {
                b.exports = function(b, c, d) {
                    ...
                    function g(a, b) {
                        return null != a.cancelPromise ? (arguments.length > 1 ? a.cancelPromise._reject(b) : a.cancelPromise._cancel(), a.cancelPromise = null, !0) : !1
                    }
                    ...
                    function i(a) {
                        return g(this, a) ? void 0 : (m.e = a, m)
                    }
            ...
            16: [function(a, b, c) {
                b.exports = function(b, c, d, e, f, g) {
                    ...
                    l.inherits(i, f), i.prototype._isResolved = function() {
                        ...
                        if (!this._isResolved()) {
                            var a, c = "undefined" != typeof this._generator["return"];
                            if (c) this._promise._pushContext(), a = n(this._generator["return"]).call(this._generator, void 0), this._promise._popContext();
                            else {
                                var d = new b.CancellationError("generator .return() sentinel");
                                b.coroutine.returnSentinel = d, this._promise._attachExtraTrace(d), this._promise._pushContext(), a = n(this._generator["throw"]).call(this._generator, d), this._promise._popContext()
                            }
                    ...
                    k.inherits(h, c), h.prototype._asyncInit = function() {
                        ...
                        if (0 > c) {
                            ...
                            if (q instanceof b) {
                                q = q._target();
                                var r = q._bitField;
                                if (0 === (50397184 & r)) return i >= 1 && this._inFlight++, d[c] = q, q._proxy(this, -1 * (c + 1)), !1;
                        ...
                        return s >= f ? (null !== h ? this._filter(d, h) : this._resolve(d), !0) : !1
            ...
            22: [function(a, b, c) {
                b.exports = function() {
                    ...
                    function d(a, b) {
                        if (null == a || a.constructor !== e) throw new s("the promise constructor cannot be invoked directly\n\n    See http://goo.gl/MqrFmX\n");
                        if ("function" != typeof b) throw new s("expecting a function but got " + n.classString(b))
                    }

                    function e(a) {
                        a !== u && d(this, a), this._bitField = 0, this._fulfillmentHandler0 = void 0, this._rejectionHandler0 = void 0, this._promise0 = void 0, this._receiver0 = void 0, this._resolveFromExecutor(a), this._promiseCreated(), this._fireEvent("promiseCreated", this)
                    }
                    ...
                    i = n.isNode ? function() {
                        ...
                        return null
                    }, n.notEnumerableProp(e, "_getDomain", i);
                    var o = a("./es5"),
                        p = a("./async"),
                        q = new p;
                    o.defineProperty(e, "_async", {
                        value: q
                    });
                    var r = a("./errors"),
                        s = e.TypeError = r.TypeError;
                    e.RangeError = r.RangeError;
                    var t = e.CancellationError = r.CancellationError;
                    e.TimeoutError = r.TimeoutError, e.OperationalError = r.OperationalError, e.RejectionError = r.OperationalError, e.AggregateError = r.AggregateError;
                    var u = function() {},
                        v = {},
                        w = {},
                        x = a("./thenables")(e, u),
                        y = a("./promise_array")(e, u, x, l, c),
                        z = a("./context")(e),
                        A = z.create,
                        B = a("./debuggability")(e, z),
                        C = (B.CapturedTrace, a("./finally")(e, x, w)),
                        D = a("./catch_filter")(w),
                        E = a("./nodeback"),
                        F = n.errorObj,
                        G = n.tryCatch;
                    return e.prototype.toString = function() {
                        ...
                        if (b > 1) {
                            ...
                            for (c = 0; b - 1 > c; ++c) {
                                var f = arguments[c];
                                if (!n.isObject(f)) return l("Catch statement predicate: expecting an object but got " + n.classString(f));
                                d[e++] = f
                            }
                            return d.length = e, a = arguments[c], this.then(void 0, D(d, a, this))
                        }
                        return this.then(void 0, a)
                    }, e.prototype.reflect = function() {
                        return this._then(k, k, void 0, this, void 0)
                    }, e.prototype.then = function(a, b) {
                        if (B.warnings() && arguments.length > 0 && "function" != typeof a && "function" != typeof b) {
                            var c = ".then() only accepts functions but was passed: " + n.classString(a);
                            arguments.length > 1 && (c += ", " + n.classString(b)), this._warn(c)
                        }
                        return this._then(a, b, void 0, void 0, void 0)
                    }, e.prototype.done = function(a, b) {
                        var c = this._then(a, b, void 0, void 0, void 0);
                        c._setIsFinal()
                    }, e.prototype.spread = function(a) {
                        return "function" != typeof a ? l("expecting a function but got " + n.classString(a)) : this.all()._then(a, void 0, void 0, v, void 0)
                        ...
                        return this.caught(n.originatesFromRejection, a)
                    }, e.getNewLibraryCopy = b.exports, e.is = function(a) {
                        return a instanceof e
                    }, e.fromNode = e.fromCallback = function(a) {
                        var b = new e(u);
                        b._captureStackTrace();
                        var c = arguments.length > 1 ? !!Object(arguments[1]).multiArgs : !1,
                            d = G(a)(E(b, c));
                        return d === F && b._rejectCallback(d.e, !0), b._isFateSealed() || b._setAsyncGuaranteed(), b
                    }, e.all = function(a) {
                        return new y(a).promise()
                    }, e.cast = function(a) {
                        var b = x(a);
                        return b instanceof e || (b = new e(u), b._captureStackTrace(), b._setFulfilled(), b._rejectionHandler0 = a), b
                    }, e.resolve = e.fulfilled = e.cast, e.reject = e.rejected = function(a) {
                        var b = new e(u);
                        return b._captureStackTrace(), b._rejectCallback(a, !0), b
                    }, e.setScheduler = function(a) {
                        if ("function" != typeof a) throw new s("expecting a function but got " + n.classString(a));
                        return q.setScheduler(a)
                    }, e.prototype._then = function(a, b, c, d, f) {
                        var g = void 0 !== f,
                            h = g ? f : new e(u),
                            j = this._target(),
                            k = j._bitField;
                        g || (h._propagateFrom(this, 3), h._captureStackTrace(), void 0 === d && 0 !== (2097152 & this._bitField) && (d = 0 !== (50397184 & k) ? this._boundValue() : j === this ? void 0 : this._boundTo), this._fireEvent("promiseChained", this, h));
                        var l = i();
                        if (0 !== (50397184 & k)) {
                            var m, o, p = j._settlePromiseCtx;
                            0 !== (33554432 & k) ? (o = j._rejectionHandler0, m = a) : 0 !== (16777216 & k) ? (o = j._fulfillmentHandler0, m = b, j._unsetRejectionIsUnhandled()) : (p = j._settlePromiseLateCancellationObserver, o = new t("late cancellation observer"), j._attachExtraTrace(o), m = b), q.invoke(p, j, {
                                handler: null === l ? m : "function" == typeof m && n.domainBind(l, m),
                                promise: h,
                                receiver: d,
                                value: o
                            })
                        } else j._addCallbacks(a, b, h, d, l);
                        return h
                        ...
                        q.hasCustomScheduler() || (this._bitField = 134217728 | this._bitField)
                    }, e.prototype._receiverAt = function(a) {
                        var b = 0 === a ? this._receiver0 : this[4 * a - 4 + 3];
                        return b === m ? void 0 : void 0 === b && this._isBound() ? this._boundValue() : b
                        ...
                        return this[4 * a - 4 + 1]
                    }, e.prototype._boundValue = function() {}, e.prototype._migrateCallback0 = function(a) {
                        var b = (a._bitField, a._fulfillmentHandler0),
                            c = a._rejectionHandler0,
                            d = a._promise0,
                            e = a._receiverAt(0);
                        void 0 === e && (e = m), this._addCallbacks(b, c, d, e, null)
                    }, e.prototype._migrateCallbackAt = function(a, b) {
                        var c = a._fulfillmentHandlerAt(b),
                            d = a._rejectionHandlerAt(b),
                            e = a._promiseAt(b),
                            f = a._receiverAt(b);
                        void 0 === f && (f = m), this._addCallbacks(c, d, e, f, null)
                    }, e.prototype._addCallbacks = function(a, b, c, d, e) {
                        var f = this._length();
                        if (f >= 65531 && (f = 0, this._setLength(0)), 0 === f) this._promise0 = c, this._receiver0 = d, "function" == typeof a && (this._fulfillmentHandler0 = null === e ? a : n.domainBind(e, a)), "function" == typeof b && (this._rejectionHandler0 = null === e ? b : n.domainBind(e, b));
                        else {
                            var g = 4 * f - 4;
                            this[g + 2] = c, this[g + 3] = d, "function" == typeof a && (this[g + 0] = null === e ? a : n.domainBind(e, a)), "function" == typeof b && (this[g + 1] = null === e ? b : n.domainBind(e, b))
                        }
                        return this._setLength(f + 1), f
                    }, e.prototype._proxy = function(a, b) {
                        this._addCallbacks(void 0, void 0, b, a, null)
                    }, e.prototype._resolveCallback = function(a, b) {
                        if (0 === (117506048 & this._bitField)) {
                            if (a === this) return this._rejectCallback(j(), !1);
                            var c = x(a, this);
                            if (!(c instanceof e)) return this._fulfill(a);
                            b && this._propagateFrom(c, 2);
                            var d = c._target();
                            if (d === this) return void this._reject(j());
                            var f = d._bitField;
                            if (0 === (50397184 & f)) {
                                var g = this._length();
                                g > 0 && d._migrateCallback0(this);
                                for (var h = 1; g > h; ++h) d._migrateCallbackAt(this, h);
                                this._setFollowing(), this._setLength(0), this._setFollowee(d)
                            } else if (0 !== (33554432 & f)) this._fulfill(d._value());
                            else if (0 !== (16777216 & f)) this._reject(d._reason());
                            else {
                                var i = new t("late cancellation observer");
                                d._attachExtraTrace(i), this._reject(i)
                            }
                        }
                    }, e.prototype._rejectCallback = function(a, b, c) {
                        var d = n.ensureErrorObject(a),
                            e = d === a;
                        if (!e && !c && B.warnings()) {
                            var f = "a promise was rejected with a non-error: " + n.classString(a);
                            this._warn(f, !0)
                        }
                        this._attachExtraTrace(d, b ? e : !1), this._reject(a)
                    }, e.prototype._resolveFromExecutor = function(a) {
                        if (a !== u) {
                            var b = this;
                    ...
                    }, e.prototype._settlePromiseFromHandler = function(a, b, c, d) {
                        var e = d._bitField;
                        if (0 === (65536 & e)) {
                            d._pushContext();
                            var f;
                            b === v ? c && "number" == typeof c.length ? f = G(a).apply(this._boundValue(), c) : (f = F, f.e = new s("cannot .spread() a non-array: " + n.classString(c))) : f = G(a).call(b, c);
                            var g = d._popContext();
                            e = d._bitField, 0 === (65536 & e) && (f === w ? d._reject(c) : f === F ? d._rejectCallback(f.e, !1) : (B.checkForgottenReturns(f, g, "", d, this), d._resolveCallback(f)))
                        }
                        ...
                        if (!((117506048 & b) >>> 16)) {
                            ...
                            this._setFulfilled(), this._rejectionHandler0 = a, (65535 & b) > 0 && (0 !== (134217728 & b) ? this._settlePromises() : q.settlePromises(this))
                        }
                    }, e.prototype._reject = function(a) {
                        var b = this._bitField;
                        if (!((117506048 & b) >>> 16)) return this._setRejected(), this._fulfillmentHandler0 = a, this._isFinal() ? q.fatalError(a, n.isNode) : void((65535 & b) > 0 ? q.settlePromises(this) : this._ensurePossibleRejectionHandled())
                    }, e.prototype._fulfillPromises = function(a, b) {
                        for (var c = 1; a > c; c++) {
                    ...
                    }, e.prototype._rejectPromises = function(a, b) {
                        for (var c = 1; a > c; c++) {
                    ...
                    }, n.notEnumerableProp(e, "_makeSelfResolutionError", j), a("./method")(e, u, x, l, B), a("./bind")(e, u, x, B), a("./cancel")(e, y, l, B), a("./direct_resolve")(e), a("./synchronous_inspection")(e), a("./join")(e, y, x, u, q, i), e.Promise = e, e.version = "3.5.0", a("./map.js")(e, y, l, x, u, B), a("./call_get.js")(e), a("./using.js")(e, l, x, A, u, B), a("./timers.js")(e, u, B), a("./generators.js")(e, l, u, x, c, B), a("./nodeify.js")(e), a("./promisify.js")(e, u), a("./props.js")(e, y, x, l), a("./race.js")(e, u, x, l), a("./reduce.js")(e, y, l, x, u, B), a("./settle.js")(e, y, B), a("./some.js")(e, y, l), a("./filter.js")(e, u), a("./each.js")(e, u), a("./any.js")(e), n.toFastProperties(e), n.toFastProperties(e.prototype), h({
                        a: 1
                    }), h({
                        b: 2
                    }), h({
                        c: 3
                    }), h(1), h(function() {}), h(void 0), h(!1), h(new e(u)), B.setBounds(p.firstLineError, n.lastLineError), e
                }
            }, {
                "./any.js": 1,
                "./async": 2,
            ...
            23: [function(a, b, c) {
                b.exports = function(b, c, d, e, f) {
                    ...
                    return i.inherits(h, f), h.prototype.length = function() {
                        ...
                        return this._promise
                    }, h.prototype._init = function j(a, c) {
                        var f = d(this._values, this._promise);
                        if (f instanceof b) {
                            f = f._target();
                            var h = f._bitField;
                            if (this._values = f, 0 === (50397184 & h)) return this._promise._setAsyncGuaranteed(), f._then(j, this._reject, void 0, this, c);
                            if (0 === (33554432 & h)) return 0 !== (16777216 & h) ? this._reject(f._reason()) : this._cancel();
                            f = f._value()
                        }
                        if (f = i.asArray(f), null === f) {
                            var k = e("expecting an array or an iterable object but got " + i.classString(f)).reason();
                            return void this._promise._rejectCallback(k, !1)
                        }
                        return 0 === f.length ? void(-5 === c ? this._resolveEmptyArray() : this._resolve(g(c))) : void this._iterate(f)
                        ...
                        for (var e = this._promise, f = !1, g = null, h = 0; c > h; ++h) {
                            var i = d(a[h], e);
                        ...
                        if (!this._isResolved()) {
                            ...
                            if (this._cancel(), a instanceof b) a.cancel();
                                ...
                                for (var c = 0; c < a.length; ++c) a[c] instanceof b && a[c].cancel()
                        }
                ...
                b.exports = function(b, c) {
                    ...
                    function g(a, b, c) {
                        for (var d = 0; d < a.length; d += 2) {
                            var e = a[d];
                            if (c.test(e))
                                for (var f = e.replace(c, ""), g = 0; g < a.length; g += 2)
                                    if (a[g] === f) throw new s("Cannot promisify an API that has normal methods with '%s'-suffix\n\n    See http://goo.gl/MqrFmX\n".replace("%s", b))
                        }
                    }
                    ...
                    function j(a, b, c, d, e) {
                        for (var f = new RegExp(y(b) + "$"), g = h(a, b, f, c), i = 0, j = g.length; j > i; i += 2) {
                            var k = g[i],
                                l = g[i + 1],
                                o = k + b;
            ...
            25: [function(a, b, c) {
                b.exports = function(b, c, d, e) {
                    ...
                    var l = function() {
                        ...
                        m = function(a) {
                            for (var b = new h, c = a.length / 2 | 0, d = 0; c > d; ++d) {
                                var e = a[c + d],
                                    f = a[d];
                                b.set(e, f)
                            }
                    ...
                    i.inherits(f, c), f.prototype._init = function() {}, f.prototype._promiseFulfilled = function(a, b) {
                        ...
                        if (c >= this._length) {
                            ...
                            if (this._isMap) d = m(this._values);
                                ...
                                d = {};
                                for (var e = this.length(), f = 0, g = this.length(); g > f; ++f) d[this._values[f + e]] = this._values[f]
                            }
            ...
            28: [function(a, b, c) {
                b.exports = function(b, c, d, e, f, g) {
                    ...
                    n.inherits(h, c), h.prototype._gotAccum = function(a) {
                        ...
                        this._values = a;
                        var c, d, e = a.length;
                        if (void 0 !== this._initialValue ? (c = this._initialValue, d = 0) : (c = b.resolve(a[0]), d = 1), this._currentCancellable = c, !c.isRejected())
                            for (; e > d; ++d) {
                                var f = {
                                    accum: null,
                                    value: a[d],
            ...
            29: [function(a, b, c) {
                var d, e = a("./util"),
                    ...
                    g = e.getNativePromise();
                if (e.isNode && "undefined" == typeof MutationObserver) {
                    var h = global.setImmediate,
                        i = process.nextTick;
                    d = e.isRecentNode ? function(a) {
                        h.call(global, a)
                    } : function(a) {
                        i.call(process, a)
                    }
                } else if ("function" == typeof g && "function" == typeof g.resolve) {
                    var j = g.resolve();
                    d = function(a) {
                        j.then(a)
                    }
                } else d = "undefined" == typeof MutationObserver || "undefined" != typeof window && window.navigator && (window.navigator.standalone || window.cordova) ? "undefined" != typeof setImmediate ? function(a) {
                    setImmediate(a)
            ...
            31: [function(a, b, c) {
                b.exports = function(b, c, d) {
                    ...
                    g.inherits(e, c), e.prototype._init = function() {
                        ...
                        return this._addFulfilled(a), this._fulfilled() === this.howMany() ? (this._values.length = this.howMany(), 1 === this.howMany() && this._unwrap ? this._resolve(this._values[0]) : this._resolve(this._values), !0) : !1
            ...
            35: [function(a, b, c) {
                b.exports = function(b, c, d, e, f, g) {
                    ...
                    k.prototype.data = function() {
                        ...
                        for (var a = this.length, c = 0; a > c; ++c) {
                            var d = this[c];
            ...
            36: [function(a, b, c) {
                function d() {
                    try {
                        var a = D;
                        return D = null, a.apply(this, arguments)
                    } catch (b) {
                        return C.e = b, C
                    }
                }
                ...
                function j(a, b, c) {
                    if (!A.isES5) return {}.hasOwnProperty.call(a, b) ? a[b] : void 0;
                ...
                function k(a, b, c) {
                    ...
                    return A.defineProperty(a, b, d), a
                }
                ...
                function m(a) {
                    try {
                        if ("function" == typeof a) {
                            var b = A.names(a.prototype),
                                c = A.isES5 && b.length > 1,
                                d = b.length > 0 && !(1 === b.length && "constructor" === b[0]),
                                e = H.test(a + "") && A.names(a).length > 0;
                            if (c || d || e) return !0
                        }
                        return !1
                    } catch (f) {
                ...
                function t(a) {
                    return null == a ? !1 : a instanceof Error.__BluebirdErrorTypes__.OperationalError || a.isOperational === !0
                }

                function u(a) {
                    return r(a) && A.propertyIsWritable(a, "stack")
                }
                ...
                function w(a, b, c) {
                    for (var d = A.names(a), e = 0; e < d.length; ++e) {
                        var f = d[e];
                        if (c(f)) try {
                            A.defineProperty(b, f, A.getDescriptor(a, f))
                        } catch (g) {}
                    }
                }

                function x(a) {
                    return N ? process.env[a] : void 0
                }
                ...
                var A = a("./es5"),
                    ...
                    D, E = "undefined" != typeof self ? self : "undefined" != typeof window ? window : "undefined" != typeof global ? global : void 0 !== this ? this : null,
                    F = function(a, b) {
                        function c() {
                                ...
                                for (var d = [], e = Object.create(null); null != a && !b(a);) {
                                    ...
                                    for (var h = 0; h < f.length; ++h) {
                                        ...
                                        if (!e[i]) {
                                            ...
                                            null != j && null == j.get && null == j.set && d.push(i)
                                        }
                                    }
                                    a = A.getPrototypeOf(a)
                                }
                                return d
                            }
                        }
                    ...
                    K = function(a) {
                        return A.isArray(a) ? a : null
                    };
                if ("undefined" != typeof Symbol && Symbol.iterator) {
                    var L = "function" == typeof Array.from ? function(a) {
                        return Array.from(a)
                    } : function(a) {
                    ...
                    K = function(a) {
                        return A.isArray(a) ? a : null != a && "function" == typeof a[Symbol.iterator] ? L(a) : null
                    }
                }
                var M = "undefined" != typeof process && "[object process]" === v(process).toLowerCase(),
                    N = "undefined" != typeof process && "undefined" != typeof process.env,
                    O = {
                        isClass: m,
                        isIdentifier: o,
                        inheritedDataKeys: G,
                        getDataPropertyOrDefault: j,
                        thrower: l,
                        isArray: A.isArray,
                        asArray: K,
                        notEnumerableProp: k,
                ...
                O.isRecentNode = O.isNode && function() {
                    var a = process.versions.node.split(".").map(Number);
                    return 0 === a[0] && a[1] > 10 || a[0] > 0
                }(), O.isNode && O.toFastProperties(process);
                try {
                    throw new Error
                } catch (P) {
                    O.lastLineError = P
...
JSON || (JSON = {}),
    function() {
        ...
        d.prototype.addEventListener = function(a, b) {
            ...
            var d = this._listeners[a]; - 1 === c.arrIndexOf(d, b) && d.push(b)
        ...
        f.prototype.emit = function(a) {
            ...
            var b = this; - 1 === c.arrIndexOf(b._events, a) && c.log("Event " + JSON.stringify(a) + " not listed " + JSON.stringify(b._events) + " in " + b)
        ...
        c.polluteGlobalNamespace = function() {
            ...
            b.console && console.log && console.log.apply && void 0
        }, c.bind = function(a, b) {
        ...
        c.attachEvent("unload", t), c.unload_add = function(a) {
            ...
            var e, f, g = a.createElement("iframe"),
                h = function() {
                    clearTimeout(e);
                    try {
                        g.onload = null
            ...
            return g.src = b, g.style.display = "none", g.style.position = "absolute", g.onerror = function() {
                ...
                j("timeout")
            }, 15e3), f = c.unload_add(i), {
                post: k,
                cleanup: i,
                loaded: h
            }
        }, c.createHtmlfile = function(a, d) {
            var e, f, g, i = new ActiveXObject("htmlfile"),
                j = function() {
                    clearTimeout(e)
                },
                k = function() {
        ...
        u.prototype = new f(["chunk", "finish"]), u.prototype._start = function(a, d, e, f) {
            ...
            } catch (h) {}(b.ActiveXObject || b.XDomainRequest) && (d += (-1 === d.indexOf("?") ? "?" : "&") + "t=" + +new Date), g.unload_ref = c.unload_add(function() {
                g._cleanup(!0)
            });
            try {
                g.xhr.open(a, d, !0)
        ...
        var B = function(b, d, e) {
            ...
            D = function(b, d) {
                var e, f, g = a.createElement("script"),
                    h = function(a) {
                    ...
                    i = !1,
                    j = null;
                if (g.id = "a" + c.random_string(8), g.src = b, g.type = "text/javascript", g.charset = "UTF-8", g.onerror = function(a) {
                    ...
                    if (/opera/i.test(navigator.userAgent)) f = a.createElement("script"), f.text = "try{var a = document.getElementById('" + g.id + "'); if(a)a.onerror();}catch(x){};", g.async = f.async = !1;
                    else {
                        try {
                    ...
                    if (e === M) switch (f) {
                        case "s":
                            var h = JSON.parse(g),
                                ...
                                k = h[2],
                                l = h[3];
                            if (i !== y.version && c.log('Incompatibile SockJS! Main site uses: "' + i + '", the iframe: "' + y.version + '".'), !c.flatUrl(k) || !c.flatUrl(l)) return void c.log("Only basic urls are supported in SockJS");
        ...
        var aa, ba = function() {
            ...
            ca = function(a) {
                ...
                b[h][d.id] = {
                    ...
                    f.cleanup(), d.iframe_close = f = null, delete b[h][d.id], d.dispatchEvent(new e("close", {
                        reason: c
                    }))
                }, f = g(a, function(a) {
        ...
        ca.prototype = new d, ca.prototype.abort = function() {
            var a = this;
        ...
        return da.prototype = new d, da.prototype.abort = function() {
            var a = this;
        ...
        return SockJS
    }), define("clientSDK/src/clients/WebSocketClient", ["underscore", "bluebird", "sockjs", "state-machine"], function(a, b, c, d) {
        var e, f, g, h, i, j = d.transitions.transition,
            k = d.transitions.afterTransition,
            l = d.triggers.anyOf,
            m = "meeting.register",
            n = [],
            i = null,
            o = function(b, c, d) {
                return a.invoke(a.filter(b, function(a) {
                    return void 0 !== a[c]
                }), c, d)
            },
            p = 0,
            q = {},
            r = ["websocket", "xdr-streaming", "xhr-streaming", "xdr-polling", "xhr-polling", "iframe-xhr-polling", "jsonp-polling"],
            s = function(a) {
                return a === m
            },
            t = 1e3,
            ...
            x = function() {
                h && clearTimeout(h), setTimeout(function() {
                    t > p && setTimeout(function() {
                        o(a.values(q), "onBeforeReconnect", p), F(f, !0), p++
                    }, u * (p > 10 ? 10 : p))
                }, 100)
            },
            y = d.create({
                ...
                triggers: [{
                    event: "close",
                    activatedBy: l(["remoteClose", "pairingError", "kicked", "crash", "idleTimeout", "clientClose"])
                }, {
                    event: "closedUnexpectedly",
                    activatedBy: l(["networkIssue"])
                }],
                callbacks: [k({
                    to: "closed"
                }, w), k({
            ...
            z = function() {
                return "connected" === y.getState()
            },
            A = function() {
                return {
                    guid_assigned: C,
                    remoteclose: function() {
                        y.trigger("remoteClose")
                    },
                    pairingError: function() {
                        y.trigger("pairingError")
                    },
                    kicked: function() {
                        y.trigger("kicked")
                    }
            ...
            B = function(a, b) {
                (s(a) || z()) && i.send(JSON.stringify([a, b || {}]))
            },
            C = function(b) {
                g = b.seamGuid, y.assignGuid(), o(a.values(q), "onConnect", b)
            },
            D = function() {
                h && clearTimeout(h), y.trigger("clientClose"), i.close("3077", "client-closing on keep alive failure")
            },
            E = function(b) {
                var c = {
                        access_token: b.oauthInfo.access_token,
                        numeric_id: b.oauthInfo.scope.meeting.meetingNumericId,
                        leader_id: b.oauthInfo.scope.meeting.leaderId,
                        protocol: "2",
                        events: b.events,
                        user: {
                            full_name: b.user.name,
                            is_leader: b.user.leaderId
                        }
                    },
                    d = a.extend.apply(null, a.union([{}, c], a.map(n, function(b) {
                        return a.isFunction(b) ? b() : b
                    })));
                y.register(), B(m, d);
                var e = setTimeout(function() {
                    "connected" !== y.getState() ? y.reconnect() : clearTimeout(e)
                }, 5e3)
            },
            F = function(d, g) {
                return new b(function(b, g) {
                    q.guidAssigned = {
                        onConnect: b
                    }, f = d, i = new c(f.websocketURL, {}, {
                        cookie: !0,
                        protocols_whitelist: r
                    }), h = setTimeout(function() {
                        z() ? clearTimeout(h) : (y.close(), y.reconnect())
                    }, 15e3), e = f.access_token, i.onopen = function() {
                        E(f), o(a.values(q), "onopen", f)
                    }, i.onmessage = function(b) {
                        try {
                            var c = JSON.parse(b.data);
                            if (2 == c.length && "object" == typeof c[1]) {
                                var d = c[0];
                                switch (d) {
                                    case "keepalive":
                                        B("heartbeat");
                                    ...
                                    default:
                                        ...
                                        if (f in A()) A()[f](e);
                                            ...
                                            var g = a.keys(q),
                                                h = a.find(g, function(a) {
                                                    return d.match("^" + a)
                                                });
                                            q[h] && q[h].onMessage && q[h].onMessage(d, e)
                                        }
                                }
                            }
                        } catch (i) {}
                    }, i.onclose = function(a) {
                        "connected" === y.getState() && y.closedUnexpectedly()
                    }, i.onerror = function(b) {
                        o(a.values(q), "onError", b)
                    }
                })
            };
        return {
    ...
    }), define("clientSDK/src/clients/EventServiceClient", ["config", "clientSDK/src/models/ParticipantsCollection", "clientSDK/src/Roster", "clientSDK/src/clients/WebSocketClient"], function(a, b, c, d) {
        var e = {
                user: {
            ...
            j = function(a) {
                a.meetingGuid;
                a.props && a.props.f && (h = h ? h : new c(new b), h.fullUpdate(a.props, {
                    init: !0
                }), a.props.f.forEach(function(a) {})), a.props && a.props.a && (h.partialUpdate(a.props), a.props.a.forEach(function(a) {})), a.props && a.props.m && (h.partialUpdate(a.props), a.props.m.forEach(function(a) {})), a.props && a.props.d && (h.partialUpdate(a.props), a.props.d.forEach(function(a) {}))
            },
            k = function(a) {},
            l = function(a) {},
            m = function(a, b) {
                var c = {
                    websocketURL: a.events.url,
                    oauthInfo: a.oauthInfo,
                    user: {
                        name: f.user.name,
                        leaderId: a.oauthInfo.scope.meeting.leaderId
                    },
                    events: f.events
                };
                d.registerHandler({
                    onMessage: function(a, b) {
                        ...
                        if (b.body && b.body) {
                            ...
                            c.timestamp = b.timestamp, c.event && ("statechange.endpoints" === c.event.substr(0, 21) ? j(c) : "statechange.livemeeting" === c.event.substr(0, 23) ? k(c) : "dialout.notification" === c.event && l(c))
                        }
                    }
                }, "meeting.notification.msg"), d.connect(c).then(function(a) {
                    var b = {};
                    b.E1 = a.seamGuid, b.ch = a.guid ? a.guid : "", b.m = a.meetingGuid ? a.meetingGuid : "", h.assignedSelf(b), d.registerHandler({
                        onMessage: function(a, b) {
                            i(b)
                        }
                    }, "meeting.chat.msg"), d.onBeforeReconnect = function(a) {}, d.onError = function(a) {}
                }).error(function(a) {})
            },
            n = function() {
                d.close()
    ...
    }), define("clientSDK/src/clients/SchedulingClient", ["clientSDK/src/clients/RestClient"], function(a) {
        var b = function(a) {
                var b = new Date,
                    c = b.getTime(),
                    d = b;
                d.setHours(d.getHours() + 1), d = d.getTime();
                var e = {
                    description: "",
                    addAttendeePasscode: !1,
                    ...
                    advancedMeetingOptions: {
                        ...
                        disallowChat: !1,
                        publishMeeting: !1,
                        showAllAttendeesInMeetingInvite: !1
                    },
                    isLargeMeeting: !1,
    ...
    }), define("WebRTC_SDK/RTCManager", ["require", "my.Class", "underscore", "backbone", "q", "WebRTC_SDK/RTCController", "Logger", "clientSDK/src/clients/SecurePerimeterClient", "clientSDK/src/clients/EventServiceClient", "clientSDK/src/clients/SchedulingClient", "clientSDK/src/clients/RestClient", "config"], function(a) {
        var b = a("my.Class"),
            c = a("underscore"),
            d = a("backbone"),
            e = (a("q"), a("WebRTC_SDK/RTCController")),
            f = a("Logger"),
            g = a("clientSDK/src/clients/SecurePerimeterClient"),
            h = a("clientSDK/src/clients/EventServiceClient"),
            i = (a("clientSDK/src/clients/SchedulingClient"), a("clientSDK/src/clients/RestClient")),
            j = (a("config"), b.Class({
                constructor: function(a) {
                    c.bindAll(this), c.extend(this, d.Events), this.initialize(a), this.aggregateAPIResponse = null, this.meeting = null, this.reconnectInterval = 1e3, this.bjnCloudTimeout = 5e3, this.bjnSIPTimeout = 3e3, this.bjnWebRTCReconnectTimeout = 9e4, this.isVolumeMonitorStarted = !1, this.maxBandwidth = 1200, this.config = {
                        environment: {
                ...
                initialize: function(a) {
                    this.rtcController = new e(a.webrtcParams), this.webrtcParams = a.webrtcParams, this.setupRTCControllerCB(), this.setupRTCControllerListeners(), a.bjnSIPTimeout && (this.bjnSIPTimeout = a.bjnSIPTimeout), a.bjnWebRTCReconnectTimeout && (this.bjnWebRTCReconnectTimeout = a.bjnWebRTCReconnectTimeout), a.bjnCloudTimeout && (this.bjnCloudTimeout = a.bjnCloudTimeout), this.meetingInfo = null, this.localEndPointStateChange = null, this.remoteEndPointStateChange = null, this.remoteStreamChange = null, this.remoteMuteChange = null, this.localVideoStreamChange = null, this.localAudioStreamChange = null, this.error = null
                },
                setBandwidth: function(a) {
                    a >= 100 && 4096 >= a && (this.maxBandwidth = a)
                },
                tokenCookie: "BJNt",
                loginClient: function(a, b) {
                    var c = {
                        url: "/seamapi/oauth2/token?Password",
                        body: {
                            grant_type: "password",
                            username: a,
                            password: b
                    ...
                    this.config.user.username = a, this.config.user.password = b;
                    var d = this;
                    i.post(c, function(a, b) {
                        if (null == a) {
                            var c = JSON.parse(b),
                                e = c.expires_in + Date.now();
                            d.config.user.leaderId = c.scope.user;
                            var f = new Date(e).toUTCString();
                            d.setAccessToken(c.access_token, f)
                        }
                    })
                },
                setAccessToken: function(a, b) {
                    document.cookie = this.tokenCookie + "=" + a + ";expires=" + b, this.config.user.userToken = a
                },
                getUserInfo: function() {
                    for (var a = decodeURIComponent(document.cookie).split(";"), b = null, c = 0; c < a.length; c++) {
                        var d = a[c].trim();
                        if (0 === d.indexOf(this.tokenCookie)) {
                            b = {
                                name: info.split(",")[0],
                                leaderId: info.split(",")[1],
                                token: info.split(",")[2]
                            };
                            break
                        }
                ...
                setupRTCControllerCB: function() {
                    this.getLocalMedia = this.rtcController.getLocalMedia, this.getLocalDevices = this.rtcController.getLocalDevices, this.setSpeaker = this.rtcController.setSpeaker, this.renderSelfView = this.rtcController.renderSelfView, this.renderStream = this.rtcController.renderStream, this.muteStreams = this.rtcController.muteStreams, this.makeCall = this.rtcController.makeCall
                },
                setupRTCControllerListeners: function() {
                    this.rtcController.model.on("change:callState", this.onCallStateChange), this.rtcController.model.on("change:localAudioStream", this.onLocalAudioStreamChange), this.rtcController.model.on("change:localVideoStream", this.onLocalVideoStreamChange), this.rtcController.model.on("change:previewStream", this.onPreviewStreamChange), this.rtcController.model.on("change:remoteStream", this.onRemoteStreamChange), this.rtcController.model.on("change:isIceRestarted", this.onIceRestart)
                },
                startMeeting: function(a) {
                    return a.numericMeetingId && a.displayName ? (this.getPairingCodeAndInitCall(a), void this.initBJNCloudConnectionTimer()) : (this.error && this.error("invalidMeetingParams"), void f.error("Meeting id or display name cannot be empty"))
                },
                WebRTCPairing: function() {
                    var a = this;
                    this.meeting.oauthInfo = this.aggregateAPIResponse.oauthInfo, g.webRTCPairing(a.meeting, function(b, c) {
                        b ? f.error(b) : (a.clearReconnectTimer(), a.clearBJNCloudConnectionTimer(), a.initWebRTCCall(JSON.parse(c)), a.connectEventService(a.aggregateAPIResponse))
                    })
                },
                getPairingCodeAndInitCall: function(a) {
                    var b = this;
                    this.meetingInfo = a, b.meeting = {}, b.meeting.meetingNumericId = a.numericMeetingId, a.attendeePasscode && (b.meeting.meetingPasscode = a.attendeePasscode), g.aggregatePairing(b.meeting, function(a, c) {
                        a ? f.debug("could not get response of aggregate Pairing ", a) : (b.aggregateAPIResponse = JSON.parse(c), f.debug("main: aggregatePairing response = ", b.aggregateAPIResponse), b.WebRTCPairing())
                    })
                },
                connectEventService: function(a) {
                    var b = this;
                    h.roster.collection.bind("add", function(a, c, d) {
                        b.clearSipConnectionTimer(), b.remoteEndPointStateChange && b.remoteEndPointStateChange("connected")
                    }), h.roster.collection.bind("change:isSendingAudio", function(a, b, c) {
                        f.debug("bind change:isSendingAudio ", a.id + a.attributes.name, a)
                    }), h.roster.collection.bind("change:isSendingVideo", function(a, b, c) {
                        f.debug("bind change:isSendingVideo ", a.id + a.attributes.name, a)
                    }), h.roster.collection.bind("remove", function(a, c, d) {
                        f.debug("bind onRemove: ", a.id + a.attributes.name, a), b.remoteEndPointStateChange && b.remoteEndPointStateChange("disconnected")
                    }), h.connect(a, this.config, function(a, c) {
                        a && (f.debug("End the meeting"), b.error && (f.error(a), b.error("bjnCloudUnreachable"), b.clearBJNCloudConnectionTimer(), b.endMeeting()))
                    })
                },
                disconntEventService: function() {
                    h.close()
                },
                initWebRTCCall: function(a) {
                    f.debug("RTCManager :: WebRTC Pairing response ", JSON.stringify(a));
                    var b = {
                            sockUrl: a.uri,
                            sessionId: a.pairingCode,
                            endpointDetails: {
                        ...
                        c = this.webrtcParams.peerConfig;
                    c.peerConnectionConfig.iceServers = a.turnservers;
                    var d = {
                        peerConfig: c,
                ...
                stopLocalStreams: function() {
                    var a = this.getMediaStream("localVideoStream"),
                        b = this.getMediaStream("localAudioStream");
                    c.isNull(b) || c.isUndefined(b) || this.rtcController.stopLocalMedia(b), c.isNull(a) || c.isUndefined(a) || this.rtcController.stopLocalMedia(a)
                },
                getMediaStream: function(a) {
                    var b = this.rtcController.model.get(a);
                    return b ? b : null
                },
                getCurrentState: function(a) {
                    return "local" === a ? this.rtcController.model.get("callState") : this.getRemoteCallState()
                },
                getCurrentMuteStates: function(a) {
                    return "local" === a ? {
                ...
                onCallStateChange: function(a) {
                    ...
                    switch (c) {
                        case "connected":
                            ...
                            break;
                        case "disconnected":
                            var d = this.rtcController.model.get("disconnectCode");
                            d / 100 !== 2 && (b.initReconnectTimer(), b.initWebrtcReconnectTimer());
                    }
                    this.localEndPointStateChange && this.localEndPointStateChange(c)
                },
                onRemoteStreamChange: function(a) {
                    var b = a.get("remoteStream");
                    this.remoteStreamChange && b && this.remoteStreamChange(b)
                },
                onLocalVideoStreamChange: function(a) {
                    this.localVideoStreamChange && this.localVideoStreamChange(a.get("localVideoStream"))
                },
                onLocalAudioStreamChange: function(a) {
                    this.localAudioStreamChange && this.localAudioStreamChange(a.get("localAudioStream"))
                },
                initWebrtcReconnectTimer: function() {
                    var a = this;
                    a.webrtcReconnectTimer || (a.webrtcReconnectTimer = window.setTimeout(function() {
                        "connected" !== a.getCurrentState("local") && (a.error && a.error("webrtcReconnectTimeout"), a.clearReconnectTimer(), a.endMeeting())
                    }, a.bjnWebRTCReconnectTimeout))
                },
                clearWebrtcReconnectTimer: function() {
                    this.webrtcReconnectTimer && window.clearTimeout(this.webrtcReconnectTimer), this.webrtcReconnectTimer = null
                },
                initSipConnectionTimer: function() {
                    var a = this;
                    a.sipConnectionTimer || (a.sipConnectionTimer = window.setTimeout(function() {
                        a.error && a.error("sipConnectionTimeout"), a.endMeeting()
                    }, a.bjnSIPTimeout))
                },
                clearSipConnectionTimer: function() {
                    this.sipConnectionTimer && window.clearTimeout(this.sipConnectionTimer), this.sipConnectionTimer = null
                },
                initBJNCloudConnectionTimer: function() {
                    var a = this;
                    this.bjnCloudConnectiontimer || (this.bjnCloudConnectiontimer = window.setTimeout(function() {
                        a.onError && a.onError("bjnCloudUnreachable"), a.endMeeting()
                    }, this.bjnCloudTimeout))
                },
                clearBJNCloudConnectionTimer: function() {
                    this.bjnCloudConnectiontimer && window.clearTimeout(this.bjnCloudConnectiontimer), this.bjnCloudConnectiontimer = null
                },
                initReconnectTimer: function() {
                    this.reconnectInterval < 32e3 && (this.reconnectInterval *= 2), f.debug("reconnect interval" + this.reconnectInterval), this.WebRTCPairing(), this.reconnectTimer = window.setTimeout(this.initReconnectTimer, this.reconnectInterval)
                },
                getMicrophoneVolume: function() {
                    return this.isVolumeMonitorStarted || (this.rtcController.startVolumeMonitoring(this.rtcController.model.get("localAudioStream"), params = {}), this.isVolumeMonitorStarted = !0), this.rtcController.model.get("volumeLevel")
                },
                clearReconnectTimer: function() {
                    this.reconnectTimer && window.clearTimeout(this.reconnectTimer), this.reconnectTimer = null, this.reconnectInterval = 1e3
                },
                endMeeting: function() {
                    f.debug("End the meeting"), this.rtcController.stopVolumeMonitoring(), this.isVolumeMonitorStarted = !1, this.rtcController.endCall(), this.disconntEventService()
                }
            }));
        return j
    }), define("webrtc-sdk", function() {}), require(["webrtc-sdk"]);